...
//	
	...
	protected final long prepare() {
		...
		minTimeToNextElement = new int[sequence.size()];
...
//			System.err.println(String.format("%.2f%% gain at %d (%s)", (100.0 * (initialValue - bestValue))/initialValue, count, Long.toString(bestValue)));
		}
	}
