...
public final class CargoSchedulerFitnessCoreFactory implements IFitnessCoreFactory {
	...
	public Collection<String> getFitnessComponentNames() {
		return CollectionsUtil.makeArrayList(LATENESS_COMPONENT_NAME, COST_BASE_COMPONENT_NAME, COST_LNG_COMPONENT_NAME, CHARTER_COST_COMPONENT_NAME, ROUTE_PRICE_COMPONENT_NAME,
