 ...
 *
 */
public class RandomInitialSequenceBuilder<T> implements IInitialSequenceBuilder<T> {
	...
	public ISequences<T> createInitialSequences(IOptimisationData<T> data) {
		...
		final IPortSlotProvider<T> slotProvider = data.getDataComponentProvider(SchedulerConstants.DCP_portSlotsProvider, IPortSlotProvider.class);
		...
		final IModifiableSequences<T> sequences = new ModifiableSequences<T>(resources);
		...
		IStartEndRequirementProvider<T> startEndProvider = data.getDataComponentProvider(SchedulerConstants.DCP_startEndRequirementProvider, IStartEndRequirementProvider.class);
