...
/**
 */
public class MarkToMarketVesselCharter implements IVesselCharter {
	...
	public MarkToMarketVesselCharter(@NonNull final IMarkToMarket markToMarket, @NonNull final IDischargeOption dischargeOption) {
	...
	public MarkToMarketVesselCharter(@NonNull final IMarkToMarket markToMarket, @NonNull final ILoadOption loadOption) {
		this.markToMarket = markToMarket;
