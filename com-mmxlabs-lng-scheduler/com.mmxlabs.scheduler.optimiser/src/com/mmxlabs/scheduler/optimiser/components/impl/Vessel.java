...
public final class Vessel implements IVessel {
	...
	private final EnumMap<VesselState, Long> nboRate = new EnumMap<>(VesselState.class);

	private final EnumMap<VesselState, Long> idleConsumptionRate = new EnumMap<>(VesselState.class);

	private final EnumMap<PortType, Long> inPortConsumptionRateInMTPerDay = new EnumMap<>(PortType.class);

	private final EnumMap<VesselState, Long> idleNBORate = new EnumMap<>(VesselState.class);

	private final EnumMap<VesselState, Long> inPortNBORate = new EnumMap<>(VesselState.class);

	private final EnumMap<VesselState, IConsumptionRateCalculator> consumptionRate = new EnumMap<>(VesselState.class);
