...
public interface IVoyagePlanner {
	...
	Pair<VoyagePlan, IAllocationAnnotation> makeNonShippedVoyagePlan(IResource resource, IPortTimesRecord portTimesRecord, boolean extendedEvaluation, @Nullable IAnnotatedSolution annotatedSolution);
