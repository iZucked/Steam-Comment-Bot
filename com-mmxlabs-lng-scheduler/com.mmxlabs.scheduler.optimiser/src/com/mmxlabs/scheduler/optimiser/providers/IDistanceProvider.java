...
public interface IDistanceProvider extends IDataComponentProvider {
	 ...
	 * @return
	 */
	int getRouteAvailableFrom(@NonNull String route);
	 ...
	 * @return
	 */
	boolean isRouteAvailable(@NonNull String route, int voyageStartTime);
	 ...
	 */
	@NonNull
	List<MatrixEntry<IPort, Integer>> getDistanceValues(@NonNull IPort from, @NonNull IPort to, int voyageStartTime);

	@NonNull
	List<MatrixEntry<IPort, Integer>> getAllDistanceValues(@NonNull IPort from, @NonNull IPort to);
	 ...
	 * @return
	 */
	int getDistance(@NonNull String route, @NonNull IPort from, @NonNull IPort to, int voyageStartTime);
	 ...
	 * @return
	 */
	int getOpenDistance(@NonNull String route, @NonNull IPort from, @NonNull IPort to);
	 ...
	 * @return
	 */
	int getTravelTime(@NonNull String route, @NonNull IVessel vessel, @NonNull IPort from, @NonNull IPort to, int voyageStartTime, int speed);

	@NonNull
	Pair<String, Integer> getQuickestTravelTime(@NonNull IVessel vessel, @NonNull IPort from, @NonNull IPort to, int voyageStartTime, int speed);
