...
public class ShippingCostEntityValueCalculator implements IEntityValueCalculator {
	...
	public Pair<@NonNull CargoValueAnnotation, @NonNull Long> evaluate(@NonNull EvaluationMode evaluationMode, @NonNull final VoyagePlan plan, @NonNull final IAllocationAnnotation currentAllocation,
		...
		{
			calculateShippingEntityCosts(evaluationMode, entityPreTaxProfit, vesselAvailability, plan, cargoPNLData, baseEntity, shippingEntity, true, entityBookDetailTreeMap);
		}
