...
public class MonthlyBallastBonusContractRule extends BallastBonusContractRule implements INotionalJourneyBallastBonusContractRule {
	...
	@Override
	public long calculateBallastBonus(final IPort firstLoad, final IPortSlot lastSlot, final IVesselAvailability vesselAvailability, final int vesselStartTime, final int vesselEndTime) {
	...
	@Override
	public IBallastBonusRuleAnnotation annotate(IPortSlot lastSlot, IVesselAvailability vesselAvailability, int vesselStartTime, int vesselEndTime) {
		throw new IllegalArgumentException("Use new API");
	}
}
