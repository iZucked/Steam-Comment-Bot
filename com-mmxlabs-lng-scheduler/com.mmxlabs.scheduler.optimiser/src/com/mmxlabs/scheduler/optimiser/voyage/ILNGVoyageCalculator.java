...
public interface ILNGVoyageCalculator {
	 ...
	 */
	int calculateVoyagePlan(VoyagePlan voyagePlan, IVessel vessel, @NonNull ICharterCostCalculator charterCostCalculator, long[] startHeelRangeInM3, int[] baseFuelPricePerMT, IPortTimesRecord voyageRecord, IDetailsSequenceElement... sequence);
