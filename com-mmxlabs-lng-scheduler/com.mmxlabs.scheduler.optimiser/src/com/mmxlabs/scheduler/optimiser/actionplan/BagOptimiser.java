...
import com.mmxlabs.scheduler.optimiser.actionplan.independence.ActionSetIndependenceChecking;
...
public class BagOptimiser {
	...
	public static final @NonNull String ACTION_PLAN__LOGGER = "ACTION_PLAN_LOGGER";
	public static final @NonNull String ACTION_PLAN__MAIN_MOVER = "MAIN_MOVER";
	...
	private ISimpleProgressMonitor progressMonitor = null;
	...
	protected void init(final ISimpleProgressMonitor progressMonitor, final int maxLeafs) {
	...
	protected void checkIfCancelled(final ISimpleProgressMonitor progressMonitor) {
	...
	public void setProgressMonitor(final ISimpleProgressMonitor progressMonitor) {
	...
	private static class ProgressCounter {
		...
		public void increment(final ISimpleProgressMonitor progressMonitor) {
			ticks++;
