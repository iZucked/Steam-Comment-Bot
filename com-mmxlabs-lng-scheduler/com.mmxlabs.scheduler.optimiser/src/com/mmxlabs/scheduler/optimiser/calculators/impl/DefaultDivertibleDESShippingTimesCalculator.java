...
public class DefaultDivertibleDESShippingTimesCalculator implements IDivertibleDESShippingTimesCalculator {
	...
	@Override
	public Pair<@NonNull Integer, @NonNull Integer> getDivertibleDESTimes(final @NonNull ILoadOption buyOption, final @NonNull IDischargeOption sellOption, final @NonNull IVessel nominatedVessel,
	...
	private Triple<Integer, ERouteOption, Integer> getShortestTravelTimeToPort(@NonNull final ILoadOption loadOption, final @NonNull IPort to, final @NonNull IPort from, final IVessel vessel,
		...
		final Collection<ERouteOption> allowedRoutes = shippingHoursRestrictionProvider.getDivertibleDESAllowedRoutes(loadOption);
