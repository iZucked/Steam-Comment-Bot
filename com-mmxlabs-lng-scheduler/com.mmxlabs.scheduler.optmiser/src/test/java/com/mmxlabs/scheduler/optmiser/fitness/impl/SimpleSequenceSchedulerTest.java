...
public class SimpleSequenceSchedulerTest {
	...
	public void testSchedule_1() {
		...
		List<ISequenceElement> elements = CollectionsUtil.makeArrayList(element1, element2, element3, element4);
		ISequence<ISequenceElement> sequence = new ListSequence<ISequenceElement>(elements);
		...
		// output
		{
			IVisitElement visitElement = scheduler.getAdditionalInformation(element1, SchedulerConstants.AI_visitInfo, IVisitElement.class);
			...
			Assert.assertEquals(timeWindow1.getStart(), visitElement.getStartTime());
			Assert.assertEquals(timeWindow1.getStart() + duration, visitElement.getEndTime());
			Assert.assertSame(element1, visitElement.getSequenceElement());
			
			IIdleElement idleElement = scheduler.getAdditionalInformation(element1, SchedulerConstants.AI_idleInfo, IIdleElement.class);
			...
			IJourneyElement journeyElement = scheduler.getAdditionalInformation(element1, SchedulerConstants.AI_journeyInfo, IJourneyElement.class);
			Assert.assertNull(journeyElement);
		}
		

		{
			IVisitElement visitElement = scheduler.getAdditionalInformation(element2, SchedulerConstants.AI_visitInfo, IVisitElement.class);
			Assert.assertNotNull(visitElement);
			Assert.assertSame(port2, visitElement.getPort());
			Assert.assertEquals(duration , visitElement.getDuration());
			Assert.assertEquals(timeWindow2.getStart(), visitElement.getStartTime());
			Assert.assertEquals(timeWindow2.getStart() + duration, visitElement.getEndTime());
			Assert.assertSame(element2, visitElement.getSequenceElement());
			
			IIdleElement idleElement = scheduler.getAdditionalInformation(element2, SchedulerConstants.AI_idleInfo, IIdleElement.class);
			Assert.assertNotNull(idleElement);
			...
			IJourneyElement journeyElement = scheduler.getAdditionalInformation(element2, SchedulerConstants.AI_journeyInfo, IJourneyElement.class);
		...
		{
			IVisitElement visitElement = scheduler.getAdditionalInformation(element3, SchedulerConstants.AI_visitInfo, IVisitElement.class);
			Assert.assertNotNull(visitElement);
			Assert.assertSame(port3, visitElement.getPort());
			Assert.assertEquals(duration , visitElement.getDuration());
			Assert.assertEquals(timeWindow3.getStart(), visitElement.getStartTime());
			Assert.assertEquals(timeWindow3.getStart() + duration, visitElement.getEndTime());
			Assert.assertSame(element3, visitElement.getSequenceElement());
			
			IIdleElement idleElement = scheduler.getAdditionalInformation(element3, SchedulerConstants.AI_idleInfo, IIdleElement.class);
			Assert.assertNotNull(idleElement);
			...
			IJourneyElement journeyElement = scheduler.getAdditionalInformation(element3, SchedulerConstants.AI_journeyInfo, IJourneyElement.class);
			Assert.assertNotNull(journeyElement);
		...
		{
			IVisitElement visitElement = scheduler.getAdditionalInformation(element4, SchedulerConstants.AI_visitInfo, IVisitElement.class);
			Assert.assertNotNull(visitElement);
			Assert.assertSame(port4, visitElement.getPort());
			Assert.assertEquals(duration , visitElement.getDuration());
			Assert.assertEquals(timeWindow4.getStart(), visitElement.getStartTime());
			Assert.assertEquals(timeWindow4.getStart() + duration, visitElement.getEndTime());
			Assert.assertSame(element4, visitElement.getSequenceElement());
			
			IIdleElement idleElement = scheduler.getAdditionalInformation(element4, SchedulerConstants.AI_idleInfo, IIdleElement.class);
			Assert.assertNotNull(idleElement);
			...
			IJourneyElement journeyElement = scheduler.getAdditionalInformation(element4, SchedulerConstants.AI_journeyInfo, IJourneyElement.class);
			Assert.assertNotNull(journeyElement);
