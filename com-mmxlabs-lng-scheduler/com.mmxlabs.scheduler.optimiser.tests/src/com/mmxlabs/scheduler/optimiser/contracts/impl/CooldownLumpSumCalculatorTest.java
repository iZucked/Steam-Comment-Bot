...
public class CooldownLumpSumCalculatorTest {
	...
	public void testCalculatorLumpSum(String timeZone) {
		...
		int priceA = (int) OptimiserUnitConvertor.convertToInternalFixedCost(100000);
		int priceAMinus = (int) OptimiserUnitConvertor.convertToInternalFixedCost(50000);
		int priceB = (int) OptimiserUnitConvertor.convertToInternalFixedCost(200000);
		int priceBMinus = (int) OptimiserUnitConvertor.convertToInternalFixedCost(100000);
		int timeA = 100;
		int timeB = 200;
	...
	private CooldownLumpSumCalculator createCooldownLumpSumCalculator(final ICurve curve) {
