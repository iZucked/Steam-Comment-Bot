...
public class MullProfileDetailCompositeFactory implements IDisplayCompositeFactory {
	...
	public IDisplayComposite createSublevelComposite(Composite composite, EClass eClass, IDialogEditingContext context, FormToolkit toolkit) {
		// TODO Auto-generated method stub
		return new MullProfileDetailComposite(composite, context, SWT.NONE, toolkit);
	}
