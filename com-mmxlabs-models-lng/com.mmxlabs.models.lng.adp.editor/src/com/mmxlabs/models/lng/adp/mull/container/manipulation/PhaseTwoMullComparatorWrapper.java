...
@NonNullByDefault
public class PhaseTwoMullComparatorWrapper implements IMullComparatorWrapper {

	private final PhaseTwoComparator comparator;

	private class PhaseTwoComparator implements Comparator<IMudContainer> {
		...
		public PhaseTwoComparator(final Map<Vessel, LocalDateTime> vesselToMostRecentUseDateTime, final Map<Vessel, LocalDateTime> vesselToNextForwardUseTime, final int defaultAllocationDrop,
	...
	public PhaseTwoMullComparatorWrapper(final Map<Vessel, LocalDateTime> vesselToMostRecentUseDateTime, final Map<Vessel, LocalDateTime> vesselToNextForwardUseTime, final int defaultAllocationDrop,
			final Set<Vessel> firstPartyVessels, final int fullCargoLotValue, final int loadDuration) {
		this.comparator = new PhaseTwoComparator(vesselToMostRecentUseDateTime, vesselToNextForwardUseTime, defaultAllocationDrop, firstPartyVessels, fullCargoLotValue, loadDuration);
	}
