...
public class VesselUsageProfileConstraintDisplayCompositeFactory implements IDisplayCompositeFactory {
	...
	public IDisplayComposite createSublevelComposite(final Composite composite, final EClass eClass, final IDialogEditingContext dialogContext, final FormToolkit toolkit) {
		return new VesselUsageProfileConstraintDetailComposite(composite, SWT.NONE, toolkit);
	}
