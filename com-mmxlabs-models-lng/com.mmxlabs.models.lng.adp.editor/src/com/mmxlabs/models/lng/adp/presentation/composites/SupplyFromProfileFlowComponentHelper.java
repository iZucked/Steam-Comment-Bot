...
/**
 * A component helper for SupplyFromProfileFlow instances
 *
 * @generated
 */
public class SupplyFromProfileFlowComponentHelper extends BaseComponentHelper {
	 ...
	 * @generated
	 */
	public SupplyFromProfileFlowComponentHelper() {
	 ...
	 * @generated
	 */
	public SupplyFromProfileFlowComponentHelper(IAdapterManager adapterManager) {
		final IComponentHelperRegistry registry = com.mmxlabs.models.ui.Activator.getDefault().getComponentHelperRegistry();
		superClassesHelpers.addAll(registry.getComponentHelpers(ADPPackage.Literals.SUPPLY_FROM_FLOW));
	}
	
	/**
	 * add editors to a composite, using SupplyFromProfileFlow as the supertype
	 *
	 * @generated
	 */
	 @Override
	public void addEditorsToComposite(final IInlineEditorContainer detailComposite) {
		addEditorsToComposite(detailComposite, ADPPackage.Literals.SUPPLY_FROM_PROFILE_FLOW);	
	}
	...
	/**
	 * Create the editor for the profile feature on SupplyFromProfileFlow
	 *
	 * @generated
	 */
	...
	protected void add_subProfileEditor(final IInlineEditorContainer detailComposite, final EClass topClass) {
		detailComposite.addInlineEditor(ComponentHelperUtils.createDefaultEditor(topClass, ADPPackage.Literals.SUPPLY_FROM_PROFILE_FLOW__SUB_PROFILE));
	}
}