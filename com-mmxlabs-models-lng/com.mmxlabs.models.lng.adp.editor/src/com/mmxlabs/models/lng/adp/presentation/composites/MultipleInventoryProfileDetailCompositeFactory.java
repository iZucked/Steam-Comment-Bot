...
public class MultipleInventoryProfileDetailCompositeFactory implements IDisplayCompositeFactory {
	...
	public IDisplayComposite createSublevelComposite(Composite composite, EClass eClass, IDialogEditingContext context, FormToolkit toolkit) {
		// TODO Auto-generated method stub
		return new MultipleInventoryProfileDetailComposite(composite, context, SWT.NONE, toolkit);
	}
