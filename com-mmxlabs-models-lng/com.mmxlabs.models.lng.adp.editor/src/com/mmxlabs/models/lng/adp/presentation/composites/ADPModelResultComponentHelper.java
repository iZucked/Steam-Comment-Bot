...
/**
 * A component helper for ADPModelResult instances
 *
 * @generated
 */
public class ADPModelResultComponentHelper extends BaseComponentHelper {
	 ...
	 * @generated
	 */
	public ADPModelResultComponentHelper() {
	 ...
	 * @generated
	 */
	public ADPModelResultComponentHelper(IAdapterManager adapterManager) {
		final IComponentHelperRegistry registry = com.mmxlabs.models.ui.Activator.getDefault().getComponentHelperRegistry();
	}
	
	/**
	 * add editors to a composite, using ADPModelResult as the supertype
	 *
	 * @generated
	 */
	 @Override
	public void addEditorsToComposite(final IInlineEditorContainer detailComposite) {
		addEditorsToComposite(detailComposite, ADPPackage.Literals.ADP_MODEL_RESULT);	
	}
	...
	protected void add_extraSlotsEditor(final IInlineEditorContainer detailComposite, final EClass topClass) {
		detailComposite.addInlineEditor(ComponentHelperUtils.createDefaultEditor(topClass, ADPPackage.Literals.ADP_MODEL_RESULT__EXTRA_SLOTS));
	}
	/**
	 * Create the editor for the scheduleModel feature on ADPModelResult
	 *
	 * @generated
	 */
