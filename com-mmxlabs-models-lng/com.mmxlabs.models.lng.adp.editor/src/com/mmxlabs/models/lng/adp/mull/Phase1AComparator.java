...
public class Phase1AComparator implements Comparator<CargoBlueprint> {
	...
	public Phase1AComparator(final YearMonth fromYm, final YearMonth toYm, final Map<BaseLegalEntity, Map<YearMonth, Long>> monthEndEntitlements, final int fullCargoLotValue) {
		this.fromYm = fromYm;
		this.toYm = toYm;
