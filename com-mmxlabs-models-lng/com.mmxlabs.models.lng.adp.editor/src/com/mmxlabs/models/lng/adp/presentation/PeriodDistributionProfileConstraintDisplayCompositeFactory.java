...
public class PeriodDistributionProfileConstraintDisplayCompositeFactory implements IDisplayCompositeFactory {
	...
	public IDisplayComposite createSublevelComposite(final Composite composite, final EClass eClass, final IDialogEditingContext dialogContext, final FormToolkit toolkit) {
		return new PeriodDistributionProfileConstraintDetailComposite(composite, SWT.NONE, toolkit);
	}
