...
public class AssignmentAdapterFactory extends AdapterFactoryImpl {
	...
	protected AssignmentSwitch<Adapter> modelSwitch =
		new AssignmentSwitch<Adapter>() {
			@Override
			public Adapter caseAssignmentModel(AssignmentModel object) {
				return createAssignmentModelAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.mmxlabs.models.lng.assignment.AssignmentModel <em>Model</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createAssignmentModelAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link com.mmxlabs.models.lng.assignment.ElementAssignment <em>Element Assignment</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
