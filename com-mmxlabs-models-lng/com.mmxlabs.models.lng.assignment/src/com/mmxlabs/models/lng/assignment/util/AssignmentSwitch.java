...
public class AssignmentSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AssignmentPackage.ASSIGNMENT_MODEL: {
				AssignmentModel assignmentModel = (AssignmentModel)theEObject;
				T result = caseAssignmentModel(assignmentModel);
				if (result == null) result = caseUUIDObject(assignmentModel);
				if (result == null) result = caseMMXObject(assignmentModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AssignmentPackage.ELEMENT_ASSIGNMENT: {
				ElementAssignment elementAssignment = (ElementAssignment)theEObject;
				T result = caseElementAssignment(elementAssignment);
				if (result == null) result = caseMMXObject(elementAssignment);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseAssignmentModel(AssignmentModel object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Element Assignment</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Element Assignment</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseElementAssignment(ElementAssignment object) {
		return null;
	}
