 ...
 * <ul>
 *   <li>{@link com.mmxlabs.models.lng.assignment.impl.ElementAssignmentImpl#getAssignedObject <em>Assigned Object</em>}</li>
 *   <li>{@link com.mmxlabs.models.lng.assignment.impl.ElementAssignmentImpl#getAssignment <em>Assignment</em>}</li>
 *   <li>{@link com.mmxlabs.models.lng.assignment.impl.ElementAssignmentImpl#isLocked <em>Locked</em>}</li>
 *   <li>{@link com.mmxlabs.models.lng.assignment.impl.ElementAssignmentImpl#getSequence <em>Sequence</em>}</li>
 *   <li>{@link com.mmxlabs.models.lng.assignment.impl.ElementAssignmentImpl#getSpotIndex <em>Spot Index</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ElementAssignmentImpl extends MMXObjectImpl implements ElementAssignment {
	...
	protected EClass eStaticClass() {
		return AssignmentPackage.Literals.ELEMENT_ASSIGNMENT;
	}
		...
		if (assignedObject != null && assignedObject.eIsProxy()) {
			...
			if (assignedObject != oldAssignedObject) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AssignmentPackage.ELEMENT_ASSIGNMENT__ASSIGNED_OBJECT, oldAssignedObject, assignedObject));
			}
		}
	...
	public void setAssignedObject(UUIDObject newAssignedObject) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AssignmentPackage.ELEMENT_ASSIGNMENT__ASSIGNED_OBJECT, oldAssignedObject, assignedObject));
	}
	...
	public void setLocked(boolean newLocked) {
		...
		locked = newLocked;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AssignmentPackage.ELEMENT_ASSIGNMENT__LOCKED, oldLocked, locked));
	}
	...
	public void setSequence(int newSequence) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AssignmentPackage.ELEMENT_ASSIGNMENT__SEQUENCE, oldSequence, sequence));
	}
	...
	public void setSpotIndex(int newSpotIndex) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AssignmentPackage.ELEMENT_ASSIGNMENT__SPOT_INDEX, oldSpotIndex, spotIndex));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AssignmentPackage.ELEMENT_ASSIGNMENT__ASSIGNED_OBJECT:
