...
public class ObjectiveImpl extends NamedObjectImpl implements Objective {
	...
	protected EClass eStaticClass() {
		return ParametersPackage.Literals.OBJECTIVE;
	}
	...
	public void setWeight(double newWeight) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ParametersPackage.OBJECTIVE__WEIGHT, oldWeight, weight));
	}
	...
	public void setEnabled(boolean newEnabled) {
		...
		enabled = newEnabled;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ParametersPackage.OBJECTIVE__ENABLED, oldEnabled, enabled));
	}
