...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Local Search Optimisation Stage</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class LocalSearchOptimisationStageImpl extends ParallisableOptimisationStageImpl implements LocalSearchOptimisationStage {
	 ...
	 * @generated
	 */
	protected LocalSearchOptimisationStageImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ParametersPackage.Literals.LOCAL_SEARCH_OPTIMISATION_STAGE;
	}
	...
	public void setSeed(int newSeed) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ParametersPackage.LOCAL_SEARCH_OPTIMISATION_STAGE__SEED, oldSeed, seed));
	}
	...
	public NotificationChain basicSetAnnealingSettings(AnnealingSettings newAnnealingSettings, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ParametersPackage.LOCAL_SEARCH_OPTIMISATION_STAGE__ANNEALING_SETTINGS, oldAnnealingSettings, newAnnealingSettings);
	...
	public void setAnnealingSettings(AnnealingSettings newAnnealingSettings) {
		if (newAnnealingSettings != annealingSettings) {
			...
			if (annealingSettings != null)
				msgs = ((InternalEObject)annealingSettings).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ParametersPackage.LOCAL_SEARCH_OPTIMISATION_STAGE__ANNEALING_SETTINGS, null, msgs);
			if (newAnnealingSettings != null)
				msgs = ((InternalEObject)newAnnealingSettings).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ParametersPackage.LOCAL_SEARCH_OPTIMISATION_STAGE__ANNEALING_SETTINGS, null, msgs);
			msgs = basicSetAnnealingSettings(newAnnealingSettings, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ParametersPackage.LOCAL_SEARCH_OPTIMISATION_STAGE__ANNEALING_SETTINGS, newAnnealingSettings, newAnnealingSettings));
	}
...
} //LocalSearchOptimisationStageImpl
