...
/**
 * This is the item provider adapter for a {@link com.mmxlabs.models.lng.pricing.FOBSalesMarket} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PricingPackage.Literals.FOB_SALES_MARKET__LOAD_PORT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addContractPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FOBSalesMarket_contract_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FOBSalesMarket_contract_feature", "_UI_FOBSalesMarket_type"),
				 PricingPackage.Literals.FOB_SALES_MARKET__CONTRACT,
				 true,
				 false,
				 true,
				 null,
