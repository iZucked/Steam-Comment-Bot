...
/**
 * This is the item provider adapter for a {@link com.mmxlabs.models.lng.pricing.DESPurchaseMarket} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DESPurchaseMarketItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PricingPackage.Literals.DES_PURCHASE_MARKET__CV,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PricingPackage.Literals.DES_PURCHASE_MARKET__DESTINATION_PORTS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addContractPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DESPurchaseMarket_contract_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DESPurchaseMarket_contract_feature", "_UI_DESPurchaseMarket_type"),
				 PricingPackage.Literals.DES_PURCHASE_MARKET__CONTRACT,
				 true,
				 false,
				 true,
				 null,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DESPurchaseMarket.class)) {
			case PricingPackage.DES_PURCHASE_MARKET__CV:
