	...
	protected void addPortsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SpotMarket_ports_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SpotMarket_ports_feature", "_UI_SpotMarket_type"),
				 PricingPackage.Literals.SPOT_MARKET__PORTS,
				 true,
				 false,
				 true,
				 null,
