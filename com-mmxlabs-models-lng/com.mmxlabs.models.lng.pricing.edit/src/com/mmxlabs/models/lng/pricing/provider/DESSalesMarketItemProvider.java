...
/**
 * This is the item provider adapter for a {@link com.mmxlabs.models.lng.pricing.DESSalesMarket} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PricingPackage.Literals.DES_SALES_MARKET__NOTIONAL_PORT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addContractPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DESSalesMarket_contract_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DESSalesMarket_contract_feature", "_UI_DESSalesMarket_type"),
				 PricingPackage.Literals.DES_SALES_MARKET__CONTRACT,
				 true,
				 false,
				 true,
				 null,
