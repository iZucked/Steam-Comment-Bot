 ...
 * @generated
 */
public class TransfersAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	public TransfersAdapterFactory() {
	...
	protected TransfersSwitch<@Nullable Adapter> modelSwitch =
		new TransfersSwitch<@Nullable Adapter>() {
			...
			@Override
			public Adapter caseTransferAgreement(TransferAgreement object) {
				return createTransferAgreementAdapter();
			}
			@Override
			public Adapter caseTransferRecord(TransferRecord object) {
				return createTransferRecordAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.mmxlabs.models.lng.transfers.TransferModel <em>Transfer Model</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.mmxlabs.models.lng.transfers.TransferAgreement <em>Transfer Agreement</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.mmxlabs.models.lng.transfers.TransferRecord <em>Transfer Record</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
