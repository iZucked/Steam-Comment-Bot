...
/**
 * A component helper for FuelAmount instances
 *
 * @generated
 */
public class FuelAmountComponentHelper extends BaseComponentHelper {
	 ...
	 * @generated
	 */
	public FuelAmountComponentHelper() {
	 ...
	 * @generated
	 */
	public FuelAmountComponentHelper(IAdapterManager adapterManager) {
		final IComponentHelperRegistry registry = com.mmxlabs.models.ui.Activator.getDefault().getComponentHelperRegistry();
	}
	
	/**
	 * add editors to a composite, using FuelAmount as the supertype
	 *
	 * @generated
	 */
	 @Override
	public void addEditorsToComposite(final IInlineEditorContainer detailComposite) {
		addEditorsToComposite(detailComposite, SchedulePackage.Literals.FUEL_AMOUNT);	
	}
	...
	protected void add_unitEditor(final IInlineEditorContainer detailComposite, final EClass topClass) {
		detailComposite.addInlineEditor(ComponentHelperUtils.createDefaultEditor(topClass, SchedulePackage.Literals.FUEL_AMOUNT__UNIT));
	}
	/**
	 * Create the editor for the quantity feature on FuelAmount
	 *
	 * @generated
	 */
