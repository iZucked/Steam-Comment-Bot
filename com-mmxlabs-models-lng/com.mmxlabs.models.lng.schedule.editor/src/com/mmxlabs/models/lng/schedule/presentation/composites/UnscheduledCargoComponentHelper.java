...
/**
 * A component helper for UnscheduledCargo instances
 *
 * @generated
 */
public class UnscheduledCargoComponentHelper extends BaseComponentHelper {
	 ...
	 * @generated
	 */
	public UnscheduledCargoComponentHelper() {
	 ...
	 * @generated
	 */
	public UnscheduledCargoComponentHelper(IAdapterManager adapterManager) {
		final IComponentHelperRegistry registry = com.mmxlabs.models.ui.Activator.getDefault().getComponentHelperRegistry();
		superClassesHelpers.addAll(registry.getComponentHelpers(MMXCorePackage.Literals.MMX_OBJECT));
	}
	
	/**
	 * add editors to a composite, using UnscheduledCargo as the supertype
	 *
	 * @generated
	 */
	 @Override
	public void addEditorsToComposite(final IInlineEditorContainer detailComposite) {
		addEditorsToComposite(detailComposite, SchedulePackage.Literals.UNSCHEDULED_CARGO);	
	}
