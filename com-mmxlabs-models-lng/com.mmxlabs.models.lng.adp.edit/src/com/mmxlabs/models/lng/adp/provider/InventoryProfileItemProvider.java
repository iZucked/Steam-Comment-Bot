...
public class InventoryProfileItemProvider 
	...
	/**
	 * This adds a property descriptor for the Relative Entitlements feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addRelativeEntitlementsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_InventoryProfile_relativeEntitlements_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_InventoryProfile_relativeEntitlements_feature", "_UI_InventoryProfile_type"),
				 ADPPackage.Literals.INVENTORY_PROFILE__RELATIVE_ENTITLEMENTS,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This adds a property descriptor for the Initial Allocations feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addInitialAllocationsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_InventoryProfile_initialAllocations_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_InventoryProfile_initialAllocations_feature", "_UI_InventoryProfile_type"),
				 ADPPackage.Literals.INVENTORY_PROFILE__INITIAL_ALLOCATIONS,
				 true,
				 false,
				 true,
				 null,
