 ...
 * @generated
 */
public class FuelAmountItemProvider
	 ...
	 * @generated
	 */
	public FuelAmountItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FuelAmount_unit_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FuelAmount_unit_feature", "_UI_FuelAmount_type"),
				 SchedulePackage.Literals.FUEL_AMOUNT__UNIT,
				 true,
				 false,
				 false,
	...
	protected void addQuantityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FuelAmount_quantity_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FuelAmount_quantity_feature", "_UI_FuelAmount_type"),
				 SchedulePackage.Literals.FUEL_AMOUNT__QUANTITY,
				 true,
				 false,
				 false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/FuelAmount"));
	}
	...
	public String getText(Object object) {
		FuelUnit labelValue = ((FuelAmount)object).getUnit();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_FuelAmount_type") :
			getString("_UI_FuelAmount_type") + " " + label;
	}
