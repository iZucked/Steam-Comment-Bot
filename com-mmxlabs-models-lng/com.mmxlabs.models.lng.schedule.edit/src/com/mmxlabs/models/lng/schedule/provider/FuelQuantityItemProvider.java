...
public class FuelQuantityItemProvider
	...
	protected void addBaseFuelPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FuelQuantity_baseFuel_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FuelQuantity_baseFuel_feature", "_UI_FuelQuantity_type"),
				 SchedulePackage.Literals.FUEL_QUANTITY__BASE_FUEL,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SchedulePackage.Literals.FUEL_QUANTITY__AMOUNTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SchedulePackage.Literals.FUEL_QUANTITY__AMOUNTS,
