...
/**
 * This is the item provider adapter for a {@link com.mmxlabs.models.lng.schedule.GroupedCharterOutEvent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GroupedCharterOutEventItemProvider extends EventItemProvider {
	/**
	 ...
	 * @generated
	 */
	public GroupedCharterOutEventItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addLinkedSequencePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_GroupedCharterOutEvent_linkedSequence_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_GroupedCharterOutEvent_linkedSequence_feature", "_UI_GroupedCharterOutEvent_type"),
				 SchedulePackage.Literals.GROUPED_CHARTER_OUT_EVENT__LINKED_SEQUENCE,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns GroupedCharterOutEvent.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/GroupedCharterOutEvent"));
	}
	...
	public String getText(Object object) {
		ZonedDateTime labelValue = ((GroupedCharterOutEvent)object).getStart();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_GroupedCharterOutEvent_type") :
			getString("_UI_GroupedCharterOutEvent_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(GroupedCharterOutEvent.class)) {
