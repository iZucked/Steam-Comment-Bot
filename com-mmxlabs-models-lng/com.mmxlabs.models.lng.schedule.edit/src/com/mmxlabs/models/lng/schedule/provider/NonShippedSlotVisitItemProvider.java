...
public class NonShippedSlotVisitItemProvider extends EventItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SchedulePackage.Literals.NON_SHIPPED_SLOT_VISIT__LATENESS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(NonShippedSlotVisit.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SchedulePackage.Literals.NON_SHIPPED_SLOT_VISIT__LATENESS,
