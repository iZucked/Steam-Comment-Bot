...
/**
 * This is the item provider adapter for a {@link com.mmxlabs.models.lng.parameters.HillClimbOptimisationStage} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HillClimbOptimisationStageItemProvider extends ParallisableOptimisationStageItemProvider {
	 ...
	 * @generated
	 */
	public HillClimbOptimisationStageItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_HillClimbOptimisationStage_seed_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_HillClimbOptimisationStage_seed_feature", "_UI_HillClimbOptimisationStage_type"),
				 ParametersPackage.Literals.HILL_CLIMB_OPTIMISATION_STAGE__SEED,
				 true,
				 false,
				 false,
	...
	/**
	 * This returns HillClimbOptimisationStage.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/HillClimbOptimisationStage"));
	}
	...
	public String getText(Object object) {
		String label = ((HillClimbOptimisationStage)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_HillClimbOptimisationStage_type") :
			getString("_UI_HillClimbOptimisationStage_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(HillClimbOptimisationStage.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ParametersPackage.Literals.HILL_CLIMB_OPTIMISATION_STAGE__ANNEALING_SETTINGS,
