...
/**
 * This is the item provider adapter for a {@link com.mmxlabs.models.lng.parameters.ConstraintsAndFitnessSettingsStage} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConstraintsAndFitnessSettingsStageItemProvider 
	 ...
	 * @generated
	 */
	public ConstraintsAndFitnessSettingsStageItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((ConstraintsAndFitnessSettingsStage)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ConstraintsAndFitnessSettingsStage_type") :
			getString("_UI_ConstraintsAndFitnessSettingsStage_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ConstraintsAndFitnessSettingsStage.class)) {
