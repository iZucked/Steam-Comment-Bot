...
public class PricingAdapterFactory extends AdapterFactoryImpl {
	...
	protected PricingSwitch<Adapter> modelSwitch =
		new PricingSwitch<Adapter>() {
			...
			@Override
			public Adapter caseCooldownPriceEntry(CooldownPriceEntry object) {
				return createCooldownPriceEntryAdapter();
			}
			@Override
			...
			@Override
			public Adapter casePricingCalendarEntry(PricingCalendarEntry object) {
				return createPricingCalendarEntryAdapter();
			}
			@Override
			public Adapter casePricingCalendar(PricingCalendar object) {
				return createPricingCalendarAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.mmxlabs.models.lng.pricing.CooldownPriceEntry <em>Cooldown Price Entry</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.mmxlabs.models.lng.pricing.PricingCalendarEntry <em>Calendar Entry</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.mmxlabs.models.lng.pricing.PricingCalendar <em>Calendar</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
