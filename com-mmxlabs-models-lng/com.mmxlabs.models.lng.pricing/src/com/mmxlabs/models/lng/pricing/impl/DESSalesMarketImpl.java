 ...
 * <ul>
 *   <li>{@link com.mmxlabs.models.lng.pricing.impl.DESSalesMarketImpl#getNotionalPort <em>Notional Port</em>}</li>
 *   <li>{@link com.mmxlabs.models.lng.pricing.impl.DESSalesMarketImpl#getContract <em>Contract</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DESSalesMarketImpl extends SpotMarketImpl implements DESSalesMarket {
	...
	protected EClass eStaticClass() {
		return PricingPackage.Literals.DES_SALES_MARKET;
	}
		...
		if (notionalPort != null && notionalPort.eIsProxy()) {
			...
			if (notionalPort != oldNotionalPort) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PricingPackage.DES_SALES_MARKET__NOTIONAL_PORT, oldNotionalPort, notionalPort));
			}
		}
		return notionalPort;
	}
	...
	public void setNotionalPort(Port newNotionalPort) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PricingPackage.DES_SALES_MARKET__NOTIONAL_PORT, oldNotionalPort, notionalPort));
	}
	...
	public SalesContract getContract() {
		if (contract != null && contract.eIsProxy()) {
			...
			if (contract != oldContract) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PricingPackage.DES_SALES_MARKET__CONTRACT, oldContract, contract));
			}
		}
		return contract;
	}
	...
	public void setContract(SalesContract newContract) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PricingPackage.DES_SALES_MARKET__CONTRACT, oldContract, contract));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PricingPackage.DES_SALES_MARKET__NOTIONAL_PORT:
				if (resolve) return getNotionalPort();
				return basicGetNotionalPort();
			case PricingPackage.DES_SALES_MARKET__CONTRACT:
