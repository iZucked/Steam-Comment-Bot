...
public class DESPurchaseMarketImpl extends SpotMarketImpl implements DESPurchaseMarket {
	...
	protected EClass eStaticClass() {
		return PricingPackage.Literals.DES_PURCHASE_MARKET;
	}
	...
	public void setCv(double newCv) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PricingPackage.DES_PURCHASE_MARKET__CV, oldCv, cv));
	}
	...
	public EList<APortSet> getDestinationPorts() {
		if (destinationPorts == null) {
			destinationPorts = new EObjectResolvingEList<APortSet>(APortSet.class, this, PricingPackage.DES_PURCHASE_MARKET__DESTINATION_PORTS);
		}
