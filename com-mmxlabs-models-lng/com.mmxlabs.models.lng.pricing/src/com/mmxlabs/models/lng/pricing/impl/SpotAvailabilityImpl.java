 ...
 * <ul>
 *   <li>{@link com.mmxlabs.models.lng.pricing.impl.SpotAvailabilityImpl#getConstant <em>Constant</em>}</li>
 *   <li>{@link com.mmxlabs.models.lng.pricing.impl.SpotAvailabilityImpl#getCurve <em>Curve</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SpotAvailabilityImpl extends EObjectImpl implements SpotAvailability {
	...
	protected EClass eStaticClass() {
		return PricingPackage.Literals.SPOT_AVAILABILITY;
	}
	...
	public void setConstant(int newConstant) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PricingPackage.SPOT_AVAILABILITY__CONSTANT, oldConstant, constant, !oldConstantESet));
	}
	...
	public void unsetConstant() {
		...
		constantESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, PricingPackage.SPOT_AVAILABILITY__CONSTANT, oldConstant, CONSTANT_EDEFAULT, oldConstantESet));
	}
	...
	public NotificationChain basicSetCurve(DataIndex<Integer> newCurve, NotificationChain msgs) {
		...
		curveESet = true;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PricingPackage.SPOT_AVAILABILITY__CURVE, oldCurve, newCurve, !oldCurveESet);
	...
	public void setCurve(DataIndex<Integer> newCurve) {
		if (newCurve != curve) {
			...
			if (curve != null)
				msgs = ((InternalEObject)curve).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PricingPackage.SPOT_AVAILABILITY__CURVE, null, msgs);
			if (newCurve != null)
				msgs = ((InternalEObject)newCurve).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PricingPackage.SPOT_AVAILABILITY__CURVE, null, msgs);
			...
			curveESet = true;
			if (eNotificationRequired())
				eNotify(new ENotificationImpl(this, Notification.SET, PricingPackage.SPOT_AVAILABILITY__CURVE, newCurve, newCurve, !oldCurveESet));
		}
	}
	...
	public NotificationChain basicUnsetCurve(NotificationChain msgs) {
		...
		curveESet = false;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.UNSET, PricingPackage.SPOT_AVAILABILITY__CURVE, oldCurve, null, oldCurveESet);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void unsetCurve() {
		if (curve != null) {
			...
			curveESet = false;
			if (eNotificationRequired())
				eNotify(new ENotificationImpl(this, Notification.UNSET, PricingPackage.SPOT_AVAILABILITY__CURVE, null, null, oldCurveESet));
		}
	}
