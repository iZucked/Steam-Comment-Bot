...
/**
 * A component helper for Assignment instances
 *
 * @generated
 */
public class AssignmentComponentHelper extends BaseComponentHelper {
	 ...
	 * @generated
	 */
	public AssignmentComponentHelper() {
	 ...
	 * @generated
	 */
	public AssignmentComponentHelper(IAdapterManager adapterManager) {
		final IComponentHelperRegistry registry = com.mmxlabs.models.ui.Activator.getDefault().getComponentHelperRegistry();
		superClassesHelpers.addAll(registry.getComponentHelpers(MMXCorePackage.Literals.MMX_OBJECT));
	}
	
	/**
	 * add editors to a composite, using Assignment as the supertype
	 *
	 * @generated
	 */
	 @Override
	public void addEditorsToComposite(final IInlineEditorContainer detailComposite) {
		addEditorsToComposite(detailComposite, InputPackage.Literals.ASSIGNMENT);	
	}
	...
	protected void add_vesselsEditor(final IInlineEditorContainer detailComposite, final EClass topClass) {
		detailComposite.addInlineEditor(ComponentHelperUtils.createDefaultEditor(topClass, InputPackage.Literals.ASSIGNMENT__VESSELS));
	}
	/**
	 * Create the editor for the assignToSpot feature on Assignment
	 *
	 * @generated
	 */
	protected void add_assignToSpotEditor(final IInlineEditorContainer detailComposite, final EClass topClass) {
