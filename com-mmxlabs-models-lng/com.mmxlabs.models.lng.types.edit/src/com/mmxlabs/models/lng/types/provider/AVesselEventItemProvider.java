...
/**
 * This is the item provider adapter for a {@link com.mmxlabs.models.lng.types.AVesselEvent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AVesselEventItemProvider extends UUIDObjectItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider,
		IItemPropertySource {
	/**
	 ...
	 * @generated
	 */
	public AVesselEventItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/AVesselEvent"));
	}
	...
	public String getText(Object object) {
		String label = ((AVesselEvent) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_AVesselEvent_type") : getString("_UI_AVesselEvent_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AVesselEvent.class)) {
