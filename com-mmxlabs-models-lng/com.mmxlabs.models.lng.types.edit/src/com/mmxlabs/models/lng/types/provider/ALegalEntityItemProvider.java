...
/**
 * This is the item provider adapter for a {@link com.mmxlabs.models.lng.types.ALegalEntity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ALegalEntityItemProvider extends UUIDObjectItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider,
		IItemPropertySource {
	/**
	 ...
	 * @generated
	 */
	public ALegalEntityItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ALegalEntity"));
	}
	...
	public String getText(Object object) {
		String label = ((ALegalEntity) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_ALegalEntity_type") : getString("_UI_ALegalEntity_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ALegalEntity.class)) {
