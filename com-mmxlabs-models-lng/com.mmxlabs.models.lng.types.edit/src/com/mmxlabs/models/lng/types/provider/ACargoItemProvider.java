 ...
 * @generated
 */
public class ACargoItemProvider extends UUIDObjectItemProvider implements
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_ACargo_type")
				: getString("_UI_ACargo_type") + " " + label;
	}
