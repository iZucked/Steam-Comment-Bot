 ...
 * 
 */
public class MultipleVesselReferenceManipulator extends DialogFeatureManipulator {
	...
	public MultipleVesselReferenceManipulator(final EStructuralFeature field, final ICommandHandler commandHandler, final IReferenceValueProvider valueProvider, final EAttribute nameAttribute) {
		super(field, commandHandler);
		this.valueProvider = valueProvider;
		this.nameAttribute = nameAttribute;
	}

	public MultipleVesselReferenceManipulator(final EStructuralFeature field, final IReferenceValueProviderProvider providerProvider, final ICommandHandler commandHandler,
	...
	protected Object openDialogBox(final Control cellEditorWindow, final Object object) {
		...
		VesselPickerDialog picker = new VesselPickerDialog(cellEditorWindow.getShell(), options.toArray());
