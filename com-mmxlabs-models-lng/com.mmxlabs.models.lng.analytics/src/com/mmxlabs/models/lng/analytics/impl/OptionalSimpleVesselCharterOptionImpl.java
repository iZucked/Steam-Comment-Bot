 ...
 * </p>
 * <ul>
 *   <li>{@link com.mmxlabs.models.lng.analytics.impl.OptionalSimpleVesselCharterOptionImpl#getBallastBonus <em>Ballast Bonus</em>}</li>
 *   <li>{@link com.mmxlabs.models.lng.analytics.impl.OptionalSimpleVesselCharterOptionImpl#getRepositioningFee <em>Repositioning Fee</em>}</li>
 *   <li>{@link com.mmxlabs.models.lng.analytics.impl.OptionalSimpleVesselCharterOptionImpl#getStart <em>Start</em>}</li>
 *   <li>{@link com.mmxlabs.models.lng.analytics.impl.OptionalSimpleVesselCharterOptionImpl#getEnd <em>End</em>}</li>
 *   <li>{@link com.mmxlabs.models.lng.analytics.impl.OptionalSimpleVesselCharterOptionImpl#getStartPort <em>Start Port</em>}</li>
 *   <li>{@link com.mmxlabs.models.lng.analytics.impl.OptionalSimpleVesselCharterOptionImpl#getEndPort <em>End Port</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OptionalSimpleVesselCharterOptionImpl extends SimpleVesselCharterOptionImpl implements OptionalSimpleVesselCharterOption {
	/**
	 ...
	 * @generated
	 */
	protected OptionalSimpleVesselCharterOptionImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return AnalyticsPackage.Literals.OPTIONAL_SIMPLE_VESSEL_CHARTER_OPTION;
	}
	...
	public void setBallastBonus(String newBallastBonus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnalyticsPackage.OPTIONAL_SIMPLE_VESSEL_CHARTER_OPTION__BALLAST_BONUS, oldBallastBonus, ballastBonus));
	}
	...
	public void setRepositioningFee(String newRepositioningFee) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnalyticsPackage.OPTIONAL_SIMPLE_VESSEL_CHARTER_OPTION__REPOSITIONING_FEE, oldRepositioningFee, repositioningFee));
	}
	...
	public void setStart(LocalDate newStart) {
		...
		start = newStart;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnalyticsPackage.OPTIONAL_SIMPLE_VESSEL_CHARTER_OPTION__START, oldStart, start));
	}
	...
	public void setEnd(LocalDate newEnd) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnalyticsPackage.OPTIONAL_SIMPLE_VESSEL_CHARTER_OPTION__END, oldEnd, end));
	}
	...
	public Port getStartPort() {
		if (startPort != null && startPort.eIsProxy()) {
			...
			if (startPort != oldStartPort) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AnalyticsPackage.OPTIONAL_SIMPLE_VESSEL_CHARTER_OPTION__START_PORT, oldStartPort, startPort));
			}
		}
		return startPort;
	}
	...
	public void setStartPort(Port newStartPort) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnalyticsPackage.OPTIONAL_SIMPLE_VESSEL_CHARTER_OPTION__START_PORT, oldStartPort, startPort));
	}
	...
	public Port getEndPort() {
		if (endPort != null && endPort.eIsProxy()) {
			...
			if (endPort != oldEndPort) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AnalyticsPackage.OPTIONAL_SIMPLE_VESSEL_CHARTER_OPTION__END_PORT, oldEndPort, endPort));
			}
		}
		return endPort;
	}
	...
	public void setEndPort(Port newEndPort) {
		...
		endPort = newEndPort;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnalyticsPackage.OPTIONAL_SIMPLE_VESSEL_CHARTER_OPTION__END_PORT, oldEndPort, endPort));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case AnalyticsPackage.OPTIONAL_SIMPLE_VESSEL_CHARTER_OPTION__END:
				return getEnd();
			case AnalyticsPackage.OPTIONAL_SIMPLE_VESSEL_CHARTER_OPTION__START_PORT:
				if (resolve) return getStartPort();
				return basicGetStartPort();
			case AnalyticsPackage.OPTIONAL_SIMPLE_VESSEL_CHARTER_OPTION__END_PORT:
