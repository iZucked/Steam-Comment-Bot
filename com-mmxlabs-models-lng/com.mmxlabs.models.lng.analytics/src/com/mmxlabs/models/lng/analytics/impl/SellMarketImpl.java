...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Sell Market</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.mmxlabs.models.lng.analytics.impl.SellMarketImpl#getMarket <em>Market</em>}</li>
 *   <li>{@link com.mmxlabs.models.lng.analytics.impl.SellMarketImpl#getMonth <em>Month</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SellMarketImpl extends UUIDObjectImpl implements SellMarket {
	...
	protected EClass eStaticClass() {
		return AnalyticsPackage.Literals.SELL_MARKET;
	}
		...
		if (market != null && market.eIsProxy()) {
			...
			if (market != oldMarket) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AnalyticsPackage.SELL_MARKET__MARKET, oldMarket, market));
			}
		}
		return market;
	}
	...
	public void setMarket(SpotMarket newMarket) {
		...
		market = newMarket;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnalyticsPackage.SELL_MARKET__MARKET, oldMarket, market));
	}
	...
	public void setMonth(YearMonth newMonth) {
		...
		monthESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnalyticsPackage.SELL_MARKET__MONTH, oldMonth, month, !oldMonthESet));
	}
	...
	public void unsetMonth() {
		...
		monthESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AnalyticsPackage.SELL_MARKET__MONTH, oldMonth, MONTH_EDEFAULT, oldMonthESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AnalyticsPackage.SELL_MARKET__MARKET:
