 ...
 * 
 */
public class BuyReferenceReferenceValueProvider extends BaseReferenceValueProvider {
	protected final MMXRootObject rootObject;

	public BuyReferenceReferenceValueProvider(final MMXRootObject rootObject) {
	...
	public List<Pair<String, EObject>> getAllowedValues(final EObject target, final EStructuralFeature field) {
		...
		if (rootObject instanceof LNGScenarioModel) {
			...
			final List<LoadSlot> options = new LinkedList<>(cargoModel.getLoadSlots());
	...
	private @NonNull String getName(LoadSlot slot) {
