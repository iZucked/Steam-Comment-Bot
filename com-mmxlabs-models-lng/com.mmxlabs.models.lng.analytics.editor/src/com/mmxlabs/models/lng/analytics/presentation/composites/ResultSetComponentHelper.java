...
/**
 * A component helper for ResultSet instances
 *
 * @generated
 */
public class ResultSetComponentHelper extends BaseComponentHelper {
	 ...
	 * @generated
	 */
	public ResultSetComponentHelper() {
	 ...
	 * @generated
	 */
	public ResultSetComponentHelper(IAdapterManager adapterManager) {
		final IComponentHelperRegistry registry = com.mmxlabs.models.ui.Activator.getDefault().getComponentHelperRegistry();
	}
	
	/**
	 * add editors to a composite, using ResultSet as the supertype
	 *
	 * @generated
	 */
	 @Override
	public void addEditorsToComposite(final IInlineEditorContainer detailComposite) {
		addEditorsToComposite(detailComposite, AnalyticsPackage.Literals.RESULT_SET);	
	}
	...
	protected void add_rowsEditor(final IInlineEditorContainer detailComposite, final EClass topClass) {
		detailComposite.addInlineEditor(ComponentHelperUtils.createDefaultEditor(topClass, AnalyticsPackage.Literals.RESULT_SET__ROWS));
	}
	/**
	 * Create the editor for the profitAndLoss feature on ResultSet
	 *
	 * @generated
	 */
