 ...
 * 
 */
public class PartialCaseRowOptionsTopLevelComposite extends DefaultTopLevelComposite {
	...
	public PartialCaseRowOptionsTopLevelComposite(final Composite parent, final int style, final IDialogEditingContext dialogContext, final FormToolkit toolkit) {
	...
	public void display(final IDialogEditingContext dialogContext, final MMXRootObject root, final EObject object, final Collection<EObject> range, final EMFDataBindingContext dbc) {
		...
		AnalyticsPackage.Literals.PARTIAL_CASE_ROW_OPTIONS.getEAllStructuralFeatures().forEach(f -> {
