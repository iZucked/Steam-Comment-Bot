...
public class CommodityCurveLabelProvider extends DefaultSandboxLabelProvider {

	public CommodityCurveLabelProvider(SandboxUIHelper sandboxUIHelper, final ICellRenderer renderer, Map<Object, IStatus> validationErrors, String name, final ETypedElement... pathObjects) {
		super(sandboxUIHelper, renderer, validationErrors, name, pathObjects);
	}

	public CommodityCurveLabelProvider(SandboxUIHelper sandboxUIHelper, ICellRenderer renderer, Map<Object, IStatus> validationErrors, String name, @Nullable EMFPath path) {
