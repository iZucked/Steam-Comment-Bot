...
public class CommodityCurveOptionsContextMenuManager implements MenuDetectListener {
	...
	public CommodityCurveOptionsContextMenuManager(@NonNull final GridTreeViewer viewer, @NonNull final IScenarioEditingLocation scenarioEditingLocation, @NonNull final MenuManager mgr) {
		this.mgr = mgr;
	...
	public void menuDetected(final MenuDetectEvent e) {
		...
		if (items.length == 1) {
			...
			final CommodityCurveOption row = (CommodityCurveOption) ed;
			if (row instanceof CommodityCurveOverlay commodityCurveOverlay) {
