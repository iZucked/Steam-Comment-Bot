...
/**
 * This is the item provider adapter for a {@link com.mmxlabs.models.lng.analytics.ResultSet} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ResultSetItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ResultSet_profitAndLoss_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ResultSet_profitAndLoss_feature", "_UI_ResultSet_type"),
				 AnalyticsPackage.Literals.RESULT_SET__PROFIT_AND_LOSS,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_ResultSet_type") + " " + resultSet.getProfitAndLoss();
	}
