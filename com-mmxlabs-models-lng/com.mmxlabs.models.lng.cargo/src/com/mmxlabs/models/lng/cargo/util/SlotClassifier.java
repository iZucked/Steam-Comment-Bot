...
public final class SlotClassifier {
	...
	public static enum SlotType{FOB_Buy, DES_Buy, DES_Buy_AnyDisPort, DES_Sale, FOB_Sale, FOB_Sale_AnyLoadPort};

	public static @NonNull SlotType classify(@NonNull Slot slot){		

		EList<PortCapability> caps = slot.getPort().getCapabilities();
