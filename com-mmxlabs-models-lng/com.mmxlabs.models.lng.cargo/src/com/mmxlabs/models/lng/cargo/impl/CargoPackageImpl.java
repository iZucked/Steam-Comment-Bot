...
public class CargoPackageImpl extends EPackageImpl implements CargoPackage {
	...
	public EReference getSlot_RestrictedSlots() {
		return (EReference)slotEClass.getEStructuralFeatures().get(34);
	}
	...
	public EReference getSlot_RestrictedVessels() {
		return (EReference)slotEClass.getEStructuralFeatures().get(31);
	}
	...
	public EAttribute getSlot_RestrictedVesselsOverride() {
		return (EAttribute)slotEClass.getEStructuralFeatures().get(33);
	}
	...
	public EReference getSlot_NominatedVessel() {
		return (EReference)slotEClass.getEStructuralFeatures().get(39);
	}
	 ...
	 */
	@Override
	public EOperation getSlot__GetSlotOrDelegateWindowSize() {
	 ...
	 */
	@Override
	public EOperation getSlot__GetSlotOrDelegateWindowSizeUnits() {
	 ...
	 */
	@Override
	public EOperation getSlot__GetSlotOrDelegateFlex() {
	 ...
	 */
	@Override
	public EOperation getSlot__GetWindowFlexInHours() {
	 ...
	 */
	@Override
	public EOperation getVesselAvailability__GetAvailabilityOrCharterContractBallastBonusContract() {
	 ...
	 */
	@Override
	public EOperation getVesselAvailability__GetAvailabilityOrContractMinDuration() {
	 ...
	 */
	@Override
	public EOperation getVesselAvailability__GetAvailabilityOrContractMaxDuration() {
	...
	public void createPackageContents() {
		...
		createEOperation(slotEClass, SLOT___GET_SLOT_OR_DELEGATE_WINDOW_SIZE);
		createEOperation(slotEClass, SLOT___GET_SLOT_OR_DELEGATE_WINDOW_SIZE_UNITS);
		...
		createEOperation(slotEClass, SLOT___GET_SLOT_OR_DELEGATE_FLEX);
		createEOperation(slotEClass, SLOT___GET_WINDOW_FLEX_IN_HOURS);
	...
	public void initializePackageContents() {
		...
		initEOperation(getSlot__GetSlotOrDelegateWindowSize(), ecorePackage.getEInt(), "getSlotOrDelegateWindowSize", 1, 1, IS_UNIQUE, IS_ORDERED);

		initEOperation(getSlot__GetSlotOrDelegateWindowSizeUnits(), theTypesPackage.getTimePeriod(), "getSlotOrDelegateWindowSizeUnits", 1, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEOperation(getSlot__GetSlotOrDelegateFlex(), ecorePackage.getEInt(), "getSlotOrDelegateFlex", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEOperation(getSlot__GetWindowFlexInHours(), ecorePackage.getEInt(), "getWindowFlexInHours", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEOperation(getVesselAvailability__GetAvailabilityOrCharterContractBallastBonusContract(), theCommercialPackage.getBallastBonusContract(), "getAvailabilityOrCharterContractBallastBonusContract", 1, 1, IS_UNIQUE, IS_ORDERED);
