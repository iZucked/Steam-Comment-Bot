...
public class EuEtsEditorView extends ScenarioInstanceView implements CommandStackListener {
	/**
	 * The ID of the view as specified by the extension.
	 */
	public static final String ID = "com.mmxlabs.models.lng.cargo.editor.views.EuEtsEditorView";
