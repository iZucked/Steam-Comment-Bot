...
public class RouteOptionEditorPane extends ScenarioTableViewerPane {
	...
	public void init(final List<EReference> path, final AdapterFactory adapterFactory, final CommandStack commandStack) {
		...
		addTypicalColumn("Entry Point", new SingleReferenceManipulator(CargoPackage.eINSTANCE.getCanalBookingSlot_EntryPoint(), scenarioEditingLocation.getReferenceValueProviderCache(), getEditingDomain()));
...
//			@Override
//			public void run() {
//				final DetailCompositeDialog dcd = new DetailCompositeDialog(RouteOptionEditorPane.this.getJointModelEditorPart().getShell(),
//						RouteOptionEditorPane.this.getJointModelEditorPart().getDefaultCommandHandler());
...
//		getToolBarManager().update(true);
		...
		defaultSetTitle("Canal Slot Bookings");
		...
		protected Action createMatrixEditor(final String name, final Route distanceModel) {
			return new LockableAction("Edit distances...") {
				...
				private Route edit(final Route distanceModel) {
					...
					if (ded.open(RouteOptionEditorPane.this.part.getSite(), getJointModelEditorPart(), distanceModel) == Window.OK) {
