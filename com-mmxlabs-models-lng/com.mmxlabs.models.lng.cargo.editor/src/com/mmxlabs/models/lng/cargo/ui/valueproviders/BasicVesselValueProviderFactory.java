...
public class BasicVesselValueProviderFactory implements IReferenceValueProviderFactory {
	...
	private IReferenceValueProviderFactory vesselAvailabilityProviderFactory;
	private IReferenceValueProviderFactory charterInMarketProviderFactory;

	public BasicVesselValueProviderFactory() {
			...
			return new IReferenceValueProvider() {
				...
				public List<Pair<String, EObject>> getAllowedValues(EObject target, final EStructuralFeature field) {
					...
					for (final Pair<String, EObject> pair : charterInMarketResult) {
						...
						//
						// // // determine the vessel class (if any) for this option
						// VesselClass vc = charterInMarket.getVesselClass();
						// // if (vessel instanceof Vessel) {
						// // vc = ((Vessel) vessel).getVesselClass();
						// // }
						// //
