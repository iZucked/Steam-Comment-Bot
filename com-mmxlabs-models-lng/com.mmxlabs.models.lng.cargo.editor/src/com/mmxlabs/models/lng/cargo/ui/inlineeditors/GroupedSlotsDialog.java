...
public class GroupedSlotsDialog extends FormDialog {
	...
	private void createFormArea(final IManagedForm mform) {
		...
		mainPane.setLayoutData(new GridData(GridData.FILL_BOTH));
		{
			...
			final IReferenceValueProvider dischargeSlotProvider = commandHandler.getReferenceValueProviderProvider().getReferenceValueProvider(CargoPackage.eINSTANCE.getGroupedDischargeSlotsConstraint(), CargoPackage.eINSTANCE.getGroupedSlotsConstraint_Slots());
			final MultipleReferenceManipulator slotsManipulator = new MultipleReferenceManipulator(CargoPackage.eINSTANCE.getGroupedSlotsConstraint_Slots(), commandHandler, dischargeSlotProvider, MMXCorePackage.eINSTANCE.getNamedObject_Name());
