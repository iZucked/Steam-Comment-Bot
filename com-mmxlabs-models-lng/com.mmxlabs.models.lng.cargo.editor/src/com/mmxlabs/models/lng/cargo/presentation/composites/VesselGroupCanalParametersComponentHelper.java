...
/**
 * A component helper for VesselGroupCanalParameters instances
 *
 * @generated
 */
public class VesselGroupCanalParametersComponentHelper extends BaseComponentHelper {
	 ...
	 * @generated
	 */
	public VesselGroupCanalParametersComponentHelper() {
	 ...
	 * @generated
	 */
	public VesselGroupCanalParametersComponentHelper(IAdapterManager adapterManager) {
		final IComponentHelperRegistry registry = com.mmxlabs.models.ui.Activator.getDefault().getComponentHelperRegistry();
		superClassesHelpers.addAll(registry.getComponentHelpers(MMXCorePackage.Literals.NAMED_OBJECT));
	}
	
	/**
	 * add editors to a composite, using VesselGroupCanalParameters as the supertype
	 *
	 * @generated
	 */
	 @Override
	public void addEditorsToComposite(final IInlineEditorContainer detailComposite) {
		addEditorsToComposite(detailComposite, CargoPackage.Literals.VESSEL_GROUP_CANAL_PARAMETERS);	
	}
	 ...
	 * @generated
	 */
	protected void add_vesselGroupEditor(final IInlineEditorContainer detailComposite, final EClass topClass) {
		detailComposite.addInlineEditor(ComponentHelperUtils.createDefaultEditor(topClass, CargoPackage.Literals.VESSEL_GROUP_CANAL_PARAMETERS__VESSEL_GROUP));
	}
}