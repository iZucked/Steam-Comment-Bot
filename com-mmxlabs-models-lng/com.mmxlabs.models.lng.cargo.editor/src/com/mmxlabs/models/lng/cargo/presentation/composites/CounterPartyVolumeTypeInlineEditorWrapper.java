...
/**
 * Implementation of {@link IInlineEditorExternalNotificationListener} to disable editor for non DES Sales
 * 
 * @author FM
 * 
 */
public class CounterPartyVolumeTypeInlineEditorWrapper extends IInlineEditorEnablementWrapper {
	private boolean wrapperEnabled = false;

	public CounterPartyVolumeTypeInlineEditorWrapper(@NonNull final IInlineEditor wrapped) {
		super(wrapped);
	}
