...
/**
 * A component helper for VesselEventSpecification instances
 *
 * @generated
 */
public class VesselEventSpecificationComponentHelper extends BaseComponentHelper {
	 ...
	 * @generated
	 */
	public VesselEventSpecificationComponentHelper() {
	 ...
	 * @generated
	 */
	public VesselEventSpecificationComponentHelper(IAdapterManager adapterManager) {
		final IComponentHelperRegistry registry = com.mmxlabs.models.ui.Activator.getDefault().getComponentHelperRegistry();
		superClassesHelpers.addAll(registry.getComponentHelpers(CargoPackage.Literals.SCHEDULE_SPECIFICATION_EVENT));
	}
	
	/**
	 * add editors to a composite, using VesselEventSpecification as the supertype
	 *
	 * @generated
	 */
	 @Override
	public void addEditorsToComposite(final IInlineEditorContainer detailComposite) {
		addEditorsToComposite(detailComposite, CargoPackage.Literals.VESSEL_EVENT_SPECIFICATION);	
	}
