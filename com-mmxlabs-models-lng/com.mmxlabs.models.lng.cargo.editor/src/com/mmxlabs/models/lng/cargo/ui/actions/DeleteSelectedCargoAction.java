							...
							for (int i = 0; i < size; i++) {
								...
								if (cargo != null) {
									...
									if (!useResponseForAll) {
										...
										final MessageDialogWithCheckbox dialog = new MessageDialogWithCheckbox(shell, dialogTitle, null, dialogMessage, MessageDialog.QUESTION, dialogOptions,
												ALLBUTTON, checkboxTitle, dialogDefault && showCheckbox) {
