...
public class CanalBookingBookingCodeValueProviderFactory implements IReferenceValueProviderFactory {
	@Override
	public IReferenceValueProvider createReferenceValueProvider(final EClass owner, final EReference reference, final MMXRootObject theRootObject) {
		...
		return new SimpleReferenceValueProvider(((LNGScenarioModel) theRootObject).getCargoModel().getCanalBookings(), CargoPackage.eINSTANCE.getCanalBookings_VesselGroupCanalParameters()) {
