 ...
 * @generated
 */
public class ConstraintComponentHelper implements IComponentHelper {
	...
	public void addEditorsToComposite(final IInlineEditorContainer detailComposite) {
		addEditorsToComposite(detailComposite, OptimiserPackage.Literals.CONSTRAINT);	
	}
	...
	protected void add_enabledEditor(final IInlineEditorContainer detailComposite, final EClass topClass) {
		detailComposite.addInlineEditor(ComponentHelperUtils.createDefaultEditor(topClass, OptimiserPackage.Literals.CONSTRAINT__ENABLED));
	}
}