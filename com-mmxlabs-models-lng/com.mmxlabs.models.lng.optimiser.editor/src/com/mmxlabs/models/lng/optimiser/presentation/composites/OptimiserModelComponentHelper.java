 ...
 * @generated
 */
public class OptimiserModelComponentHelper extends BaseComponentHelper {
	 ...
	 * @generated
	 */
	public OptimiserModelComponentHelper() {
	 ...
	 * @generated
	 */
	public OptimiserModelComponentHelper(IAdapterManager adapterManager) {
		final IComponentHelperRegistry registry = com.mmxlabs.models.ui.Activator.getDefault().getComponentHelperRegistry();
		superClassesHelpers.addAll(registry.getComponentHelpers(MMXCorePackage.Literals.UUID_OBJECT));
	}
	
	/**
	 * add editors to a composite, using OptimiserModel as the supertype
	 *
	 * @generated
	 */
	 @Override
	public void addEditorsToComposite(final IInlineEditorContainer detailComposite) {
		addEditorsToComposite(detailComposite, OptimiserPackage.Literals.OPTIMISER_MODEL);	
	}
