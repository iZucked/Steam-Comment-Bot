...
public class OptimiserSettingsComponentHelper extends BaseComponentHelper {
	...
	public void addEditorsToComposite(final IInlineEditorContainer detailComposite) {
		addEditorsToComposite(detailComposite, OptimiserPackage.Literals.OPTIMISER_SETTINGS);	
	}
	...
	protected void add_objectivesEditor(final IInlineEditorContainer detailComposite, final EClass topClass) {
		detailComposite.addInlineEditor(ComponentHelperUtils.createDefaultEditor(topClass, OptimiserPackage.Literals.OPTIMISER_SETTINGS__OBJECTIVES));
	}
	/**
	...
	protected void add_constraintsEditor(final IInlineEditorContainer detailComposite, final EClass topClass) {
		detailComposite.addInlineEditor(ComponentHelperUtils.createDefaultEditor(topClass, OptimiserPackage.Literals.OPTIMISER_SETTINGS__CONSTRAINTS));
	}
	/**
	...
	protected void add_rangeEditor(final IInlineEditorContainer detailComposite, final EClass topClass) {
		detailComposite.addInlineEditor(ComponentHelperUtils.createDefaultEditor(topClass, OptimiserPackage.Literals.OPTIMISER_SETTINGS__RANGE));
	}
	/**
	...
	protected void add_annealingSettingsEditor(final IInlineEditorContainer detailComposite, final EClass topClass) {
		detailComposite.addInlineEditor(ComponentHelperUtils.createDefaultEditor(topClass, OptimiserPackage.Literals.OPTIMISER_SETTINGS__ANNEALING_SETTINGS));
	}
	/**
	...
	protected void add_seedEditor(final IInlineEditorContainer detailComposite, final EClass topClass) {
		detailComposite.addInlineEditor(ComponentHelperUtils.createDefaultEditor(topClass, OptimiserPackage.Literals.OPTIMISER_SETTINGS__SEED));
	}
	/**
