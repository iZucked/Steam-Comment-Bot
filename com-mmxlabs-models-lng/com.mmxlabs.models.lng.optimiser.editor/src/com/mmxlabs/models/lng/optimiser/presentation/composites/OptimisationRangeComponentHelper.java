 ...
 * @generated
 */
public class OptimisationRangeComponentHelper implements IComponentHelper {
	...
	public void addEditorsToComposite(final IInlineEditorContainer detailComposite) {
		addEditorsToComposite(detailComposite, OptimiserPackage.Literals.OPTIMISATION_RANGE);	
	}
	...
	protected void add_optimiseAfterEditor(final IInlineEditorContainer detailComposite, final EClass topClass) {
		detailComposite.addInlineEditor(ComponentHelperUtils.createDefaultEditor(topClass, OptimiserPackage.Literals.OPTIMISATION_RANGE__OPTIMISE_AFTER));
	}
	/**
	...
	protected void add_optimiseBeforeEditor(final IInlineEditorContainer detailComposite, final EClass topClass) {
		detailComposite.addInlineEditor(ComponentHelperUtils.createDefaultEditor(topClass, OptimiserPackage.Literals.OPTIMISATION_RANGE__OPTIMISE_BEFORE));
	}
}