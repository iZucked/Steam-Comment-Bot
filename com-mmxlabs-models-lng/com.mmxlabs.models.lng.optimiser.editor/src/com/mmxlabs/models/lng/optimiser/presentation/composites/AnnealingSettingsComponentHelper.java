 ...
 * @generated
 */
public class AnnealingSettingsComponentHelper implements IComponentHelper {
	...
	public void addEditorsToComposite(final IInlineEditorContainer detailComposite) {
		addEditorsToComposite(detailComposite, OptimiserPackage.Literals.ANNEALING_SETTINGS);	
	}
	...
	protected void add_iterationsEditor(final IInlineEditorContainer detailComposite, final EClass topClass) {
		detailComposite.addInlineEditor(ComponentHelperUtils.createDefaultEditor(topClass, OptimiserPackage.Literals.ANNEALING_SETTINGS__ITERATIONS));
	}
	/**
	...
	protected void add_epochLengthEditor(final IInlineEditorContainer detailComposite, final EClass topClass) {
		detailComposite.addInlineEditor(ComponentHelperUtils.createDefaultEditor(topClass, OptimiserPackage.Literals.ANNEALING_SETTINGS__EPOCH_LENGTH));
	}
	/**
	...
	protected void add_coolingEditor(final IInlineEditorContainer detailComposite, final EClass topClass) {
		detailComposite.addInlineEditor(ComponentHelperUtils.createDefaultEditor(topClass, OptimiserPackage.Literals.ANNEALING_SETTINGS__COOLING));
	}
	/**
	...
	protected void add_initialTemperatureEditor(final IInlineEditorContainer detailComposite, final EClass topClass) {
		detailComposite.addInlineEditor(ComponentHelperUtils.createDefaultEditor(topClass, OptimiserPackage.Literals.ANNEALING_SETTINGS__INITIAL_TEMPERATURE));
	}
}