...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Grouped Charter Length Event</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.mmxlabs.models.lng.schedule.impl.GroupedCharterLengthEventImpl#getEvents <em>Events</em>}</li>
 *   <li>{@link com.mmxlabs.models.lng.schedule.impl.GroupedCharterLengthEventImpl#getGroupProfitAndLoss <em>Group Profit And Loss</em>}</li>
 *   <li>{@link com.mmxlabs.models.lng.schedule.impl.GroupedCharterLengthEventImpl#getGeneralPNLDetails <em>General PNL Details</em>}</li>
 *   <li>{@link com.mmxlabs.models.lng.schedule.impl.GroupedCharterLengthEventImpl#getLinkedSequence <em>Linked Sequence</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GroupedCharterLengthEventImpl extends EventImpl implements GroupedCharterLengthEvent {
	/**
	 ...
	 * @generated
	 */
	protected GroupedCharterLengthEventImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return SchedulePackage.Literals.GROUPED_CHARTER_LENGTH_EVENT;
	}
	...
	public NotificationChain basicSetGroupProfitAndLoss(GroupProfitAndLoss newGroupProfitAndLoss, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SchedulePackage.GROUPED_CHARTER_LENGTH_EVENT__GROUP_PROFIT_AND_LOSS, oldGroupProfitAndLoss, newGroupProfitAndLoss);
	...
	public void setGroupProfitAndLoss(GroupProfitAndLoss newGroupProfitAndLoss) {
		if (newGroupProfitAndLoss != groupProfitAndLoss) {
			...
			if (groupProfitAndLoss != null)
				msgs = ((InternalEObject)groupProfitAndLoss).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SchedulePackage.GROUPED_CHARTER_LENGTH_EVENT__GROUP_PROFIT_AND_LOSS, null, msgs);
			if (newGroupProfitAndLoss != null)
				msgs = ((InternalEObject)newGroupProfitAndLoss).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SchedulePackage.GROUPED_CHARTER_LENGTH_EVENT__GROUP_PROFIT_AND_LOSS, null, msgs);
			msgs = basicSetGroupProfitAndLoss(newGroupProfitAndLoss, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SchedulePackage.GROUPED_CHARTER_LENGTH_EVENT__GROUP_PROFIT_AND_LOSS, newGroupProfitAndLoss, newGroupProfitAndLoss));
	}
	...
	public Sequence getLinkedSequence() {
		if (linkedSequence != null && linkedSequence.eIsProxy()) {
			...
			if (linkedSequence != oldLinkedSequence) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SchedulePackage.GROUPED_CHARTER_LENGTH_EVENT__LINKED_SEQUENCE, oldLinkedSequence, linkedSequence));
			}
		}
	...
	public void setLinkedSequence(Sequence newLinkedSequence) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SchedulePackage.GROUPED_CHARTER_LENGTH_EVENT__LINKED_SEQUENCE, oldLinkedSequence, linkedSequence));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SchedulePackage.GROUPED_CHARTER_LENGTH_EVENT__EVENTS:
				return getEvents();
			case SchedulePackage.GROUPED_CHARTER_LENGTH_EVENT__GROUP_PROFIT_AND_LOSS:
				return getGroupProfitAndLoss();
			case SchedulePackage.GROUPED_CHARTER_LENGTH_EVENT__GENERAL_PNL_DETAILS:
				return getGeneralPNLDetails();
			case SchedulePackage.GROUPED_CHARTER_LENGTH_EVENT__LINKED_SEQUENCE:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == EventGrouping.class) {
			switch (derivedFeatureID) {
				case SchedulePackage.GROUPED_CHARTER_LENGTH_EVENT__EVENTS: return SchedulePackage.EVENT_GROUPING__EVENTS;
				default: return -1;
			}
		}
		if (baseClass == ProfitAndLossContainer.class) {
			switch (derivedFeatureID) {
				case SchedulePackage.GROUPED_CHARTER_LENGTH_EVENT__GROUP_PROFIT_AND_LOSS: return SchedulePackage.PROFIT_AND_LOSS_CONTAINER__GROUP_PROFIT_AND_LOSS;
				case SchedulePackage.GROUPED_CHARTER_LENGTH_EVENT__GENERAL_PNL_DETAILS: return SchedulePackage.PROFIT_AND_LOSS_CONTAINER__GENERAL_PNL_DETAILS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == EventGrouping.class) {
			switch (baseFeatureID) {
				case SchedulePackage.EVENT_GROUPING__EVENTS: return SchedulePackage.GROUPED_CHARTER_LENGTH_EVENT__EVENTS;
				default: return -1;
			}
		}
		if (baseClass == ProfitAndLossContainer.class) {
			switch (baseFeatureID) {
				case SchedulePackage.PROFIT_AND_LOSS_CONTAINER__GROUP_PROFIT_AND_LOSS: return SchedulePackage.GROUPED_CHARTER_LENGTH_EVENT__GROUP_PROFIT_AND_LOSS;
				case SchedulePackage.PROFIT_AND_LOSS_CONTAINER__GENERAL_PNL_DETAILS: return SchedulePackage.GROUPED_CHARTER_LENGTH_EVENT__GENERAL_PNL_DETAILS;
				default: return -1;
			}
		}
