 ...
 *   <li>{@link com.mmxlabs.models.lng.schedule.impl.EndEventImpl#getHeelCostUnitPrice <em>Heel Cost Unit Price</em>}</li>
 *   <li>{@link com.mmxlabs.models.lng.schedule.impl.EndEventImpl#getHeelRevenueUnitPrice <em>Heel Revenue Unit Price</em>}</li>
...
public class EndEventImpl extends EventImpl implements EndEvent {
	...
	public void setHeelCostUnitPrice(double newHeelCostUnitPrice) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SchedulePackage.END_EVENT__HEEL_COST_UNIT_PRICE, oldHeelCostUnitPrice, heelCostUnitPrice));
	}
	...
	public void setHeelRevenueUnitPrice(double newHeelRevenueUnitPrice) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SchedulePackage.END_EVENT__HEEL_REVENUE_UNIT_PRICE, oldHeelRevenueUnitPrice, heelRevenueUnitPrice));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == PortVisit.class) {
			switch (derivedFeatureID) {
				...
				case SchedulePackage.END_EVENT__HEEL_COST_UNIT_PRICE: return SchedulePackage.PORT_VISIT__HEEL_COST_UNIT_PRICE;
				case SchedulePackage.END_EVENT__HEEL_REVENUE_UNIT_PRICE: return SchedulePackage.PORT_VISIT__HEEL_REVENUE_UNIT_PRICE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == PortVisit.class) {
			switch (baseFeatureID) {
				...
				case SchedulePackage.PORT_VISIT__HEEL_COST_UNIT_PRICE: return SchedulePackage.END_EVENT__HEEL_COST_UNIT_PRICE;
				case SchedulePackage.PORT_VISIT__HEEL_REVENUE_UNIT_PRICE: return SchedulePackage.END_EVENT__HEEL_REVENUE_UNIT_PRICE;
				default: return -1;
			}
		}
		if (baseClass == ProfitAndLossContainer.class) {
