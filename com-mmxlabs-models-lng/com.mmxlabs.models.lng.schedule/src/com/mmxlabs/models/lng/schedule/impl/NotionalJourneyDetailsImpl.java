...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Notional Journey Details</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 *   <li>{@link com.mmxlabs.models.lng.schedule.impl.NotionalJourneyDetailsImpl#getTotalFuelCost <em>Total Fuel Cost</em>}</li>
 *   <li>{@link com.mmxlabs.models.lng.schedule.impl.NotionalJourneyDetailsImpl#getHireRate <em>Hire Rate</em>}</li>
 *   <li>{@link com.mmxlabs.models.lng.schedule.impl.NotionalJourneyDetailsImpl#getHireCost <em>Hire Cost</em>}</li>
 *   <li>{@link com.mmxlabs.models.lng.schedule.impl.NotionalJourneyDetailsImpl#getRouteTaken <em>Route Taken</em>}</li>
 *   <li>{@link com.mmxlabs.models.lng.schedule.impl.NotionalJourneyDetailsImpl#getCanalCost <em>Canal Cost</em>}</li>
 *   <li>{@link com.mmxlabs.models.lng.schedule.impl.NotionalJourneyDetailsImpl#getLumpSum <em>Lump Sum</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NotionalJourneyDetailsImpl extends MatchingContractDetailsImpl implements NotionalJourneyDetails {
	/**
	 ...
	 * @generated
	 */
	protected NotionalJourneyDetailsImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return SchedulePackage.Literals.NOTIONAL_JOURNEY_DETAILS;
	}
	...
	public void setDistance(int newDistance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SchedulePackage.NOTIONAL_JOURNEY_DETAILS__DISTANCE, oldDistance, distance));
	}
	...
	public void setTotalTimeInDays(double newTotalTimeInDays) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SchedulePackage.NOTIONAL_JOURNEY_DETAILS__TOTAL_TIME_IN_DAYS, oldTotalTimeInDays, totalTimeInDays));
	}
	...
	public void setTotalFuelUsed(int newTotalFuelUsed) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SchedulePackage.NOTIONAL_JOURNEY_DETAILS__TOTAL_FUEL_USED, oldTotalFuelUsed, totalFuelUsed));
	}
	...
	public void setFuelPrice(double newFuelPrice) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SchedulePackage.NOTIONAL_JOURNEY_DETAILS__FUEL_PRICE, oldFuelPrice, fuelPrice));
	}
	...
	public void setTotalFuelCost(int newTotalFuelCost) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SchedulePackage.NOTIONAL_JOURNEY_DETAILS__TOTAL_FUEL_COST, oldTotalFuelCost, totalFuelCost));
	}
	...
	public void setHireRate(int newHireRate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SchedulePackage.NOTIONAL_JOURNEY_DETAILS__HIRE_RATE, oldHireRate, hireRate));
	}
	...
	public void setHireCost(int newHireCost) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SchedulePackage.NOTIONAL_JOURNEY_DETAILS__HIRE_COST, oldHireCost, hireCost));
	}
	...
	public void setRouteTaken(String newRouteTaken) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SchedulePackage.NOTIONAL_JOURNEY_DETAILS__ROUTE_TAKEN, oldRouteTaken, routeTaken));
	}
	...
	public void setCanalCost(int newCanalCost) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SchedulePackage.NOTIONAL_JOURNEY_DETAILS__CANAL_COST, oldCanalCost, canalCost));
	}
	...
	public void setLumpSum(int newLumpSum) {
		...
		lumpSum = newLumpSum;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SchedulePackage.NOTIONAL_JOURNEY_DETAILS__LUMP_SUM, oldLumpSum, lumpSum));
	}
