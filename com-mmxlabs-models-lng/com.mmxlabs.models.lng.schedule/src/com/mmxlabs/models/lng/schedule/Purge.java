 ...
 * </p>
 * <ul>
 *   <li>{@link com.mmxlabs.models.lng.schedule.Purge#getVolume <em>Volume</em>}</li>
...
public interface Purge extends Event, FuelUsage {
	 ...
	 * @see #setVolume(int)
	 * @see com.mmxlabs.models.lng.schedule.SchedulePackage#getPurge_Volume()
	 * @model required="true"
	 * @generated
	 */
	int getVolume();
	...
	/**
	 * Sets the value of the '{@link com.mmxlabs.models.lng.schedule.Purge#getVolume <em>Volume</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
