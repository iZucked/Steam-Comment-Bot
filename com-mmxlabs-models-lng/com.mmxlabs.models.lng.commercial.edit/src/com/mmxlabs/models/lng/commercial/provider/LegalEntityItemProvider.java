...
import com.mmxlabs.models.lng.types.provider.ALegalEntityItemProvider;
...
public class LegalEntityItemProvider
	extends ALegalEntityItemProvider
	implements
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LegalEntity_transferPrice_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LegalEntity_transferPrice_feature", "_UI_LegalEntity_type"),
				 CommercialPackage.Literals.LEGAL_ENTITY__TRANSFER_PRICE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CommercialPackage.Literals.LEGAL_ENTITY__TAX_RATES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CommercialPackage.Literals.LEGAL_ENTITY__TAX_RATES,
