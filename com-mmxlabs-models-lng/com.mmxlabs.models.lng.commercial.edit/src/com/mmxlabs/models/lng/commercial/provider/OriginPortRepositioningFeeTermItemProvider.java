	...
	protected void addOriginPortPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OriginPortRepositioningFeeTerm_originPort_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OriginPortRepositioningFeeTerm_originPort_feature", "_UI_OriginPortRepositioningFeeTerm_type"),
				 CommercialPackage.Literals.ORIGIN_PORT_REPOSITIONING_FEE_TERM__ORIGIN_PORT,
				 true,
				 false,
				 true,
				 null,
