...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Monthly Ballast Bonus Term</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.mmxlabs.models.lng.commercial.impl.MonthlyBallastBonusTermImpl#getMonth <em>Month</em>}</li>
 *   <li>{@link com.mmxlabs.models.lng.commercial.impl.MonthlyBallastBonusTermImpl#getBallastBonusTo <em>Ballast Bonus To</em>}</li>
 *   <li>{@link com.mmxlabs.models.lng.commercial.impl.MonthlyBallastBonusTermImpl#getBallastBonusPctFuel <em>Ballast Bonus Pct Fuel</em>}</li>
 *   <li>{@link com.mmxlabs.models.lng.commercial.impl.MonthlyBallastBonusTermImpl#getBallastBonusPctCharter <em>Ballast Bonus Pct Charter</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MonthlyBallastBonusTermImpl extends NotionalJourneyBallastBonusTermImpl implements MonthlyBallastBonusTerm {
	/**
	 ...
	 * @generated
	 */
	protected MonthlyBallastBonusTermImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return CommercialPackage.Literals.MONTHLY_BALLAST_BONUS_TERM;
	}
	...
	public void setMonth(YearMonth newMonth) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommercialPackage.MONTHLY_BALLAST_BONUS_TERM__MONTH, oldMonth, month));
	}
	...
	public void setBallastBonusTo(NextPortType newBallastBonusTo) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommercialPackage.MONTHLY_BALLAST_BONUS_TERM__BALLAST_BONUS_TO, oldBallastBonusTo, ballastBonusTo));
	}
	...
	public void setBallastBonusPctFuel(String newBallastBonusPctFuel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommercialPackage.MONTHLY_BALLAST_BONUS_TERM__BALLAST_BONUS_PCT_FUEL, oldBallastBonusPctFuel, ballastBonusPctFuel));
	}
	...
	public void setBallastBonusPctCharter(String newBallastBonusPctCharter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommercialPackage.MONTHLY_BALLAST_BONUS_TERM__BALLAST_BONUS_PCT_CHARTER, oldBallastBonusPctCharter, ballastBonusPctCharter));
	}
