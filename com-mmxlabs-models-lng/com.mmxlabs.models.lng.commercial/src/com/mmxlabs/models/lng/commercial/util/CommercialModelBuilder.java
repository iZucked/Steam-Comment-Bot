...
public class CommercialModelBuilder {
	...
	public @NonNull BallastBonusCharterContract createLumpSumBallastBonusCharterContract(@NonNull final Port redeliveryPort, @NonNull final String priceExpression, @NonNull final String repositioningFee) {
