...
public class CommercialSwitch<@Nullable T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case CommercialPackage.MONTLY_BALLAST_BONUS_CONTRACT_LINE: {
				MontlyBallastBonusContractLine montlyBallastBonusContractLine = (MontlyBallastBonusContractLine)theEObject;
				T result = caseMontlyBallastBonusContractLine(montlyBallastBonusContractLine);
				if (result == null) result = caseBallastBonusContractLine(montlyBallastBonusContractLine);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Montly Ballast Bonus Contract Line</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Montly Ballast Bonus Contract Line</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseMontlyBallastBonusContractLine(MontlyBallastBonusContractLine object) {
		return null;
	}
