...
public class CommercialPackageImpl extends EPackageImpl implements CommercialPackage {
	 ...
	 * @generated
	 */
	public EReference getBaseLegalEntity_TaxRates() {
	 ...
	 * @generated
	 */
	public EReference getContract_VolumeParams() {
	...
	public void createPackageContents() {
		...
		createEReference(baseLegalEntityEClass, BASE_LEGAL_ENTITY__TAX_RATES);
		...
		createEReference(contractEClass, CONTRACT__VOLUME_PARAMS);
	...
	public void initializePackageContents() {
		...
		initEReference(getBaseLegalEntity_TaxRates(), this.getTaxRate(), null, "taxRates", null, 0, -1, BaseLegalEntity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getContract_VolumeParams(), this.getVolumeParams(), null, "volumeParams", null, 0, 1, Contract.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getSalesContract_PurchaseDeliveryType(), theTypesPackage.getCargoDeliveryType(), "PurchaseDeliveryType", "Any", 0, 1, SalesContract.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
