...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Profit Share Price Parameters</b></em>'.
 * @since 3.0
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.mmxlabs.models.lng.commercial.impl.ProfitSharePriceParametersImpl#getBaseMarketPorts <em>Base Market Ports</em>}</li>
 *   <li>{@link com.mmxlabs.models.lng.commercial.impl.ProfitSharePriceParametersImpl#getBaseMarketIndex <em>Base Market AIndex</em>}</li>
 *   <li>{@link com.mmxlabs.models.lng.commercial.impl.ProfitSharePriceParametersImpl#getBaseMarketMultiplier <em>Base Market Multiplier</em>}</li>
 *   <li>{@link com.mmxlabs.models.lng.commercial.impl.ProfitSharePriceParametersImpl#getBaseMarketConstant <em>Base Market Constant</em>}</li>
 *   <li>{@link com.mmxlabs.models.lng.commercial.impl.ProfitSharePriceParametersImpl#getRefMarketIndex <em>Ref Market AIndex</em>}</li>
 *   <li>{@link com.mmxlabs.models.lng.commercial.impl.ProfitSharePriceParametersImpl#getRefMarketMultiplier <em>Ref Market Multiplier</em>}</li>
 *   <li>{@link com.mmxlabs.models.lng.commercial.impl.ProfitSharePriceParametersImpl#getRefMarketConstant <em>Ref Market Constant</em>}</li>
 *   <li>{@link com.mmxlabs.models.lng.commercial.impl.ProfitSharePriceParametersImpl#getShare <em>Share</em>}</li>
 *   <li>{@link com.mmxlabs.models.lng.commercial.impl.ProfitSharePriceParametersImpl#getMargin <em>Margin</em>}</li>
 *   <li>{@link com.mmxlabs.models.lng.commercial.impl.ProfitSharePriceParametersImpl#getSalesMultiplier <em>Sales Multiplier</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ProfitSharePriceParametersImpl extends LNGPriceCalculatorParametersImpl implements ProfitSharePriceParameters {
	/**
	...
	/**
	 * The cached value of the '{@link #getBaseMarketIndex() <em>Base Market AIndex</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * The cached value of the '{@link #getRefMarketIndex() <em>Ref Market AIndex</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	protected ProfitSharePriceParametersImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return CommercialPackage.Literals.PROFIT_SHARE_PRICE_PARAMETERS;
	}
	...
	public EList<APortSet> getBaseMarketPorts() {
		if (baseMarketPorts == null) {
			baseMarketPorts = new EObjectResolvingEList<APortSet>(APortSet.class, this, CommercialPackage.PROFIT_SHARE_PRICE_PARAMETERS__BASE_MARKET_PORTS);
		}
		...
		if (baseMarketIndex != null && baseMarketIndex.eIsProxy()) {
			...
			if (baseMarketIndex != oldBaseMarketIndex) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CommercialPackage.PROFIT_SHARE_PRICE_PARAMETERS__BASE_MARKET_INDEX, oldBaseMarketIndex, baseMarketIndex));
			}
		}
	...
	public void setBaseMarketIndex(AIndex newBaseMarketIndex) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommercialPackage.PROFIT_SHARE_PRICE_PARAMETERS__BASE_MARKET_INDEX, oldBaseMarketIndex, baseMarketIndex));
	}
	...
	public void setBaseMarketMultiplier(double newBaseMarketMultiplier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommercialPackage.PROFIT_SHARE_PRICE_PARAMETERS__BASE_MARKET_MULTIPLIER, oldBaseMarketMultiplier, baseMarketMultiplier));
	}
	...
	public void setBaseMarketConstant(double newBaseMarketConstant) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommercialPackage.PROFIT_SHARE_PRICE_PARAMETERS__BASE_MARKET_CONSTANT, oldBaseMarketConstant, baseMarketConstant));
	}
	...
	public AIndex getRefMarketIndex() {
		if (refMarketIndex != null && refMarketIndex.eIsProxy()) {
			...
			if (refMarketIndex != oldRefMarketIndex) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CommercialPackage.PROFIT_SHARE_PRICE_PARAMETERS__REF_MARKET_INDEX, oldRefMarketIndex, refMarketIndex));
			}
		}
	...
	public void setRefMarketIndex(AIndex newRefMarketIndex) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommercialPackage.PROFIT_SHARE_PRICE_PARAMETERS__REF_MARKET_INDEX, oldRefMarketIndex, refMarketIndex));
	}
	...
	public void setRefMarketMultiplier(double newRefMarketMultiplier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommercialPackage.PROFIT_SHARE_PRICE_PARAMETERS__REF_MARKET_MULTIPLIER, oldRefMarketMultiplier, refMarketMultiplier));
	}
	...
	public void setRefMarketConstant(double newRefMarketConstant) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommercialPackage.PROFIT_SHARE_PRICE_PARAMETERS__REF_MARKET_CONSTANT, oldRefMarketConstant, refMarketConstant));
	}
	...
	public void setShare(double newShare) {
		...
		share = newShare;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommercialPackage.PROFIT_SHARE_PRICE_PARAMETERS__SHARE, oldShare, share));
	}
	...
	public void setMargin(double newMargin) {
		...
		margin = newMargin;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommercialPackage.PROFIT_SHARE_PRICE_PARAMETERS__MARGIN, oldMargin, margin));
	}
	...
	public void setSalesMultiplier(double newSalesMultiplier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommercialPackage.PROFIT_SHARE_PRICE_PARAMETERS__SALES_MULTIPLIER, oldSalesMultiplier, salesMultiplier));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CommercialPackage.PROFIT_SHARE_PRICE_PARAMETERS__BASE_MARKET_PORTS:
				return getBaseMarketPorts();
			case CommercialPackage.PROFIT_SHARE_PRICE_PARAMETERS__BASE_MARKET_INDEX:
			...
			case CommercialPackage.PROFIT_SHARE_PRICE_PARAMETERS__REF_MARKET_INDEX:
...
} // end of ProfitSharePriceParametersImpl
