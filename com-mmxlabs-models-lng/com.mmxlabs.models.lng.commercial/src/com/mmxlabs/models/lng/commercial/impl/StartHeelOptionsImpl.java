 ...
 * </p>
 * <ul>
 *   <li>{@link com.mmxlabs.models.lng.commercial.impl.StartHeelOptionsImpl#getCvValue <em>Cv Value</em>}</li>
 *   <li>{@link com.mmxlabs.models.lng.commercial.impl.StartHeelOptionsImpl#getMinVolumeAvailable <em>Min Volume Available</em>}</li>
 *   <li>{@link com.mmxlabs.models.lng.commercial.impl.StartHeelOptionsImpl#getMaxVolumeAvailable <em>Max Volume Available</em>}</li>
 *   <li>{@link com.mmxlabs.models.lng.commercial.impl.StartHeelOptionsImpl#getPriceExpression <em>Price Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StartHeelOptionsImpl extends EObjectImpl implements StartHeelOptions {
	...
	protected EClass eStaticClass() {
		return CommercialPackage.Literals.START_HEEL_OPTIONS;
	}
	...
	public void setCvValue(double newCvValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommercialPackage.START_HEEL_OPTIONS__CV_VALUE, oldCvValue, cvValue));
	}
	...
	public void setMinVolumeAvailable(double newMinVolumeAvailable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommercialPackage.START_HEEL_OPTIONS__MIN_VOLUME_AVAILABLE, oldMinVolumeAvailable, minVolumeAvailable));
	}
	...
	public void setMaxVolumeAvailable(double newMaxVolumeAvailable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommercialPackage.START_HEEL_OPTIONS__MAX_VOLUME_AVAILABLE, oldMaxVolumeAvailable, maxVolumeAvailable));
	}
	...
	public void setPriceExpression(String newPriceExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommercialPackage.START_HEEL_OPTIONS__PRICE_EXPRESSION, oldPriceExpression, priceExpression));
	}
