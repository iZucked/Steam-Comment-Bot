...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Ballast Bonus Term</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.mmxlabs.models.lng.commercial.impl.BallastBonusTermImpl#getRedeliveryPorts <em>Redelivery Ports</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BallastBonusTermImpl extends EObjectImpl implements BallastBonusTerm {
	 ...
	 * @generated
	 */
	protected BallastBonusTermImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return CommercialPackage.Literals.BALLAST_BONUS_TERM;
	}
	...
	public EList<APortSet<Port>> getRedeliveryPorts() {
		if (redeliveryPorts == null) {
			redeliveryPorts = new EObjectResolvingEList<APortSet<Port>>(APortSet.class, this, CommercialPackage.BALLAST_BONUS_TERM__REDELIVERY_PORTS);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CommercialPackage.BALLAST_BONUS_TERM__REDELIVERY_PORTS:
