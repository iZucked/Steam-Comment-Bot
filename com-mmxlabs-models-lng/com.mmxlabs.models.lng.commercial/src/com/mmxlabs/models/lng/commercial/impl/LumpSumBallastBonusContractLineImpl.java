...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Lump Sum Ballast Bonus Contract Line</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.mmxlabs.models.lng.commercial.impl.LumpSumBallastBonusContractLineImpl#getPriceExpression <em>Price Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LumpSumBallastBonusContractLineImpl extends BallastBonusContractLineImpl implements LumpSumBallastBonusContractLine {
	/**
	 ...
	 * @generated
	 */
	protected LumpSumBallastBonusContractLineImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return CommercialPackage.Literals.LUMP_SUM_BALLAST_BONUS_CONTRACT_LINE;
	}
	...
	public void setPriceExpression(String newPriceExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommercialPackage.LUMP_SUM_BALLAST_BONUS_CONTRACT_LINE__PRICE_EXPRESSION, oldPriceExpression, priceExpression));
	}
...
} //LumpSumBallastBonusContractLineImpl
