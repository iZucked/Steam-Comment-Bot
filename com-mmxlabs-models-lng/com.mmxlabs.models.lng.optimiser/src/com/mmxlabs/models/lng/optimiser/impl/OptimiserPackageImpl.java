...
public class OptimiserPackageImpl extends EPackageImpl implements OptimiserPackage {
	 ...
	 * @generated
	 */
	private EClass optimiserModelEClass = null;
	 ...
	 * @see com.mmxlabs.models.lng.optimiser.OptimiserPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EClass getOptimiserModel() {
		return optimiserModelEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getOptimiserModel_Settings() {
		return (EReference)optimiserModelEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getOptimiserModel_ActiveSetting() {
		return (EReference)optimiserModelEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		optimiserModelEClass = createEClass(OPTIMISER_MODEL);
		createEReference(optimiserModelEClass, OPTIMISER_MODEL__SETTINGS);
		createEReference(optimiserModelEClass, OPTIMISER_MODEL__ACTIVE_SETTING);
	...
	public void initializePackageContents() {
		...
		initEClass(optimiserModelEClass, OptimiserModel.class, "OptimiserModel", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getOptimiserModel_Settings(), this.getOptimiserSettings(), null, "settings", null, 0, -1, OptimiserModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getOptimiserModel_ActiveSetting(), this.getOptimiserSettings(), null, "activeSetting", null, 1, 1, OptimiserModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
