 ...
 * <ul>
 *   <li>{@link com.mmxlabs.models.lng.optimiser.AnnealingSettings#getIterations <em>Iterations</em>}</li>
 *   <li>{@link com.mmxlabs.models.lng.optimiser.AnnealingSettings#getEpochLength <em>Epoch Length</em>}</li>
 *   <li>{@link com.mmxlabs.models.lng.optimiser.AnnealingSettings#getCooling <em>Cooling</em>}</li>
 *   <li>{@link com.mmxlabs.models.lng.optimiser.AnnealingSettings#getInitialTemperature <em>Initial Temperature</em>}</li>
 * </ul>
 * </p>
 *
 * @see com.mmxlabs.models.lng.optimiser.OptimiserPackage#getAnnealingSettings()
 * @model
 * @generated
 */
public interface AnnealingSettings extends EObject {
	 ...
	 * @see com.mmxlabs.models.lng.optimiser.OptimiserPackage#getAnnealingSettings_Iterations()
	 * @model required="true"
	 * @generated
	 */
	int getIterations();
	...
	/**
	 * Sets the value of the '{@link com.mmxlabs.models.lng.optimiser.AnnealingSettings#getIterations <em>Iterations</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see com.mmxlabs.models.lng.optimiser.OptimiserPackage#getAnnealingSettings_EpochLength()
	 * @model required="true"
	 * @generated
	 */
	int getEpochLength();
	...
	/**
	 * Sets the value of the '{@link com.mmxlabs.models.lng.optimiser.AnnealingSettings#getEpochLength <em>Epoch Length</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see com.mmxlabs.models.lng.optimiser.OptimiserPackage#getAnnealingSettings_Cooling()
	 * @model required="true"
	 * @generated
	 */
	double getCooling();
	...
	/**
	 * Sets the value of the '{@link com.mmxlabs.models.lng.optimiser.AnnealingSettings#getCooling <em>Cooling</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see com.mmxlabs.models.lng.optimiser.OptimiserPackage#getAnnealingSettings_InitialTemperature()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link com.mmxlabs.models.lng.optimiser.AnnealingSettings#getInitialTemperature <em>Initial Temperature</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
