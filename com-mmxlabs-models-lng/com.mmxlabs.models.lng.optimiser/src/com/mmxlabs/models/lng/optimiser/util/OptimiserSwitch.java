...
public class OptimiserSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case OptimiserPackage.OPTIMISER_MODEL: {
	 ...
	 * @generated
	 */
	public T caseOptimiserModel(OptimiserModel object) {
		return null;
	}
