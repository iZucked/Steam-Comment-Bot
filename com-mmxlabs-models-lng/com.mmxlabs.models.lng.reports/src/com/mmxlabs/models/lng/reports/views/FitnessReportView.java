...
public class FitnessReportView extends ViewPart implements ISelectionListener {
	 ...
	 */
	public static final String ID = "com.mmxlabs.models.lng.reports.views.FitnessReportView";
	...
	public void createPartControl(final Composite parent) {
		...
		PlatformUI.getWorkbench().getHelpSystem().setHelp(viewer.getControl(), "com.mmxlabs.models.lng.reports.FitnessReportView");
		makeActions();
		hookContextMenu();
