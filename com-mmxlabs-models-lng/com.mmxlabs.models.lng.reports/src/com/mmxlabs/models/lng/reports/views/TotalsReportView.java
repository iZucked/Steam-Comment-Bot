...
import com.mmxlabs.models.lng.reports.views.TotalsContentProvider.RowData;
...
public class TotalsReportView extends ViewPart implements ISelectionListener {
	 ...
	 */
	public static final String ID = "com.mmxlabs.models.lng.reports.views.TotalsReportView";
	...
	public void createPartControl(final Composite parent) {
		...
		PlatformUI.getWorkbench().getHelpSystem().setHelp(viewer.getControl(), "com.mmxlabs.models.lng.reports.TotalsReportView");
		makeActions();
		hookContextMenu();
