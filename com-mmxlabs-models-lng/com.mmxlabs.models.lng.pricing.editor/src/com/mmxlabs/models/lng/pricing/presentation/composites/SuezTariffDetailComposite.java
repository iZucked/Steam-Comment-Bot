 ...
 * 
 */
public class SuezTariffDetailComposite extends Composite implements IDisplayComposite {
	...
	public SuezTariffDetailComposite(final Composite parent, final int style, final FormToolkit toolkit) {
		super(parent, style);
		toolkit.adapt(this);
		...
		SuezTariffDetailComposite.this.tableViewer = tableViewer;
	...
	private final @NonNull Adapter adapter = new SafeMMXContentAdapter() {
		...
		public void reallyNotifyChanged(Notification notification) {
			if (!isDisposed() && isVisible()) {
				...
				SuezTariffDetailComposite.this.removeAdapter();
			}
		}
