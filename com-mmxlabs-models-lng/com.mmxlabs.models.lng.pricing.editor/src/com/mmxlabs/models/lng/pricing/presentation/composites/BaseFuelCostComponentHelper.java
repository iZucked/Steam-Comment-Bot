 ...
 * @generated
 */
public class BaseFuelCostComponentHelper extends BaseComponentHelper {
	 ...
	 * @generated
	 */
	public BaseFuelCostComponentHelper() {
	 ...
	 * @generated
	 */
	public BaseFuelCostComponentHelper(IAdapterManager adapterManager) {
		final IComponentHelperRegistry registry = com.mmxlabs.models.ui.Activator.getDefault().getComponentHelperRegistry();
		superClassesHelpers.addAll(registry.getComponentHelpers(MMXCorePackage.Literals.MMX_OBJECT));
	}
	
	/**
	 * add editors to a composite, using BaseFuelCost as the supertype
	 *
	 * @generated
	 */
	 @Override
	public void addEditorsToComposite(final IInlineEditorContainer detailComposite) {
		addEditorsToComposite(detailComposite, PricingPackage.Literals.BASE_FUEL_COST);	
	}
	...
	/**
	 * Create the editor for the expression feature on BaseFuelCost
	 *
	 * @generated
	 */
	protected void add_expressionEditor(final IInlineEditorContainer detailComposite, final EClass topClass) {
		detailComposite.addInlineEditor(ComponentHelperUtils.createDefaultEditor(topClass, PricingPackage.Literals.BASE_FUEL_COST__EXPRESSION));
	}
