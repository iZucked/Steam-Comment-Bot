...
public class DESPurchaseSpotMarketView extends ScenarioTableViewerView<SpotMarketGroupPane> {
	...
	protected void initViewerPane(final SpotMarketGroupPane pane) {
		pane.init(Arrays.asList(new EReference[] { PricingPackage.eINSTANCE.getPricingModel_DesPurchaseSpotMarket(), PricingPackage.eINSTANCE.getSpotMarketGroup_Markets() }), null);
