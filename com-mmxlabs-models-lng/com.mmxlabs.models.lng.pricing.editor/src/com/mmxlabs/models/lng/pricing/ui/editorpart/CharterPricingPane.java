...
public class CharterPricingPane extends ScenarioTableViewerPane {
	...
	public void init(List<EReference> path, AdapterFactory adapterFactory) {
		...
		addTypicalColumn("Availability Index", 
				new SingleReferenceManipulator(PricingPackage.eINSTANCE.getCharterCostModel_SpotCharterCount(), getReferenceValueProviderCache(), getEditingDomain()));
