...
public class PricingBasisReferenceValueProviderFactory implements IReferenceValueProviderFactory {
	@Override
	public IReferenceValueProvider createReferenceValueProvider(final EClass owner, final EReference reference, final MMXRootObject rootObject) {
		...
		if (rootObject instanceof final LNGScenarioModel lngScenarioModel) {
			...
			if (referenceClass == PricingPackage.eINSTANCE.getPricingBasis()) {
				return new SimpleReferenceValueProvider(model, PricingPackage.eINSTANCE.getPricingModel_PricingBases());
			}
		}
