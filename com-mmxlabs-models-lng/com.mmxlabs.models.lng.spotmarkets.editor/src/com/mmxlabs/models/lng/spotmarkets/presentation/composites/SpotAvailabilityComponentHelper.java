 ...
 * @generated
 */
public class SpotAvailabilityComponentHelper extends BaseComponentHelper {
	 ...
	 * @generated
	 */
	public SpotAvailabilityComponentHelper(IAdapterManager adapterManager) {
		final IComponentHelperRegistry registry = com.mmxlabs.models.ui.Activator.getDefault().getComponentHelperRegistry();
	}
	
	/**
	 * add editors to a composite, using SpotAvailability as the supertype
	 *
	 * @generated
	 */
	 @Override
	public void addEditorsToComposite(final IInlineEditorContainer detailComposite) {
		addEditorsToComposite(detailComposite, SpotMarketsPackage.Literals.SPOT_AVAILABILITY);	
	}
	...
	public void addEditorsToComposite(final IInlineEditorContainer detailComposite, final EClass topClass) {
		...
		add_curveEditor(detailComposite, topClass);
	}
	/**
	 * Create the editor for the constant feature on SpotAvailability
	 *
	 * @generated
	 */
	protected void add_constantEditor(final IInlineEditorContainer detailComposite, final EClass topClass) {
		detailComposite.addInlineEditor(ComponentHelperUtils.createDefaultEditor(topClass, SpotMarketsPackage.Literals.SPOT_AVAILABILITY__CONSTANT));
	}
	/**
