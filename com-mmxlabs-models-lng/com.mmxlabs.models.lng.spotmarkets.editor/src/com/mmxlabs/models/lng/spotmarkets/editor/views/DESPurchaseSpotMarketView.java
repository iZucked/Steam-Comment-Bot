...
public class DESPurchaseSpotMarketView extends ScenarioTableViewerView<SpotMarketGroupPane> {
	...
	protected void initViewerPane(final SpotMarketGroupPane pane) {
		pane.init(
				Arrays.asList(new EReference[] { LNGScenarioPackage.eINSTANCE.getLNGScenarioModel_SpotMarketsModel(), SpotMarketsPackage.eINSTANCE.getSpotMarketsModel_DesPurchaseSpotMarket(),
