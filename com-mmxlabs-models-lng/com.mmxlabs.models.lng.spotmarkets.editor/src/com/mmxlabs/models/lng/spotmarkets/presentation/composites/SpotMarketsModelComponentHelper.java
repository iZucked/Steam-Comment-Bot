...
public class SpotMarketsModelComponentHelper extends BaseComponentHelper {
	...
	public void addEditorsToComposite(final IInlineEditorContainer detailComposite, final EClass topClass) {
		...
		add_charterOutMarketParametersEditor(detailComposite, topClass);
	}
	/**
	...
	/**
	 * Create the editor for the charterOutMarketParameters feature on SpotMarketsModel
	 *
	 * @generated
	 */
	protected void add_charterOutMarketParametersEditor(final IInlineEditorContainer detailComposite, final EClass topClass) {
		detailComposite.addInlineEditor(ComponentHelperUtils.createDefaultEditor(topClass, SpotMarketsPackage.Literals.SPOT_MARKETS_MODEL__CHARTER_OUT_MARKET_PARAMETERS));
	}
}