...
/**
 * This is the item provider adapter for a {@link com.mmxlabs.models.lng.port.EntryPoint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EntryPointItemProvider extends NamedObjectItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EntryPoint_port_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EntryPoint_port_feature", "_UI_EntryPoint_type"),
				 PortPackage.Literals.ENTRY_POINT__PORT,
				 true,
				 false,
				 true,
				 null,
