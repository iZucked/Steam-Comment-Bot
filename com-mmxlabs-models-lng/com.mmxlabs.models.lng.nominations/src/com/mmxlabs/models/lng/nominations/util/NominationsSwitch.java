...
public class NominationsSwitch<@Nullable T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case NominationsPackage.NOMINATIONS_PARAMETERS: {
				NominationsParameters nominationsParameters = (NominationsParameters)theEObject;
				T result = caseNominationsParameters(nominationsParameters);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case NominationsPackage.ABSTRACT_NOMINATED_VALUE: {
				AbstractNominatedValue abstractNominatedValue = (AbstractNominatedValue)theEObject;
				T result = caseAbstractNominatedValue(abstractNominatedValue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Abstract Nominated Value</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Abstract Nominated Value</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAbstractNominatedValue(AbstractNominatedValue object) {
		return null;
	}
