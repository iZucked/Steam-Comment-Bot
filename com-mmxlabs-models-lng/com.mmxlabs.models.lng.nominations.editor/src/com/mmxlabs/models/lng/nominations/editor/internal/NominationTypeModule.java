...
public class NominationTypeModule extends AbstractModule {

	@Override
	protected void configure() {

		final Bundle bundle = FrameworkUtil.getBundle(NominationTypeModule.class);
		if (bundle != null) {
			...
			if (bundleContext != null) {
				...
				// Extension points
				bind(iterable(NominationTypeExtension.class)).toProvider(service(NominationTypeExtension.class).multiple());
			}
		}
	}
}
