...
public class SpotMarketsAdapterFactory extends AdapterFactoryImpl {
	...
	protected SpotMarketsSwitch<@Nullable Adapter> modelSwitch =
		new SpotMarketsSwitch<@Nullable Adapter>() {
			...
			@Override
			public Adapter caseCharterOutMarketParameters(CharterOutMarketParameters object) {
				return createCharterOutMarketParametersAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.mmxlabs.models.lng.spotmarkets.CharterOutMarketParameters <em>Charter Out Market Parameters</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
