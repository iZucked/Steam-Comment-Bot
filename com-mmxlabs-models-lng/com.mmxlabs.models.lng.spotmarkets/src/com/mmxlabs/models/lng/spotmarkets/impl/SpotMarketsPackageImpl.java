...
public class SpotMarketsPackageImpl extends EPackageImpl implements SpotMarketsPackage {
	 ...
	 */
	@Override
	public EAttribute getDESSalesMarket_DaysPadding() {
	...
	public void createPackageContents() {
		...
		createEAttribute(desSalesMarketEClass, DES_SALES_MARKET__DAYS_PADDING);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getDESSalesMarket_DaysPadding(), ecorePackage.getEInt(), "daysPadding", null, 0, 1, DESSalesMarket.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
