...
public class NullReferenceConstraint extends AbstractModelConstraint {
	...
	// TODO add any more refs to check here
			AnalyticsPackage.eINSTANCE.getUnitCostMatrix_Vessel(), AnalyticsPackage.eINSTANCE.getShippingCostPlan_Vessel(), AnalyticsPackage.eINSTANCE.getShippingCostRow_Port());
