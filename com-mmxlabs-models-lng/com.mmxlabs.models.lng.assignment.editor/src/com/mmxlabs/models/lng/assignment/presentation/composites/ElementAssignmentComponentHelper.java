 ...
 * All rights reserved.
 */
package com.mmxlabs.models.lng.assignment.presentation.composites;
...
public class ElementAssignmentComponentHelper extends BaseComponentHelper {
	...
	public void addEditorsToComposite(final IInlineEditorContainer detailComposite) {
		addEditorsToComposite(detailComposite, AssignmentPackage.Literals.ELEMENT_ASSIGNMENT);	
	}
	...
	protected void add_assignedObjectEditor(final IInlineEditorContainer detailComposite, final EClass topClass) {
		detailComposite.addInlineEditor(ComponentHelperUtils.createDefaultEditor(topClass, AssignmentPackage.Literals.ELEMENT_ASSIGNMENT__ASSIGNED_OBJECT));
	}
	/**
	...
	protected void add_assignmentEditor(final IInlineEditorContainer detailComposite, final EClass topClass) {
		detailComposite.addInlineEditor(ComponentHelperUtils.createDefaultEditor(topClass, AssignmentPackage.Literals.ELEMENT_ASSIGNMENT__ASSIGNMENT));
	}
	/**
	...
	protected void add_lockedEditor(final IInlineEditorContainer detailComposite, final EClass topClass) {
		detailComposite.addInlineEditor(ComponentHelperUtils.createDefaultEditor(topClass, AssignmentPackage.Literals.ELEMENT_ASSIGNMENT__LOCKED));
	}
	/**
	...
	protected void add_sequenceEditor(final IInlineEditorContainer detailComposite, final EClass topClass) {
		detailComposite.addInlineEditor(ComponentHelperUtils.createDefaultEditor(topClass, AssignmentPackage.Literals.ELEMENT_ASSIGNMENT__SEQUENCE));
	}
	...
	protected void add_spotIndexEditor(final IInlineEditorContainer detailComposite, final EClass topClass) {
		detailComposite.addInlineEditor(ComponentHelperUtils.createDefaultEditor(topClass, AssignmentPackage.Literals.ELEMENT_ASSIGNMENT__SPOT_INDEX));
	}
}