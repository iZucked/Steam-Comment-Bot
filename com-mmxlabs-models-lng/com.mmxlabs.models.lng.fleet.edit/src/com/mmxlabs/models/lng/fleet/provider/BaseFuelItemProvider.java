...
import com.mmxlabs.models.lng.types.provider.ABaseFuelItemProvider;
...
/**
 * This is the item provider adapter for a {@link com.mmxlabs.models.lng.fleet.BaseFuel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BaseFuelItemProvider
	extends ABaseFuelItemProvider
	implements
	 ...
	 * @generated
	 */
	public BaseFuelItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/BaseFuel"));
	}
	...
	public String getText(Object object) {
		String label = ((BaseFuel)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_BaseFuel_type") :
			getString("_UI_BaseFuel_type") + " " + label;
	}
