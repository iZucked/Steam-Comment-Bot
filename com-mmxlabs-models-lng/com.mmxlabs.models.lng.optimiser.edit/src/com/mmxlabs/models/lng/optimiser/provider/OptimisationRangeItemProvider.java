		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_OptimisationRange_optimiseAfter_feature", "_UI_OptimisationRange_type"),
				 OptimiserPackage.Literals.OPTIMISATION_RANGE__OPTIMISE_AFTER,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_OptimisationRange_optimiseBefore_feature", "_UI_OptimisationRange_type"),
				 OptimiserPackage.Literals.OPTIMISATION_RANGE__OPTIMISE_BEFORE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
