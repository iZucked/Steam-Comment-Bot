...
/**
 * This is the item provider adapter for a {@link com.mmxlabs.models.lng.optimiser.Objective} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ObjectiveItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OptimiserPackage.Literals.OBJECTIVE__WEIGHT,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OptimiserPackage.Literals.OBJECTIVE__ENABLED,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Objective.class)) {
			...
			case OptimiserPackage.OBJECTIVE__ENABLED:
