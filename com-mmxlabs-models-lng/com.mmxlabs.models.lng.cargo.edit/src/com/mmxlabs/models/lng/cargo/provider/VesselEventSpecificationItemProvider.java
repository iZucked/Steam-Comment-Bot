 ...
 * @generated
 */
public class VesselEventSpecificationItemProvider extends ScheduleSpecificationEventItemProvider {
	/**
	 ...
	 * @generated
	 */
	public VesselEventSpecificationItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_VesselEventSpecification_vesselEvent_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_VesselEventSpecification_vesselEvent_feature", "_UI_VesselEventSpecification_type"),
				 CargoPackage.Literals.VESSEL_EVENT_SPECIFICATION__VESSEL_EVENT,
				 true,
				 false,
				 true,
				 null,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/VesselEventSpecification"));
	}
