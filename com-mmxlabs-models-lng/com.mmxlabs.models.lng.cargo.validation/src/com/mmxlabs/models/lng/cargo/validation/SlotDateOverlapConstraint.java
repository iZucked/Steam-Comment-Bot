		...
		public Collection<Slot> slotOverlaps(final Slot slot) {
			...
			do {
				...
				while (ii.hasNext()) {
					...
					final ZonedDateTime slotStart = slot.getSchedulingTimeWindow().getStartWithFlex();
					final ZonedDateTime overlapSlotStart = overlapSlot.getSchedulingTimeWindow().getStartWithFlex();
