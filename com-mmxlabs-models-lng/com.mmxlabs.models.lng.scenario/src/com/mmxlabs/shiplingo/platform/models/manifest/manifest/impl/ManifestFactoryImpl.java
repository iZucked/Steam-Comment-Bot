...
public class ManifestFactoryImpl extends EFactoryImpl implements ManifestFactory {
	...
	public static ManifestFactory init() {
		try {
			ManifestFactory theManifestFactory = (ManifestFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.mmxlabs.com/models/lng/demo-manifest/1/"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case ManifestPackage.ENTRY: return createEntry();
