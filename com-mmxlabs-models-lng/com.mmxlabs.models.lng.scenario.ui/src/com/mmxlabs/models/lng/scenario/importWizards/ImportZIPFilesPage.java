...
public class ImportZIPFilesPage extends WizardPage {

	private static final String FILTER_KEY = "lastSelection";
	private static final String SECTION_NAME = "ImportZIPFilesPage.section";
	...
	private static final Logger LOG = LoggerFactory.getLogger(ImportZIPFilesPage.class);
	...
	private abstract class Chunk {
		...
		public void setFromDirectory(final File directory) {
			for (final Map.Entry<String, String> entry : friendlyNames.entrySet()) {
				...
				final File sub = new File(directory, v + ".zip");
				if (sub.exists()) {
					try {
				...
				public void run(final IProgressMonitor monitor) throws InvocationTargetException, InterruptedException {
					...
					try {
						...
						if (scenarioDataProvider != null) {
							...
							ImportZIPFilesPage.this.importContext = context;
							...
							try {
								...
								ImportZIPFilesPage.this.setScenarioInstance(newInstance);
