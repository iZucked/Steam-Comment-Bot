...
public class LNGModelCorrector {
	...
	public void correctModel(final LNGScenarioModel rootObject, final EditingDomain ed) {
	...
	private void addMissingTaxCurves(final CompoundCommand parent, final LNGScenarioModel rootObject, final EditingDomain ed) {
	...
	private void fixCanalCostVesselTypes(final CompoundCommand parent, final LNGScenarioModel rootObject, final EditingDomain ed) {
	...
	private void fixPortCapabilityGroups(final CompoundCommand parent, final LNGScenarioModel rootObject, final EditingDomain ed) {
	...
	private void fixVesselTypeGroups(final CompoundCommand parent, final LNGScenarioModel rootObject, final EditingDomain ed) {
	...
	// private void fixRedirectionContracts(final CompoundCommand parent, final LNGScenarioModel rootObject, final EditingDomain ed) {
	...
	private void fixSequenceTypes(final CompoundCommand parent, final LNGScenarioModel rootObject, final EditingDomain ed) {
	...
	private void fixDuplicateUUIDs(final CompoundCommand cmd, final LNGScenarioModel rootObject, final EditingDomain ed) {
		final Set<String> seenUUIDs = new HashSet<String>();

		final TreeIterator<EObject> itr = rootObject.eAllContents();
		while (itr.hasNext()) {
	...
	private void fixMissingPortLocations(final CompoundCommand parent, final LNGScenarioModel rootObject, final EditingDomain ed) {
	...
	private void fixMissingCargoElementAssignments(final CompoundCommand parent, final LNGScenarioModel rootObject, final EditingDomain ed) {
	...
	private void fixMissingVesselEventElementAssignments(final CompoundCommand parent, final LNGScenarioModel rootObject, final EditingDomain ed) {
		...
		final AssignmentModel assignmentModel = rootObject.getPortfolioModel().getAssignmentModel();
		if (assignmentModel != null && scenarioFleetModel != null) {

			final Set<VesselEvent> events = new HashSet<VesselEvent>();
			for (final VesselEvent e : scenarioFleetModel.getVesselEvents()) {
				events.add(e);
			}
	...
	private void removeBadElementAssignments(final CompoundCommand parent, final LNGScenarioModel rootObject, final EditingDomain ed) {
	...
	private void fixMissingSpotCargoMarkets(final CompoundCommand parent, final LNGScenarioModel rootObject, final EditingDomain ed) {
	...
	private void correctDateObjects(final CompoundCommand parent, final LNGScenarioModel rootObject, final EditingDomain ed) {

		final CompoundCommand cmd = new CompoundCommand("Fix date objects");

		// Loop over all contents
		final Iterator<EObject> itr = rootObject.eAllContents();
		while (itr.hasNext()) {
			final EObject eObj = itr.next();
