...
/**
 */
public class ImportSettledPricesPage extends WizardPage {
	...
	public ImportSettledPricesPage(final String pageName, final ScenarioInstance currentScenario) {
		super(pageName);
		this.currentScenario = currentScenario;
		setTitle("Select data and scenarios");
		setDescription("Choose scenario(s) and a file for settled prices import.");
	}
	...
	public void createControl(final Composite parent) {
		...
		importFileEditor.getTextControl(datafileC).addModifyListener(new ModifyListener() {
			...
			public void modifyText(final ModifyEvent e) {
				ImportSettledPricesPage.this.getContainer().updateButtons();
			}
		});
