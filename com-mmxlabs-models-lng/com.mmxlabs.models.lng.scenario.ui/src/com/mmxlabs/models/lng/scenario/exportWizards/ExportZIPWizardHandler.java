...
public class ExportZIPWizardHandler extends AbstractHandler {
	
	private final static String EXPORT_SCENARIO_COMMAND_ID = "com.mmxlabs.shiplingo.platform.models.optimisation.ExportZIPScenario";
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		ExportZIPWizard wizard = new ExportZIPWizard(id.equalsIgnoreCase(EXPORT_SCENARIO_COMMAND_ID));
