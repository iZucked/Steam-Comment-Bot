...
/**
 */
public class ImportPricingCalendarsPage extends WizardPage {
	...
	public ImportPricingCalendarsPage(final String pageName, final ScenarioInstance currentScenario) {
		...
		setDescription("Choose scenario(s) and a file for pricing calendars import.");
	}
	...
	public void createControl(final Composite parent) {
		...
		importFileEditor.getTextControl(datafileC).addModifyListener(new ModifyListener() {
			...
			public void modifyText(final ModifyEvent e) {
				ImportPricingCalendarsPage.this.getContainer().updateButtons();
			}
		});
