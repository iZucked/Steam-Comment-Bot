...
/**
 */
public class ImportPricingCalendarsWizard extends Wizard implements IImportWizard {

	private static final Logger log = LoggerFactory.getLogger(ImportPricingCalendarsWizard.class);

	private ImportPricingCalendarsPage bip;
	...
	public void init(final IWorkbench workbench, final IStructuredSelection selection) {
		bip = new ImportPricingCalendarsPage("selectScenarios", currentScenario);
	...
	private void doImportAction(final String filename, final char listSeparator, final char decimalSeparator, final ScenarioModelRecord modelRecord, final Set<String> uniqueProblems,
		...
		try (final IScenarioDataProvider scenarioDataProvider = modelRecord.aquireScenarioDataProvider("ImportPricingCalendarsWizard")) {
			...
			final PricingCalendarsImportAction action = new PricingCalendarsImportAction(ihp, ScenarioModelUtil.getPricingModel(scenarioDataProvider));
