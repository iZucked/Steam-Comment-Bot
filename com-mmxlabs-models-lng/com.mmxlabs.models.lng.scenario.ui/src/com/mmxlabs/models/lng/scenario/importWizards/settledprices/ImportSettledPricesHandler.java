...
public class ImportSettledPricesHandler extends AbstractHandler {
	...
	public Object execute(final ExecutionEvent event) throws ExecutionException {
		...
		final ImportSettledPricesWizard wizard = new ImportSettledPricesWizard(editor != null ? editor.getScenarioInstance() : null, "Import settled prices");
