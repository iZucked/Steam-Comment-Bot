...
public class ImportSettledPricesWizard extends Wizard implements IImportWizard {
	...
	public ImportSettledPricesWizard(final ScenarioInstance scenarioInstance, final String windowTitle) {
	...
	public void init(final IWorkbench workbench, final IStructuredSelection selection) {
		bip = new ImportSettledPricesPage("selectScenarios", currentScenario);
	...
	private void doImportAction(final String filename, final char listSeparator, final char decimalSeparator, final ScenarioModelRecord modelRecord, final Set<String> uniqueProblems,
		...
		try (final IScenarioDataProvider scenarioDataProvider = modelRecord.aquireScenarioDataProvider("ImportSettledPricesWizard")) {
			...
			final SettledPricesImportAction action = new SettledPricesImportAction(ihp, ScenarioModelUtil.getPricingModel(scenarioDataProvider));
