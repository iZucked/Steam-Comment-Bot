...
/**
 */
public class ImportHolidayCalendarsPage extends WizardPage {
	...
	public ImportHolidayCalendarsPage(final String pageName, final ScenarioInstance currentScenario) {
		super(pageName);
		this.currentScenario = currentScenario;
		setTitle("Select data and scenarios");
		setDescription("Choose scenario(s) and a file for holiday calendars import.");
	}
	...
	public void createControl(final Composite parent) {
		...
		importFileEditor.getTextControl(datafileC).addModifyListener(new ModifyListener() {
			...
			public void modifyText(final ModifyEvent e) {
				ImportHolidayCalendarsPage.this.getContainer().updateButtons();
			}
		});
