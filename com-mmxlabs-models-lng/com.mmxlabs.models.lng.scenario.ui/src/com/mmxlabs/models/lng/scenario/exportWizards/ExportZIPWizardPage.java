 ...
 * 
 */
public class ExportZIPWizardPage extends WizardPage {
	...
	private static final String SECTION_NAME = "ExportZIPWizardPage.section";
	...
	protected ExportZIPWizardPage(ISelection selection) {
		super("Export Scenario as ZIP", "Export Scenario as ZIP", null);
