	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == NamedObject.class) {
			switch (derivedFeatureID) {
				case TypesPackage.AROUTE__NAME: return MMXCorePackage.NAMED_OBJECT__NAME;
				case TypesPackage.AROUTE__OTHER_NAMES: return MMXCorePackage.NAMED_OBJECT__OTHER_NAMES;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == NamedObject.class) {
			switch (baseFeatureID) {
				case MMXCorePackage.NAMED_OBJECT__NAME: return TypesPackage.AROUTE__NAME;
				case MMXCorePackage.NAMED_OBJECT__OTHER_NAMES: return TypesPackage.AROUTE__OTHER_NAMES;
				default: return -1;
			}
		}
