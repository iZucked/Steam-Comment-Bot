...
public class TypesPackageImpl extends EPackageImpl implements TypesPackage {
	...
	public void initializePackageContents() {
		...
		alngPriceCalculatorParametersEClass.getESuperTypes().add(theMMXCorePackage.getUUIDObject());
		...
		initEClass(alngPriceCalculatorParametersEClass, ALNGPriceCalculatorParameters.class, "ALNGPriceCalculatorParameters", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
	...
	protected void createMMXCoreAnnotations() {
		...
		addAnnotation(alngPriceCalculatorParametersEClass, source, new String[] { "generatedType", "com.mmxlabs.models.lng.commercial.LNGPriceCalculatorParameters" });
	}
