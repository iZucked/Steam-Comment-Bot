 ...
 * <ul>
 *   <li>{@link com.mmxlabs.models.lng.types.impl.ASlotImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.mmxlabs.models.lng.types.impl.ASlotImpl#getPort <em>Port</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class ASlotImpl extends UUIDObjectImpl implements ASlot {
	/**
	...
	protected EClass eStaticClass() {
		return TypesPackage.Literals.ASLOT;
	}
	...
	public APort getPort() {
		if (port != null && port.eIsProxy()) {
			...
			if (port != oldPort) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TypesPackage.ASLOT__PORT, oldPort, port));
			}
		}
		return port;
	}
	...
	public void setPort(APort newPort) {
		...
		port = newPort;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.ASLOT__PORT, oldPort, port));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == ALocated.class) {
			switch (derivedFeatureID) {
				case TypesPackage.ASLOT__PORT: return TypesPackage.ALOCATED__PORT;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == ALocated.class) {
			switch (baseFeatureID) {
				case TypesPackage.ALOCATED__PORT: return TypesPackage.ASLOT__PORT;
				default: return -1;
			}
		}
