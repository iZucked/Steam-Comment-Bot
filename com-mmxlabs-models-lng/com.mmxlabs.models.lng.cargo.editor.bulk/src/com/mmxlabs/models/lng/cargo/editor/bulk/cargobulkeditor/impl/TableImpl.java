 ...
 * </p>
 * <ul>
 *   <li>{@link com.mmxlabs.models.lng.cargo.editor.bulk.cargobulkeditor.impl.TableImpl#getRows <em>Rows</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TableImpl extends EObjectImpl implements Table {
	...
	protected EClass eStaticClass() {
		return CargoBulkEditorPackage.Literals.TABLE;
	}
	...
	public EList<Row> getRows() {
		if (rows == null) {
			rows = new EObjectResolvingEList<Row>(Row.class, this, CargoBulkEditorPackage.TABLE__ROWS);
		}
		return rows;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CargoBulkEditorPackage.TABLE__ROWS:
				return getRows();
		}
