...
public class TradesBasedColumnFactory implements ITradesColumnFactory {
	...
	@Override
	public void registerColumn(final String columnID, final EMFReportColumnManager columnManager, IReferenceValueProviderProvider referenceValueProvider, EditingDomain editingDomain, IScenarioEditingLocation editingLocation, EClass eclass, final IAdaptable report) {
		switch (columnID) {
		case "com.mmxlabs.models.lng.cargo.editor.bulk.columns.TradesBasedColumnFactory.l-id": {
			BasicAttributeManipulator rendMan = new BasicAttributeManipulator(MMXCorePackage.eINSTANCE.getNamedObject_Name(), editingDomain);
			columnManager.registerColumn("TRADES_TABLE", new SimpleEmfBlockColumnFactory("LOAD_ID", "L-ID", "The main ID for all except discharge slots", ColumnType.NORMAL, LOAD_START_GROUP, DEFAULT_BLOCK_TYPE, DEFAULT_ORDER_KEY,
		...
		case "com.mmxlabs.models.lng.cargo.editor.bulk.columns.TradesBasedColumnFactory.l-vol": {
			VolumeAttributeManipulator rendMan = new VolumeAttributeManipulator(CargoPackage.eINSTANCE.getSlot_MaxQuantity(), editingDomain);
			columnManager.registerColumn("TRADES_TABLE",
					new SimpleEmfBlockColumnFactory("LOAD_VOL", "Vol", "", ColumnType.NORMAL, LOAD_MAIN_GROUP, DEFAULT_BLOCK_TYPE, DEFAULT_ORDER_KEY, rendMan, rendMan, CargoBulkEditorPackage.eINSTANCE.getRow_LoadSlot()));
		}
			break;
		case "com.mmxlabs.models.lng.cargo.editor.bulk.columns.TradesBasedColumnFactory.l-date": {
			LocalDateAttributeManipulator rendMan = new LocalDateAttributeManipulator(CargoPackage.eINSTANCE.getSlot_WindowStart(), editingDomain) {
				@Override
			...
			columnManager.registerColumn("TRADES_TABLE",
					new SimpleEmfBlockColumnFactory("LOAD_DATE", "Date", "", ColumnType.NORMAL, LOAD_MAIN_GROUP, DEFAULT_BLOCK_TYPE, DEFAULT_ORDER_KEY, rendMan, rendMan, CargoBulkEditorPackage.eINSTANCE.getRow_LoadSlot()));
		}
			break;
		case "com.mmxlabs.models.lng.cargo.editor.bulk.columns.TradesBasedColumnFactory.l-window-length": {
			NumericAttributeManipulator rendMan = new NumericAttributeManipulator(CargoPackage.eINSTANCE.getSlot_WindowSize(), editingDomain);
			columnManager.registerColumn("TRADES_TABLE",
					new SimpleEmfBlockColumnFactory("LOAD_WINDOW_SIZE", "Window Size", "", ColumnType.NORMAL, LOAD_MAIN_GROUP, DEFAULT_BLOCK_TYPE, DEFAULT_ORDER_KEY, rendMan, rendMan, CargoBulkEditorPackage.eINSTANCE.getRow_LoadSlot()));
		}
		break;
		case "com.mmxlabs.models.lng.cargo.editor.bulk.columns.TradesBasedColumnFactory.purchasecontract": {
			ContractManipulator rendMan = new ContractManipulator(referenceValueProvider, editingDomain);
			columnManager.registerColumn("TRADES_TABLE", new SimpleEmfBlockColumnFactory("PURCHASE_CONTRACT", "Purchase Contract", null, ColumnType.NORMAL, LOAD_MAIN_GROUP, DEFAULT_BLOCK_TYPE, DEFAULT_ORDER_KEY, rendMan,
					rendMan, CargoBulkEditorPackage.eINSTANCE.getRow_LoadSlot()));
		}
			break;
		case "com.mmxlabs.models.lng.cargo.editor.bulk.columns.TradesBasedColumnFactory.l-override-restrictions": {
			BooleanAttributeManipulator rendMan = new BooleanAttributeManipulator(CargoPackage.eINSTANCE.getSlot_OverrideRestrictions(), editingDomain);
			columnManager.registerColumn("TRADES_TABLE", new SimpleEmfBlockColumnFactory("LOAD_OVERRIDE_RESTRICTIONS", "Override Restrictions", null, ColumnType.NORMAL, LOAD_MAIN_GROUP, DEFAULT_BLOCK_TYPE, "restrictions_1", rendMan,
					rendMan, CargoBulkEditorPackage.eINSTANCE.getRow_LoadSlot()));
		}
		break;
		case "com.mmxlabs.models.lng.cargo.editor.bulk.columns.TradesBasedColumnFactory.l-restrictions-permissive": {
			BooleanAttributeManipulator rendMan = new BooleanAttributeManipulator(CargoPackage.eINSTANCE.getSlot_RestrictedListsArePermissive(), editingDomain);
			columnManager.registerColumn("TRADES_TABLE", new SimpleEmfBlockColumnFactory("LOAD_RESTRICTIONS_PERMISSIVE", "Restrictions Permissive", null, ColumnType.NORMAL, LOAD_MAIN_GROUP, DEFAULT_BLOCK_TYPE, "restrictions_2", rendMan,
					rendMan, CargoBulkEditorPackage.eINSTANCE.getRow_LoadSlot()));
		}
		break;
		case "com.mmxlabs.models.lng.cargo.editor.bulk.columns.TradesBasedColumnFactory.l-restricted-ports": {
			MultipleReferenceManipulator rendMan = new MultipleReferenceManipulator(CargoPackage.eINSTANCE.getSlot_RestrictedPorts(), referenceValueProvider, editingDomain, MMXCorePackage.eINSTANCE.getNamedObject_Name());
			columnManager.registerColumn("TRADES_TABLE", new SimpleEmfBlockColumnFactory("LOAD_RESTRICTED_PORTS", "Restricted Ports", null, ColumnType.NORMAL, LOAD_MAIN_GROUP, DEFAULT_BLOCK_TYPE, "restrictions_3", rendMan,
					rendMan, CargoBulkEditorPackage.eINSTANCE.getRow_LoadSlot()));
		}
		break;
		case "com.mmxlabs.models.lng.cargo.editor.bulk.columns.TradesBasedColumnFactory.l-restricted-contracts": {
			MultipleReferenceManipulator rendMan = new MultipleReferenceManipulator(CargoPackage.eINSTANCE.getSlot_RestrictedContracts(), referenceValueProvider, editingDomain, MMXCorePackage.eINSTANCE.getNamedObject_Name());
			columnManager.registerColumn("TRADES_TABLE", new SimpleEmfBlockColumnFactory("LOAD_RESTRICTED_CONTRACTS", "Restricted Contracts", null, ColumnType.NORMAL, LOAD_MAIN_GROUP, DEFAULT_BLOCK_TYPE, "restrictions_4", rendMan,
					rendMan, CargoBulkEditorPackage.eINSTANCE.getRow_LoadSlot()));
		}
		break;
		case "com.mmxlabs.models.lng.cargo.editor.bulk.columns.TradesBasedColumnFactory.l-allowed-vessels": {
			MultipleReferenceManipulator rendMan = new MultipleReferenceManipulator(CargoPackage.eINSTANCE.getSlot_AllowedVessels(), referenceValueProvider, editingDomain, MMXCorePackage.eINSTANCE.getNamedObject_Name());
			columnManager.registerColumn("TRADES_TABLE", new SimpleEmfBlockColumnFactory("LOAD_ALLOWED_VESSELS", "Allowed Vessels", null, ColumnType.NORMAL, LOAD_MAIN_GROUP, DEFAULT_BLOCK_TYPE, "restrictions_5", rendMan,
					rendMan, CargoBulkEditorPackage.eINSTANCE.getRow_LoadSlot()));
		}
		break;
		case "com.mmxlabs.models.lng.cargo.editor.bulk.columns.TradesBasedColumnFactory.d-id": {
			BasicAttributeManipulator rendMan = new BasicAttributeManipulator(MMXCorePackage.eINSTANCE.getNamedObject_Name(), editingDomain);
			columnManager.registerColumn("TRADES_TABLE",
					new SimpleEmfBlockColumnFactory("DISCHARGE_ID", "D-ID", null, ColumnType.NORMAL, DISCHARGE_START_GROUP, DEFAULT_BLOCK_TYPE, DISCHARGE_START_GROUP + "_1", rendMan, rendMan, CargoBulkEditorPackage.eINSTANCE.getRow_DischargeSlot()));
		}
			break;
		...
		case "com.mmxlabs.models.lng.cargo.editor.bulk.columns.TradesBasedColumnFactory.d-vol": {
			VolumeAttributeManipulator rendMan = new VolumeAttributeManipulator(CargoPackage.eINSTANCE.getSlot_MaxQuantity(), editingDomain);
			columnManager.registerColumn("TRADES_TABLE",
					new SimpleEmfBlockColumnFactory("DISCHARGE_VOL", "Vol", "", ColumnType.NORMAL, DISCHARGE_MAIN_GROUP, DEFAULT_BLOCK_TYPE, DEFAULT_ORDER_KEY, rendMan, rendMan, CargoBulkEditorPackage.eINSTANCE.getRow_DischargeSlot()));
		}
			break;
		case "com.mmxlabs.models.lng.cargo.editor.bulk.columns.TradesBasedColumnFactory.d-date": {
			...
			columnManager.registerColumn("TRADES_TABLE",
					new SimpleEmfBlockColumnFactory("DISCHARGE_DATE", "Date", "", ColumnType.NORMAL, DISCHARGE_MAIN_GROUP, DEFAULT_BLOCK_TYPE, DEFAULT_ORDER_KEY, rendMan, rendMan, CargoBulkEditorPackage.eINSTANCE.getRow_DischargeSlot()));
		}
			break;
		case "com.mmxlabs.models.lng.cargo.editor.bulk.columns.TradesBasedColumnFactory.d-window-length": {
			NumericAttributeManipulator rendMan = new NumericAttributeManipulator(CargoPackage.eINSTANCE.getSlot_WindowSize(), editingDomain);
			columnManager.registerColumn("TRADES_TABLE",
					new SimpleEmfBlockColumnFactory("DISCHARGE_WINDOW_SIZE", "Window Size", "", ColumnType.NORMAL, DISCHARGE_MAIN_GROUP, DEFAULT_BLOCK_TYPE, DEFAULT_ORDER_KEY, rendMan, rendMan, CargoBulkEditorPackage.eINSTANCE.getRow_DischargeSlot()));
		}
		break;
		case "com.mmxlabs.models.lng.cargo.editor.bulk.columns.TradesBasedColumnFactory.salescontract": {
			ContractManipulator rendMan = new ContractManipulator(referenceValueProvider, editingDomain);
			columnManager.registerColumn("TRADES_TABLE", new SimpleEmfBlockColumnFactory("SALES_CONTRACT", "Sales Contract", null, ColumnType.NORMAL, DISCHARGE_MAIN_GROUP, DEFAULT_BLOCK_TYPE, DEFAULT_ORDER_KEY, rendMan, rendMan, CargoBulkEditorPackage.eINSTANCE.getRow_DischargeSlot()));
		}
			break;
		case "com.mmxlabs.models.lng.cargo.editor.bulk.columns.TradesBasedColumnFactory.assignment": {
			...
			columnManager.registerColumn("TRADES_TABLE", new SimpleEmfBlockColumnFactory("ASSIGNMENT", "Assignment", null, ColumnType.NORMAL, CARGO_END_GROUP, DEFAULT_BLOCK_TYPE, DEFAULT_ORDER_KEY, rendMan, rendMan, CargoBulkEditorPackage.eINSTANCE.getRow__GetAssignableObject()));
		}
		break;
	...
	private SimpleEmfBlockColumnFactory createWiringColumn(final String columnID, final String columnName, final IAdaptable report, final boolean isLoad, String blockGroup, String blockType, String orderKey) {
