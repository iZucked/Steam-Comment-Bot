...
public class ContractTypeValueListInlineEditor extends UnsettableInlineEditor {
	private Combo combo;
	...
	public ContractTypeValueListInlineEditor(final EStructuralFeature feature) {
		...
		final EList<EEnumLiteral> eLiterals = CommercialPackage.eINSTANCE.getContractType().getELiterals();
