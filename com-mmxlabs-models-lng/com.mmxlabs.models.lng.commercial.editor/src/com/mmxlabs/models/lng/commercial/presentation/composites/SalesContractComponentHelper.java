 ...
 *
 */
public class SalesContractComponentHelper extends DefaultComponentHelper {

	public SalesContractComponentHelper() {
		super(CommercialPackage.Literals.SALES_CONTRACT);

		addEditor(CommercialPackage.Literals.SALES_CONTRACT__FOB_SALE_DEAL_TYPE, topClass -> {
	...
	protected void sortEditors(List<IInlineEditor> editors) {
		...
		sortEditorBeforeOtherEditor(editors, CommercialPackage.Literals.SALES_CONTRACT__FOB_SALE_DEAL_TYPE, CommercialPackage.Literals.CONTRACT__SHIPPING_DAYS_RESTRICTION);
