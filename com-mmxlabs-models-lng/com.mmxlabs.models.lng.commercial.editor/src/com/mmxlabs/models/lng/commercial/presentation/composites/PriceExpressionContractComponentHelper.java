...
/**
 * A component helper for PriceExpressionContract instances
 *
 * @generated
 */
public class PriceExpressionContractComponentHelper extends BaseComponentHelper {
	 ...
	 * @generated
	 */
	public PriceExpressionContractComponentHelper() {
	...
	/**
	 * add editors to a composite, using PriceExpressionContract as the supertype
	 *
	 * @generated
	 */
	 @Override
	public void addEditorsToComposite(final IInlineEditorContainer detailComposite) {
		addEditorsToComposite(detailComposite, CommercialPackage.Literals.PRICE_EXPRESSION_CONTRACT);	
	}
	...
	/**
	 * Create the editor for the priceExpression feature on PriceExpressionContract
	 *
	 * @generated
	 */
	protected void add_priceExpressionEditor(final IInlineEditorContainer detailComposite, final EClass topClass) {
		detailComposite.addInlineEditor(ComponentHelperUtils.createDefaultEditor(topClass, CommercialPackage.Literals.PRICE_EXPRESSION_CONTRACT__PRICE_EXPRESSION));
	}
}