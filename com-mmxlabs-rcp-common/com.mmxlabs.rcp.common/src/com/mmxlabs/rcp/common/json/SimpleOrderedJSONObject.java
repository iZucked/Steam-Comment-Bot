...
/**
 * Fork of {@link org.json.simple.JSONObject} using a LinkedHashMap rather than a HashMap as super class to retain insertion order.
 */
public class SimpleOrderedJSONObject extends LinkedHashMap implements Map, JSONAware, JSONStreamAware {

	private static final long serialVersionUID = -503443796854799292L;

	public SimpleOrderedJSONObject() {
		super();
	}
	 ...
	 * @param map
	 */
	public SimpleOrderedJSONObject(Map map) {
		super(map);
	}
