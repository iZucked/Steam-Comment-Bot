package com.mmxlabs.lngdataserver.ui.vessels;
...
public class VesselsUiEndpointExtension implements EndpointExtension {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(VesselsUiEndpointExtension.class);
