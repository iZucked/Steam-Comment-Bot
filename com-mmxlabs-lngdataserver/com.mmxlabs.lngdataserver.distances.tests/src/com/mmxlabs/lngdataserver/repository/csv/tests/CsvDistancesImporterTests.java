...
public class CsvDistancesImporterTests {
	...
	public void testImport() throws IOException{
		...
		assertEquals(Integer.valueOf(5),result.get("arzew").get("bethioua"));
		assertEquals(Integer.valueOf(12598),result.get("gladstone").get("arzew"));
		assertEquals(Integer.valueOf(12603),result.get("arzew").get("gladstone"));
		assertEquals(Integer.valueOf(0),result.get("gladstone").get("gladstone"));
	}
}
