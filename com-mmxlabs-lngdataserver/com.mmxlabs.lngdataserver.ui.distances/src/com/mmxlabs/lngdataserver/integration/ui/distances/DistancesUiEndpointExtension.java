package com.mmxlabs.lngdataserver.integration.ui.distances;
...
public class DistancesUiEndpointExtension implements EndpointExtension {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(DistancesUiEndpointExtension.class);
