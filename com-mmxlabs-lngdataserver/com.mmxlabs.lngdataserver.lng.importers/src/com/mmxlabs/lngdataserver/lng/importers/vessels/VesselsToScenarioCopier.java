...
public class VesselsToScenarioCopier {
	...
	public static Command getUpdateVesselsCommand(@NonNull final EditingDomain editingDomain, IVesselsProvider vesselsProvider, @NonNull final FleetModel fleetModel) {
		...
		// Vessel to update
		Collection<com.mmxlabs.lngdataserver.vessel.model.@NonNull Vessel> toUpdateVessels = vesselsProvider.getVessels();
		...
		for(com.mmxlabs.lngdataserver.vessel.model.@NonNull Vessel vessel: vesselsProvider.getVessels()) {
			...
			// Ballast Model
			cc.append(SetCommand.create(editingDomain, vesselToUpdate.getBallastAttributes(), FleetPackage.Literals.VESSEL_STATE_ATTRIBUTES__IDLE_BASE_RATE, vessel.getBallastAttributes().getIdleBaseRate()));
			cc.append(SetCommand.create(editingDomain, vesselToUpdate.getBallastAttributes(), FleetPackage.Literals.VESSEL_STATE_ATTRIBUTES__IDLE_NBO_RATE, vessel.getBallastAttributes().getIdleNBORate()));
			...
			cc.append(SetCommand.create(editingDomain, vesselToUpdate.getBallastAttributes(), FleetPackage.Literals.VESSEL_STATE_ATTRIBUTES__SERVICE_SPEED, vessel.getBallastAttributes().getServiceSped()));
			cc.append(SetCommand.create(editingDomain, vesselToUpdate.getBallastAttributes(), FleetPackage.Literals.VESSEL_STATE_ATTRIBUTES__IN_PORT_BASE_RATE, vessel.getBallastAttributes().getInPortBaseRate()));
			cc.append(SetCommand.create(editingDomain, vesselToUpdate.getBallastAttributes(), FleetPackage.Literals.VESSEL_STATE_ATTRIBUTES__IN_PORT_NBO_RATE, vessel.getBallastAttributes().getInPortNBORate()));
			cc.append(AddCommand.create(editingDomain, vesselToUpdate.getBallastAttributes().getFuelConsumption(), FleetPackage.Literals.FUEL_CONSUMPTION, vessel.getBallastAttributes().getFuelConsumption()));
			
			// Laden Model
			cc.append(SetCommand.create(editingDomain, vesselToUpdate.getLadenAttributes(), FleetPackage.Literals.VESSEL_STATE_ATTRIBUTES__IDLE_BASE_RATE, vessel.getLadenAttributes().getIdleBaseRate()));
			cc.append(SetCommand.create(editingDomain, vesselToUpdate.getLadenAttributes(), FleetPackage.Literals.VESSEL_STATE_ATTRIBUTES__IDLE_NBO_RATE, vessel.getLadenAttributes().getIdleNBORate()));
			...
			cc.append(SetCommand.create(editingDomain, vesselToUpdate.getLadenAttributes(), FleetPackage.Literals.VESSEL_STATE_ATTRIBUTES__SERVICE_SPEED, vessel.getLadenAttributes().getServiceSped()));
			cc.append(SetCommand.create(editingDomain, vesselToUpdate.getLadenAttributes(), FleetPackage.Literals.VESSEL_STATE_ATTRIBUTES__IN_PORT_BASE_RATE, vessel.getLadenAttributes().getInPortBaseRate()));
			cc.append(SetCommand.create(editingDomain, vesselToUpdate.getLadenAttributes(), FleetPackage.Literals.VESSEL_STATE_ATTRIBUTES__IN_PORT_NBO_RATE, vessel.getLadenAttributes().getInPortNBORate()));
			cc.append(AddCommand.create(editingDomain, vesselToUpdate.getLadenAttributes().getFuelConsumption(), FleetPackage.Literals.FUEL_CONSUMPTION, vessel.getLadenAttributes().getFuelConsumption()));
