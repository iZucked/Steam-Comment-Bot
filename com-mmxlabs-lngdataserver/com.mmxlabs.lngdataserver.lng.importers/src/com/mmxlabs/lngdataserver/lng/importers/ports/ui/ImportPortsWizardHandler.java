...
import com.mmxlabs.models.lng.scenario.mergeWizards.SharedScenarioDataImportWizard;
...
public class ImportPortsWizardHandler extends AbstractHandler{
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		PortsToScenarioImportWizard wizard = new PortsToScenarioImportWizard(currentInstance);
