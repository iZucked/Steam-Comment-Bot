...
public class PricingClient {
	...
	public static List<String> getVersions(String baseUrl) throws IOException {
		...
		List<com.mmxlabs.lngdataserver.pricing.model.Version> pricingVersions = new ObjectMapper()
				.readValue(pricingResponse.body().byteStream(), new TypeReference<List<com.mmxlabs.lngdataserver.pricing.model.Version>>() {});
	...
	public static CompletableFuture<String> notifyOnNewVersion(String baseUrl) {
		...
		CompletableFuture<String> completableFuture = CompletableFuture.supplyAsync( ( ) -> {
			...
			try {
				...
				com.mmxlabs.lngdataserver.pricing.model.Version newVersion = new ObjectMapper()
						.readValue(response.body().byteStream(), com.mmxlabs.lngdataserver.pricing.model.Version.class);
