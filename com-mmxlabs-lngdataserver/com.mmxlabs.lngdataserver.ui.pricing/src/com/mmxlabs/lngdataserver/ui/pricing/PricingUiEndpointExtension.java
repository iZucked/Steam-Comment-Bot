...
public class PricingUiEndpointExtension implements EndpointExtension {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(PricingUiEndpointExtension.class);
