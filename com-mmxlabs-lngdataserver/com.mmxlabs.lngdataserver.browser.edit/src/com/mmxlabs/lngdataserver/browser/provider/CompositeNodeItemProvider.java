...
/**
 * This is the item provider adapter for a {@link com.mmxlabs.lngdataserver.browser.CompositeNode} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CompositeNodeItemProvider extends NodeItemProvider {
	/**
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_CompositeNode_type_feature"), getString("_UI_PropertyDescriptor_description", "_UI_CompositeNode_type_feature", "_UI_CompositeNode_type"),
				BrowserPackage.Literals.COMPOSITE_NODE__TYPE, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BrowserPackage.Literals.COMPOSITE_NODE__CHILDREN);
		}
	...
	public String getText(Object object) {
		String label = ((CompositeNode) object).getDisplayName();
		return label == null || label.length() == 0 ? getString("_UI_CompositeNode_type") : getString("_UI_CompositeNode_type") + " " + label;
	}
