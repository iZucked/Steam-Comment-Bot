...
public class UnitConversionFactorsIO {
	...
	public static UnitConversionFactorsVersion read(final InputStream is) throws IOException {
		...
		if (header.getModelVersion() == CURRENT_MODEL_VERSION) {
			return mapper.readValue(is, UnitConversionFactorsVersion.class);
		} else {
	...
	public static void write(final UnitConversionFactorsVersion version, final OutputStream os) throws IOException {
		final ObjectMapper mapper = createObjectMapper();
