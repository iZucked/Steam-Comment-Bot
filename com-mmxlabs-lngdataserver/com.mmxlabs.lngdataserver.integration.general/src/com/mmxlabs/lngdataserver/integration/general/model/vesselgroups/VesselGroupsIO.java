...
public class VesselGroupsIO {

	public static final String MODEL_TYPE = "vessel-groups";

	public static final int CURRENT_MODEL_VERSION = 1;

	private VesselGroupsIO() {
	...
	public static VesselGroupsVersion read(final InputStream is) throws IOException {
		...
		if (header.getModelVersion() == CURRENT_MODEL_VERSION) {
			return mapper.readValue(is, VesselGroupsVersion.class);
		} else {
	...
	public static void write(final VesselGroupsVersion version, final OutputStream os) throws IOException {
		final ObjectMapper mapper = createObjectMapper();
