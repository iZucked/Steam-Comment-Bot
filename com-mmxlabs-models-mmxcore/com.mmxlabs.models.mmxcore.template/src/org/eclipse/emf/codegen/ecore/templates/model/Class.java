...
public class Class
{
  ...
  protected final String TEXT_57 = NL + "\t/**" + NL + "\t * An array of objects representing the values of non-primitive features." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_58 = NL + "\t@";
  protected final String TEXT_59 = NL + "\tprotected Object[] ";
  protected final String TEXT_60 = ";" + NL;
  protected final String TEXT_61 = NL + "\t/**" + NL + "\t * A bit field representing the indices of non-primitive feature values." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_62 = NL + "\t@";
  protected final String TEXT_63 = NL + "\tprotected int ";
  protected final String TEXT_64 = ";" + NL;
  protected final String TEXT_65 = NL + "\t/**" + NL + "\t * A set of bit flags representing the values of boolean attributes and whether unsettable features have been set." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t * @ordered" + NL + "\t */";
  protected final String TEXT_66 = NL + "\t@";
  protected final String TEXT_67 = NL + "\tprotected int ";
  protected final String TEXT_68 = " = 0;" + NL;
  protected final String TEXT_69 = NL + "\t/**" + NL + "\t * The cached setting delegate for the '{@link #";
  ...
  protected final String TEXT_76 = ".Internal.SettingDelegate ";
  protected final String TEXT_77 = "__ESETTING_DELEGATE = ((";
  protected final String TEXT_78 = ".Internal)";
  protected final String TEXT_79 = ").getSettingDelegate();" + NL;
  protected final String TEXT_80 = NL + "\t/**" + NL + "\t * The cached value of the '{@link #";
  ...
  protected final String TEXT_86 = NL + "\tprotected ";
  protected final String TEXT_87 = " ";
  protected final String TEXT_88 = ";" + NL;
  protected final String TEXT_89 = NL + "\t/**" + NL + "\t * The empty value for the '{@link #";
  protected final String TEXT_90 = "() <em>";
  protected final String TEXT_91 = "</em>}' array accessor." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @see #";
  ...
  protected final String TEXT_96 = "_EEMPTY_ARRAY = new ";
  ...
  protected final String TEXT_103 = "()" + NL + "\t * @generated" + NL + "\t * @ordered" + NL + "\t */";
  protected final String TEXT_104 = NL + "\t@SuppressWarnings(\"unchecked\")";
  protected final String TEXT_105 = NL + "\tprotected static final ";
  protected final String TEXT_106 = " ";
  protected final String TEXT_107 = "; // TODO The default value literal \"";
  protected final String TEXT_108 = "\" is not valid.";
  protected final String TEXT_109 = " = ";
  protected final String TEXT_110 = ";";
  protected final String TEXT_111 = NL;
  protected final String TEXT_112 = NL + "\t/**" + NL + "\t * An additional set of bit flags representing the values of boolean attributes and whether unsettable features have been set." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t * @ordered" + NL + "\t */";
  protected final String TEXT_113 = NL + "\t@";
  protected final String TEXT_114 = NL + "\tprotected int ";
  protected final String TEXT_115 = " = 0;" + NL;
  protected final String TEXT_116 = NL + "\t/**" + NL + "\t * The offset of the flags representing the value of the '{@link #";
  ...
  protected final String TEXT_120 = "_EFLAG_OFFSET = ";
  protected final String TEXT_121 = ";" + NL + "" + NL + "\t/**" + NL + "\t * The flags representing the default value of the '{@link #";
  ...
  protected final String TEXT_126 = ".ordinal()";
  protected final String TEXT_127 = ".VALUES.indexOf(";
  protected final String TEXT_128 = ")";
  protected final String TEXT_129 = " << ";
  protected final String TEXT_130 = "_EFLAG_OFFSET;" + NL + "" + NL + "\t/**" + NL + "\t * The array of enumeration values for '{@link ";
  protected final String TEXT_131 = " ";
  protected final String TEXT_132 = "}'" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t * @ordered" + NL + "\t */" + NL + "\tprivate static final ";
  protected final String TEXT_133 = "[] ";
  protected final String TEXT_134 = "_EFLAG_VALUES = ";
  protected final String TEXT_135 = ".values()";
  protected final String TEXT_136 = "(";
  protected final String TEXT_137 = "[])";
  protected final String TEXT_138 = ".VALUES.toArray(new ";
  protected final String TEXT_139 = "[";
  protected final String TEXT_140 = ".VALUES.size()])";
  protected final String TEXT_141 = ";" + NL;
  protected final String TEXT_142 = NL + "\t/**" + NL + "\t * The flag";
  protected final String TEXT_143 = " representing the value of the '{@link #";
  protected final String TEXT_144 = "() <em>";
  protected final String TEXT_145 = "</em>}' ";
  protected final String TEXT_146 = "." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @see #";
  protected final String TEXT_147 = "()" + NL + "\t * @generated" + NL + "\t * @ordered" + NL + "\t */" + NL + "\tprotected static final int ";
  protected final String TEXT_148 = "_EFLAG = ";
  protected final String TEXT_149 = " << ";
  protected final String TEXT_150 = "_EFLAG_OFFSET";
  protected final String TEXT_151 = ";" + NL;
  protected final String TEXT_152 = NL + "\t/**" + NL + "\t * The cached value of the '{@link #";
  protected final String TEXT_153 = "() <em>";
  protected final String TEXT_154 = "</em>}' ";
  protected final String TEXT_155 = "." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @see #";
  protected final String TEXT_156 = "()" + NL + "\t * @generated" + NL + "\t * @ordered" + NL + "\t */";
  protected final String TEXT_157 = NL + "\t@";
  protected final String TEXT_158 = NL + "\tprotected ";
  protected final String TEXT_159 = " ";
  protected final String TEXT_160 = " = ";
  protected final String TEXT_161 = ";" + NL;
  protected final String TEXT_162 = NL + "\t/**" + NL + "\t * An additional set of bit flags representing the values of boolean attributes and whether unsettable features have been set." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t * @ordered" + NL + "\t */";
  protected final String TEXT_163 = NL + "\t@";
  protected final String TEXT_164 = NL + "\tprotected int ";
  protected final String TEXT_165 = " = 0;" + NL;
  protected final String TEXT_166 = NL + "\t/**" + NL + "\t * The flag representing whether the ";
  protected final String TEXT_167 = " ";
  protected final String TEXT_168 = " has been set." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t * @ordered" + NL + "\t */" + NL + "\tprotected static final int ";
  protected final String TEXT_169 = "_ESETFLAG = 1 << ";
  protected final String TEXT_170 = ";" + NL;
  protected final String TEXT_171 = NL + "\t/**" + NL + "\t * This is true if the ";
  protected final String TEXT_172 = " ";
  protected final String TEXT_173 = " has been set." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t * @ordered" + NL + "\t */";
  protected final String TEXT_174 = NL + "\t@";
  protected final String TEXT_175 = NL + "\tprotected boolean ";
  protected final String TEXT_176 = "ESet;" + NL;
  ...
  protected final String TEXT_187 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate static final int \"EOPERATION_OFFSET_CORRECTION\" = ";
  protected final String TEXT_188 = ".getOperationID(";
  protected final String TEXT_189 = ") - ";
  protected final String TEXT_190 = ";" + NL;
  protected final String TEXT_191 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\t";
  protected final String TEXT_192 = "public";
  protected final String TEXT_193 = "protected";
  protected final String TEXT_194 = " ";
  protected final String TEXT_195 = "()" + NL + "\t{" + NL + "\t\tsuper();";
  protected final String TEXT_196 = NL + "\t\t";
  protected final String TEXT_197 = " |= ";
  protected final String TEXT_198 = "_EFLAG";
  protected final String TEXT_199 = "_DEFAULT";
  protected final String TEXT_200 = ";";
  protected final String TEXT_201 = NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_202 = NL + "\t@Override";
  protected final String TEXT_203 = NL + "\tprotected ";
  protected final String TEXT_204 = " eStaticClass()" + NL + "\t{" + NL + "\t\treturn ";
  ...
  protected final String TEXT_208 = NL + "\tprotected int eStaticFeatureCount()" + NL + "\t{" + NL + "\t\treturn ";
  protected final String TEXT_209 = ";" + NL + "\t}" + NL;
  protected final String TEXT_210 = NL + "\t" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  ...
  protected final String TEXT_220 = "();" + NL + "\t\tif (list.isEmpty()) return ";
  protected final String TEXT_221 = "(";
  protected final String TEXT_222 = "[])";
  protected final String TEXT_223 = "_EEMPTY_ARRAY;";
  protected final String TEXT_224 = NL + "\t\tif (";
  protected final String TEXT_225 = " == null || ";
  protected final String TEXT_226 = ".isEmpty()) return ";
  protected final String TEXT_227 = "(";
  protected final String TEXT_228 = "[])";
  protected final String TEXT_229 = "_EEMPTY_ARRAY;" + NL + "\t\t";
  protected final String TEXT_230 = " list = (";
  protected final String TEXT_231 = ")";
  protected final String TEXT_232 = ";";
  protected final String TEXT_233 = NL + "\t\tlist.shrink();" + NL + "\t\treturn (";
  protected final String TEXT_234 = "[])list.data();" + NL + "\t}" + NL;
  ...
  protected final String TEXT_241 = "(int index)" + NL + "\t{" + NL + "\t\treturn ";
  protected final String TEXT_242 = "(";
  protected final String TEXT_243 = ")";
  protected final String TEXT_244 = "().get(index);" + NL + "\t}" + NL;
  protected final String TEXT_245 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_246 = NL + "\tint get";
  protected final String TEXT_247 = "Length();" + NL;
  protected final String TEXT_248 = NL + "\tpublic int get";
  protected final String TEXT_249 = "Length()" + NL + "\t{";
  protected final String TEXT_250 = NL + "\t\treturn ";
  protected final String TEXT_251 = "().size();";
  protected final String TEXT_252 = NL + "\t\treturn ";
  protected final String TEXT_253 = " == null ? 0 : ";
  ...
  protected final String TEXT_257 = NL + "\tvoid set";
  protected final String TEXT_258 = "(";
  protected final String TEXT_259 = "[] new";
  protected final String TEXT_260 = ");" + NL;
  protected final String TEXT_261 = NL + "\tpublic void set";
  protected final String TEXT_262 = "(";
  protected final String TEXT_263 = "[] new";
  protected final String TEXT_264 = ")" + NL + "\t{" + NL + "\t\t((";
  protected final String TEXT_265 = ")";
  protected final String TEXT_266 = "()).setData(new";
  protected final String TEXT_267 = ".length, new";
  ...
  protected final String TEXT_270 = NL + "\tvoid set";
  protected final String TEXT_271 = "(int index, ";
  protected final String TEXT_272 = " element);" + NL;
  protected final String TEXT_273 = NL + "\tpublic void set";
  protected final String TEXT_274 = "(int index, ";
  protected final String TEXT_275 = " element)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_276 = "().set(index, element);" + NL + "\t}" + NL;
  protected final String TEXT_277 = NL + "\t/**" + NL + "\t * Returns the value of the '<em><b>";
  protected final String TEXT_278 = "</b></em>' ";
  protected final String TEXT_279 = ".";
  protected final String TEXT_280 = NL + "\t * The key is of type ";
  protected final String TEXT_281 = "list of {@link ";
  protected final String TEXT_282 = "}";
  protected final String TEXT_283 = "{@link ";
  protected final String TEXT_284 = "}";
  protected final String TEXT_285 = "," + NL + "\t * and the value is of type ";
  protected final String TEXT_286 = "list of {@link ";
  protected final String TEXT_287 = "}";
  protected final String TEXT_288 = "{@link ";
  protected final String TEXT_289 = "}";
  protected final String TEXT_290 = ",";
  protected final String TEXT_291 = NL + "\t * The list contents are of type {@link ";
  protected final String TEXT_292 = "}";
  protected final String TEXT_293 = ".";
  protected final String TEXT_294 = NL + "\t * The default value is <code>";
  protected final String TEXT_295 = "</code>.";
  protected final String TEXT_296 = NL + "\t * The literals are from the enumeration {@link ";
  protected final String TEXT_297 = "}.";
  protected final String TEXT_298 = NL + "\t * It is bidirectional and its opposite is '{@link ";
  protected final String TEXT_299 = "#";
  protected final String TEXT_300 = " <em>";
  protected final String TEXT_301 = "</em>}'.";
  protected final String TEXT_302 = NL + "\t * <!-- begin-user-doc -->";
  protected final String TEXT_303 = NL + "\t * <p>" + NL + "\t * If the meaning of the '<em>";
  protected final String TEXT_304 = "</em>' ";
  protected final String TEXT_305 = " isn't clear," + NL + "\t * there really should be more of a description here..." + NL + "\t * </p>";
  protected final String TEXT_306 = NL + "\t * <!-- end-user-doc -->";
  protected final String TEXT_307 = NL + "\t * <!-- begin-model-doc -->" + NL + "\t * ";
  protected final String TEXT_308 = NL + "\t * <!-- end-model-doc -->";
  protected final String TEXT_309 = NL + "\t * @return the value of the '<em>";
  protected final String TEXT_310 = "</em>' ";
  protected final String TEXT_311 = ".";
  protected final String TEXT_312 = NL + "\t * @see ";
  protected final String TEXT_313 = NL + "\t * @see #isSet";
  protected final String TEXT_314 = "()";
  protected final String TEXT_315 = NL + "\t * @see #unset";
  protected final String TEXT_316 = "()";
  protected final String TEXT_317 = NL + "\t * @see #set";
  protected final String TEXT_318 = "(";
  protected final String TEXT_319 = ")";
  protected final String TEXT_320 = NL + "\t * @see ";
  protected final String TEXT_321 = "#get";
  protected final String TEXT_322 = "()";
  protected final String TEXT_323 = NL + "\t * @see ";
  protected final String TEXT_324 = "#";
  protected final String TEXT_325 = NL + "\t * @model ";
  protected final String TEXT_326 = NL + "\t *        ";
  protected final String TEXT_327 = NL + "\t * @model";
  ...
  protected final String TEXT_333 = NL + "\t@SuppressWarnings(\"unchecked\")";
  ...
  protected final String TEXT_341 = ")eDynamicGet(";
  ...
  protected final String TEXT_351 = ")eGet(";
  protected final String TEXT_352 = ", true)";
  ...
  protected final String TEXT_360 = "__ESETTING_DELEGATE.dynamicGet(this, null, 0, true, false)";
  ...
  protected final String TEXT_371 = NL + "\t\t\teVirtualSet(";
  ...
  protected final String TEXT_378 = NL + "\t\t}" + NL + "\t\treturn ";
  ...
  protected final String TEXT_1757 = NL + "} // end of ";
 ...
 */
    ...
    final GenClass genClass = (GenClass)((Object[])argument)[0]; final GenPackage genPackage = genClass.getGenPackage();
