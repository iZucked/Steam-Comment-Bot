 ...
 * 
 */
public abstract class AbstractEclipseJobControl2 implements IJobControl {

	private static final Logger LOG = LoggerFactory.getLogger(AbstractEclipseJobControl2.class);
			...
			try {
				doRunJob(new SubProgressMonitor(monitor, 100) {
					...
					public void worked(int work) {
						super.worked(work);
						AbstractEclipseJobControl2.this.setProgress(progress + work);
					}
				});
...
//			return Status.OK_STATUS;
	...
	public AbstractEclipseJobControl2(final String jobName) {
	 ...
	 * @param jobProperties
	 */
	public AbstractEclipseJobControl2(final String jobName, final Map<QualifiedName, Object> jobProperties) {
		super();
