...
public abstract class AbstractRegistry<Key, Factory> {
	protected final Map<Key, Factory> cache = new HashMap<>();
	protected final Map<String, Factory> cacheByID = new HashMap<>();

	protected int getMinimumGenerations(final EClass eClass, final String canonicalNameOfSuper) {
		if (canonicalNameOfSuper == null) {
