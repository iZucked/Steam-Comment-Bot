...
public interface IExtraValidationContext {
	...
	/**
	 * Get any other EObjects which will be next to the given EObject -- <code>getSiblings(x)</code> is equivalent to
	 * {@link #getContents(EObject, EReference) getContents}({@link #getContainer(EObject) getContainer(x)}, {@link #getContainment(EObject) getContainment(x)})
	 * @param object
	 * @return
	 */
