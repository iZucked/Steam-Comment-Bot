...
public class ControlUtils {
	/**
	 * Set the enabled state on the given control, and all its children if it is
	 * a composite
	 * 
	 * @param sub
	 * @param enabled
	 */
	public static void setControlEnabled(final Control sub,
	 ...
	 * @return
	 */
	public static <U> U findControlOfClass(final Control control, Class<U> class1) {
