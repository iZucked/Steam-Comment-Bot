 ...
 * 
 */
public class YearMonthTextFormatter extends AbstractDateTimeTextFormatter {
	/**
	 ...
	 *            edit mask
	 */
	public YearMonthTextFormatter(final String editPattern) {
	 ...
	 *            display mask
	 */
	public YearMonthTextFormatter(final String editPattern, final String displayPattern) {
	...
	public String getDefaultEditPattern() {
		return DateTimeFormatsProvider.INSTANCE.getYearMonthStringEdit();
	}

	public static @NonNull String format(final @Nullable YearMonth date) {
