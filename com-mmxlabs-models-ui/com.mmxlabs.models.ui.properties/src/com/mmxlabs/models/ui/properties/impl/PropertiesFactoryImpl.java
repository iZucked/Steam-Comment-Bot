...
public class PropertiesFactoryImpl extends EFactoryImpl implements PropertiesFactory {
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case PropertiesPackage.ILABEL_PROVIDER:
				return createILabelProviderFromString(eDataType, initialValue);
			default:
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
			case PropertiesPackage.ILABEL_PROVIDER:
				return convertILabelProviderToString(eDataType, instanceValue);
			default:
				throw new IllegalArgumentException("The datatype '" + eDataType.getName() + "' is not a valid classifier");
		}
	}
	 ...
	 * @generated
	 */
	public ILabelProvider createILabelProviderFromString(EDataType eDataType, String initialValue) {
		return (ILabelProvider)super.createFromString(eDataType, initialValue);
	}
	 ...
	 * @generated
	 */
	public String convertILabelProviderToString(EDataType eDataType, Object instanceValue) {
