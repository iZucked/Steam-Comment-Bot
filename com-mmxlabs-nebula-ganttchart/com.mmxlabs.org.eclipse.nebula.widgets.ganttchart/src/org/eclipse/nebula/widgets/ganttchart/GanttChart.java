 ...
 * <p>
 * <b>Description</b><br>
 * The GANTT widget has taken hints from Microsoft Project as far as arrow styles and overall look and feel goes. There are features such as dependencies, checkpoints, revised dates, and much more.
 * Nearly everything is customizable and you can zoom in to detailed day views all the way out to yearly overviews (12 zoom levels). Events can be resized, dragged and dropped and various other
 * things.
 * <p>
 * The widget is extremely simple to use for those wishing a basic implementation, or you can customize everything down to the pixel level if you so wish. Basically, if you don't like something,
 * change it!
 * <p>
 * Important note: This class exposes a few select methods from the actual GanttComposite (where all the magic happens). If you are looking for a specific method and can't find it here, do a call to
 * getGanttComposite() and see if the method you are looking for is located there.
 * <p>
 ...
 * <p>
 * <b>Customizing</b><br>
 * As you may wish to customize the widget beyond the capabilities it already has, there are a few ways you may basically take control over as much or little as you please. First, there are four
 * interfaces that are of importance. They are the IPaintManager, the IColorManager, the ISettings and the ILanguageManager. Let's start with the IColorManager.
 * <p>
 * <b>IColorManager</b><br>
 * If you don't specify a color manager, the DefaultColorManager will be used. The color manager's job is to return colors to the method that is painting everything that is visual in the chart. The
 * colors that are returned from the ColorManager will determine everything as far as looks go.
 * <p>
 * <b>IPaintManager</b><br>
 * This interface is one you want to use if you want to dig really deep into how things are drawn. This class by default controls exactly how an event is represented visually, pixel by pixel. If you
 * don't like the look of a certain object on the chart, this is the interface you will want to implement.
 * <p>
 * <b>ISettings</b><br>
 * This interface is probably the most likely that you will be implementing on your own. Mainly this interface controls pixel values (widths, heights, multipliers) and various boolean flags (if events
...
public class GanttChart extends Composite {
	 ...
	 *                     Widget style
	 * @param settings
	 *                     ISettings implementation or null
	 * @throws IllegalArgumentException
	 *                                          <ul>
	 *                                          <li>ERROR_NULL_ARGUMENT - if the parent is null</li>
	 *                                          </ul>
	...
	/**
	 * Constructs a new GANTT chart widget with custom settings, custom color manager {@link IColorManager}, a custom paint manager {@link IPaintManager} and a custom language manager
	 * {@link ILanguageManager}. If any of the managers is set to null the default manager using that implementation will be used. For styles, please see {@link GanttFlags}.
	 * 
	 * @param parent
	 *                         Parent composite
	 * @param style
	 ...
	 *                         ISettings implementation or null
	 * @param colorManager
	 *                         IColorManager implementation or null
	 * @param paintManager
	 *                         IPaintManager implementation or null
	 * @throws IllegalArgumentException
	 *                                          <ul>
	 *                                          <li>ERROR_NULL_ARGUMENT - if the parent is null</li>
	 *                                          </ul>
