...
public class CharterCostCalculatorTests extends AbstractMicroTestCase {
	...
	public static Collection<?> getTestParameters() {
		return Arrays.asList(new Object[][] { { WeightedAverageCharterCostCalculator.class }, { CharterRateToCharterCostCalculator.class } });
	}
	...
	private long validateFixedDailyRateEventCharterCost(ZonedDateTime voyagePlanStart, Event event) {
		...
		// Compute charter cost hour by hour, by adding charter cost per day per hour
		// and then dividing by 24 at the end to correct amount.
