...
public class IOTester {
	...
	public IOTester(final String name, final String scenarioPath) throws Exception {
...
//			{ "testBonnyProblems_Bonny", "/scenarios/demo-cases/Bonny problems/0 Bonny.scenario - CSV/" },
...
//		"/scenarios/demo-cases/Bonny problems/0 Bonny.scenario - CSV/
		
		LNGScenarioModel testCase = IOTestUtil.URLtoScenario(url);
		...
		LNGScenarioModel restoredCase = IOTestUtil.URLtoScenario(restoredURL);
