...
public class EventsBeforeBoundaryTests {
	...
	public void checkCharterOutEventAfterBoundary() throws Exception {
		...
		try {
			...
			Assert.assertEquals(ZonedDateTime.of(2015, 5, 1, 0, 0, 0, 0, rasLaffanTimeZone).withZoneSameInstant(utcTimeZone), vesselAvailability.getStartAfterAsDateTime());
			Assert.assertEquals(ZonedDateTime.of(2015, 5, 1, 0, 0, 0, 0, rasLaffanTimeZone).withZoneSameInstant(utcTimeZone), vesselAvailability.getStartByAsDateTime());
	...
	public void checkDryDockEventAfterBoundary() throws Exception {
		...
		cargoModelBuilder.makeDryDockEvent("drydock-2", LocalDateTime.of(2015, 5, 1, 0, 0, 0), LocalDateTime.of(2015, 5, 1, 0, 0, 0), portFinder.findPort("Ras Laffan")) //
				.withVesselAssignment(vesselAvailability_1, 2) //
				.withDurationInDays(20) //
				.build(); //
	...
	public void checkMaintenceEventAfterBoundary() throws Exception {
		...
		cargoModelBuilder.makeMaintenanceEvent("event-2", LocalDateTime.of(2015, 5, 1, 0, 0, 0), LocalDateTime.of(2015, 5, 1, 0, 0, 0), portFinder.findPort("Ras Laffan")) //
				.withVesselAssignment(vesselAvailability_1, 2) //
				.build(); //
