...
public class DistanceDataCommandProviderTest extends AbstractMicroTestCase {
	...
	public void test_ChangePortData() throws Exception {
		...
		String currentVersion = portModel.getDistanceDataVersion();
		...
		Assert.assertNotEquals(currentVersion, portModel.getDistanceDataVersion());
		currentVersion = portModel.getDistanceDataVersion();
	...
	public void test_ChangeOtherPortData() throws Exception {
		...
		Assert.assertEquals(currentVersion, portModel.getDistanceDataVersion());
