...
public class VesselAvailabilityOverrideTests extends AbstractMicroTestCase {

	final static String TEST_ENTITY = "TestEntity";
	...
	public void testEntityOnVA() {
		...
		assertEquals(TEST_ENTITY, va.getAvailabilityOrBallastBonusCharterContractEntity().getName());
	}
