...
import com.mmxlabs.shiplingo.platform.vanilla.extensions.VanillaOptimiserModuleService;
import com.mmxlabs.shiplingo.platform.vanilla.extensions.contracts.StandardContractTransformerExtensionFactory;
import com.mmxlabs.shiplingo.platform.vanilla.extensions.entities.VanillaEntityTransformerExtensionFactory;

public class VanillaExtensionTestModule extends AbstractModule {
	...
	protected void configure() {
		...
		if (!Platform.isRunning()) {
			...
			final List<IOptimiserInjectorService> injectorServices = new ArrayList<IOptimiserInjectorService>();
			injectorServices.add(new SchedulerComponentsInjectorService());
			injectorServices.add(new VanillaOptimiserModuleService());
			injectorServices.add(new RestrictedElementsModule.RestrictedElementsInjectorService());
			injectorServices.add(new ShippingTypeRequirementModule.DesPermissionInjectorService());
			...
			transformerExtensionFactories.add(new VanillaEntityTransformerExtensionFactory());
