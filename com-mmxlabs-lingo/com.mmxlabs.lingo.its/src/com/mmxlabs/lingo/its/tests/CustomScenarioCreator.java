...
public class CustomScenarioCreator {
	 ...
	 * @return
	 */
	public static void createCanalAndCost(final MMXRootObject scenario, final String canalName, final Port A, final Port B, final int distanceAToB, final int distanceBToA, final int canalLadenCost,
