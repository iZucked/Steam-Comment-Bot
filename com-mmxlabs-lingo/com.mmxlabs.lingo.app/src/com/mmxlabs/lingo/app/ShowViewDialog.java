...
public class ShowViewDialog extends Dialog implements ISelectionChangedListener, IDoubleClickListener {
	...
	/**
	 * Use the dialog store to restore widget values to the values that they held last time this dialog was used to completion.
	 */
	...
	/**
	 * Since OK was pressed, write widget values to the dialog store so that they will persist into the next invocation of this dialog
	 */
