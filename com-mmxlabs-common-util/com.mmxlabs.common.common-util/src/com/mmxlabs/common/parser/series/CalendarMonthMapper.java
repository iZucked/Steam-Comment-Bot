 ...
 * of months since this time. So January in the next year is 13. (according to simon the above maybe out of date, and it may now be 0???)
 * 
...
public interface CalendarMonthMapper {
	...
	int mapTimePoint(LocalDateTime ldt);
}
