...
public final class BunkersSeriesASTNode extends NamedSeriesASTNode {

	public BunkersSeriesASTNode(String name) {
		super(name);
	}
	...
	public @NonNull IExpression<@NonNull ISeries> asExpression(@NonNull SeriesParser seriesParser) {
		...
		assert seriesContainer.getType() == SeriesType.BUNKERS;
