...
public final class ConversionASTNode extends NamedSeriesASTNode {

	public ConversionASTNode(String name) {
		super(name);
	}
	...
	public @NonNull IExpression<@NonNull ISeries> asExpression(@NonNull SeriesParser seriesParser) {
		...
		assert seriesContainer.getType() == SeriesType.CONVERSION;
