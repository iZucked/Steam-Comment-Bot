...
public final class CurrencySeriesASTNode extends NamedSeriesASTNode {

	public CurrencySeriesASTNode(String name) {
		super(name);
	}
	...
	public @NonNull IExpression<@NonNull ISeries> asExpression(@NonNull SeriesParser seriesParser) {
		...
		assert seriesContainer.getType() == SeriesType.CURRENCY;
