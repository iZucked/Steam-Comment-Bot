...
public final class InterfaceRecorder {
	...
	public <T> T createRecorder(final Class<T> clz, final T object, final OutputStream os, final String lastMethod) throws Exception {
	...
	public <T> void replay(final T object, final InputStream is, final String lastMethod) throws Exception {
