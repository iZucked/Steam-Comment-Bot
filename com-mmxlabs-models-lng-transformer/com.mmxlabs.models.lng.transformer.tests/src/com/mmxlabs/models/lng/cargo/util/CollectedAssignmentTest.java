...
public class CollectedAssignmentTest {
	...
	public void testMoreComplicatedOverlappingCargoOrdering2() {
		...
		loadport.setLocation(loadlocation);

		final Location dischargelocation1 = PortFactory.eINSTANCE.createLocation();
		dischargelocation1.setTimeZone("Asia/Tokyo");
		final Port dischargeport1 = PortFactory.eINSTANCE.createPort();
		dischargeport1.setLocation(dischargelocation1);

		final Location dischargelocation2 = PortFactory.eINSTANCE.createLocation();
		dischargelocation2.setTimeZone("Europe/Paris");
		final Port dischargeport2 = PortFactory.eINSTANCE.createPort();
		dischargeport2.setLocation(dischargelocation2);
