...
public class LNGHillClimbOptimiserTransformerUnit implements ILNGStateTransformerUnit {
	...
	public LNGHillClimbOptimiserTransformerUnit(@NonNull final LNGDataTransformer dataTransformer, @NonNull OptimiserSettings settings, @NonNull final ISequences inputSequences,
		...
		try (PerChainUnitScopeImpl scope = injector.getInstance(PerChainUnitScopeImpl.class)) {
			...
			ConstrainedMoveGenerator cmg = injector.getInstance(ConstrainedMoveGenerator.class);
