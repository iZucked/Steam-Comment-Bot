...
public class LNGUnitCostGeneratorUnit implements ILNGStateTransformerUnit {

	private static final Logger LOG = LoggerFactory.getLogger(LNGUnitCostGeneratorUnit.class);
				...
				try (JobExecutor jobExecutor = jobExecutorFactory.begin()) {
					for (int i = 0; i < seeds.length; ++i) {
						...
						results.add(jobExecutor.submit(() -> {
							final LNGUnitCostGeneratorUnit t = new LNGUnitCostGeneratorUnit(dataTransformer, stage, jobId, userSettings, copyStageSettings, initialSequences.getSequences(),
	...
	public LNGUnitCostGeneratorUnit(@NonNull final LNGDataTransformer dataTransformer, @NonNull final String stage, final int jobID, @NonNull final UserSettings userSettings,
