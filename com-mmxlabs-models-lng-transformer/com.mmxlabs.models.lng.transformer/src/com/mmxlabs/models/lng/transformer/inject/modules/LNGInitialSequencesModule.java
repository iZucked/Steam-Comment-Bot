 ...
 * 
 */
public class LNGInitialSequencesModule extends AbstractModule {
	// @NonNull
	...
	private ISequences provideSequences(@Named(OptimiserConstants.SEQUENCE_TYPE_INITIAL) ISequences initialSequences) {
