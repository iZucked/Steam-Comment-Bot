...
public class BagOptimiser {
	...
	@NonNull
	protected Collection<JobState> runJobs(@NonNull final SimilarityState similarityState, final List<JobState> sortedJobStates, final JobStore jobStore, int depthStart, int depthEnd)
