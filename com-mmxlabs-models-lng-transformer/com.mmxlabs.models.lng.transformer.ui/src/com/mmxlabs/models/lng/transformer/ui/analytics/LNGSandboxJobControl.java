...
public class LNGSandboxJobControl extends AbstractEclipseJobControl {

	private final LNGSandboxJobDescriptor jobDescriptor;
...
//	private SlotInsertionOptions slotInsertionPlan;
	...
	private AbstractSolutionSet result;

	public LNGSandboxJobControl(final LNGSandboxJobDescriptor jobDescriptor) {
...
//		runner.prepare();
	...
	protected void doRunJob(final IProgressMonitor progressMonitor) {
		...
		result = jobDescriptor.run(progressMonitor);
		if (result != null) {
...
//
	...
	@Override
	public final AbstractSolutionSet getJobOutput() {
		return result;
	}
