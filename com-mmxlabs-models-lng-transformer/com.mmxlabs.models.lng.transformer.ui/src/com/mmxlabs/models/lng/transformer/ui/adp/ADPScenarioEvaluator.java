...
//		ScenarioUtils.setLSOStageIterations(optimisationPlan, 1_000);
		...
		try {
			...
			final IVesselProvider vesselProvider = bridge.getDataTransformer().getInjector().getInstance(IVesselProvider.class);
			// ISequences dtSequences = bridge.getDataTransformer().getInitialSequences();
