...
//		data = optimiserContext.getOptimisationData();
	...
	protected int step(final int percentage, @NonNull final ModifiableSequences pinnedPotentialRawSequences, @NonNull final ModifiableSequences pinnedCurrentRawSequences) {
		...
		MAIN_LOOP: for (int i = 0; i < iterationsThisStep; i++) {
			...
			acceptOrRejectMove(pinnedPotentialRawSequences, pinnedCurrentRawSequences, move, potentialFullSequences,
					evaluationState);
		}
	...
	protected void acceptOrRejectMove(final ModifiableSequences pinnedPotentialRawSequences,
			final ModifiableSequences pinnedCurrentRawSequences, final IMove move,
	...
	protected boolean evaluateOnEvaluationProcesses(final ModifiableSequences pinnedPotentialRawSequences,
			final ModifiableSequences pinnedCurrentRawSequences, final IMove move,
			final IModifiableSequences potentialFullSequences, final IEvaluationState evaluationState) {
	...
	protected boolean applyHardEvaluatedConstraintCheckers(final ModifiableSequences pinnedPotentialRawSequences,
			final ModifiableSequences pinnedCurrentRawSequences, final IMove move,
			final IModifiableSequences potentialFullSequences, final IEvaluationState evaluationState) {
	...
	protected IEvaluationState getEvaluationState(final ModifiableSequences pinnedPotentialRawSequences,
			final ModifiableSequences pinnedCurrentRawSequences, final IMove move,
	...
	protected boolean applyHardConstraints(final ModifiableSequences pinnedPotentialRawSequences,
			final ModifiableSequences pinnedCurrentRawSequences, final IMove move,
			final IModifiableSequences potentialFullSequences) {
		for (final IConstraintChecker checker : getConstraintCheckers()) {
