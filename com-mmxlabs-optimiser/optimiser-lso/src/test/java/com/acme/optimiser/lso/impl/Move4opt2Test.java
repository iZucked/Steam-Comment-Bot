...
public class Move4opt2Test {
	...
	public void testApplyOnData() {
		...
		final IModifiableSequence<Integer> sequence1 = new ListModifiableSequence<Integer>(new LinkedList<Integer>());
		final IModifiableSequence<Integer> sequence2 = new ListModifiableSequence<Integer>(new LinkedList<Integer>());
