...
public class ShellColourScheme extends ColourScheme {
	
	@Override
	public String getName() {
		return "Shell Colouring";
	}
	...
	public Color getBackground(final Object element) {
		if (element instanceof Journey) {
			...
			// TODO: get leeway in hours from memento
			
			if (ColourSchemeUtil.isJourneyTight(journey, 24)) {
				return ColorCache.getColor(Warning_Yellow);
			} else if (journey.isLaden()) {
