...
import scenario.cargo.presentation.CargoEditor;
import scenario.contract.presentation.ContractEditor;
import scenario.fleet.presentation.FleetEditor;
import scenario.market.presentation.MarketEditor;
...
import scenario.schedule.fleetallocation.presentation.FleetallocationEditor;
 ...
 * @generated
 */
public final class LngEditorAdvisor extends WorkbenchAdvisor {
	/**
	...
	private static String[] getFileExtensionFilters() {
		...
		result.addAll(FleetallocationEditor.FILE_EXTENSION_FILTERS);
		...
		result.addAll(MarketEditor.FILE_EXTENSION_FILTERS);
		result.addAll(OptimiserEditor.FILE_EXTENSION_FILTERS);
		result.addAll(LsoEditor.FILE_EXTENSION_FILTERS);
	...
	private static String getString(String key, Object s1) {
		return scenario.presentation.LngEditorPlugin.INSTANCE.getString(key, new Object [] { s1 });
	}
	...
	public static class Perspective implements IPerspectiveFactory {
		 ...
		 * @generated
		 */
		public static final String ID_PERSPECTIVE = "scenario.presentation.LngEditorAdvisorPerspective";
	...
	/**
	 * Open action for the objects from the Lng model.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * Open URI action for the objects from the Lng model.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
