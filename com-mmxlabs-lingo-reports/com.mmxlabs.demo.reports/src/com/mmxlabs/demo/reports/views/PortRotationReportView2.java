 ...
 * 
 */
public class PortRotationReportView2 extends EMFReportView {
	/**
	 * The ID of the view as specified by the extension.
	 */
	public static final String ID = "com.mmxlabs.demo.reports.views.PortRotationReportView2";

	public PortRotationReportView2() {
