...
/**
 * This is the item provider adapter for a {@link scenario.fleet.VesselStateAttributes} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VesselStateAttributesItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_VesselStateAttributes_vesselState_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_VesselStateAttributes_vesselState_feature", "_UI_VesselStateAttributes_type"),
				 FleetPackage.Literals.VESSEL_STATE_ATTRIBUTES__VESSEL_STATE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_VesselStateAttributes_nboRate_feature", "_UI_VesselStateAttributes_type"),
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_VesselStateAttributes_idleNBORate_feature", "_UI_VesselStateAttributes_type"),
	...
	/**
	 * This adds a property descriptor for the Idle Consumption Rate feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addIdleConsumptionRatePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_VesselStateAttributes_idleConsumptionRate_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_VesselStateAttributes_idleConsumptionRate_feature", "_UI_VesselStateAttributes_type"),
				 FleetPackage.Literals.VESSEL_STATE_ATTRIBUTES__IDLE_CONSUMPTION_RATE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FleetPackage.Literals.VESSEL_STATE_ATTRIBUTES__FUEL_CONSUMPTION_CURVE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FleetPackage.Literals.VESSEL_STATE_ATTRIBUTES__FUEL_CONSUMPTION_CURVE,
