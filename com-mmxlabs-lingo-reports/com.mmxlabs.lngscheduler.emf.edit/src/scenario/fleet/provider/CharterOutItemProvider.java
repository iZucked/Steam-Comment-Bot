...
public class CharterOutItemProvider
	...
	/**
	 * This adds a property descriptor for the Max Heel Out feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addMaxHeelOutPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CharterOut_maxHeelOut_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CharterOut_maxHeelOut_feature", "_UI_CharterOut_type"),
				 FleetPackage.Literals.CHARTER_OUT__MAX_HEEL_OUT,
				 true,
				 false,
				 false,
