...
public class CanalItemProvider
	 ...
	 * @generated
	 */
	public CanalItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Canal_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Canal_name_feature", "_UI_Canal_type"),
				 PortPackage.Literals.CANAL__NAME,
				 true,
				 false,
				 false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Canal"));
	}
	...
	public String getText(Object object) {
		String label = ((Canal)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Canal_type") :
			getString("_UI_Canal_type") + " " + label;
	}
