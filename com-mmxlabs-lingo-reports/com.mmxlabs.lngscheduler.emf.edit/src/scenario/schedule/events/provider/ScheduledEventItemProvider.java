...
/**
 * This is the item provider adapter for a {@link scenario.schedule.events.ScheduledEvent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ScheduledEventItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ScheduledEvent_startTime_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ScheduledEvent_startTime_feature", "_UI_ScheduledEvent_type"),
				 EventsPackage.Literals.SCHEDULED_EVENT__START_TIME,
				 true,
				 false,
				 false,
	...
	protected void addEndTimePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ScheduledEvent_endTime_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ScheduledEvent_endTime_feature", "_UI_ScheduledEvent_type"),
				 EventsPackage.Literals.SCHEDULED_EVENT__END_TIME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		Date labelValue = ((ScheduledEvent)object).getStartTime();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_ScheduledEvent_type") :
