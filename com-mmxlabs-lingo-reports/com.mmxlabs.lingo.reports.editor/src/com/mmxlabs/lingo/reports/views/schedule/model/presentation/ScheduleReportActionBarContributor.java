...
/**
 * This is the action bar contributor for the ScheduleReport model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ScheduleReportActionBarContributor
	 ...
	 * @generated
	 */
	public ScheduleReportActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("schedulereport-settings"));
		toolBarManager.add(new Separator("schedulereport-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(modelEditorPlugin.INSTANCE.getString("_UI_ScheduleReportEditor_menu"), "com.mmxlabs.lingo.reports.views.schedule.modelMenuID");
