...
public class FilterControlContribution extends ControlContribution {
	...
	private Text t;
	private List<ModifyListener> listeners = Collections.synchronizedList(new LinkedList<ModifyListener>());
	private List<KeyListener> keyListeners = Collections.synchronizedList(new LinkedList<KeyListener>());
	...
	protected int computeWidth(final Control control) {
		...
		return (int) (super.computeWidth(control) * 2);
	}
}
