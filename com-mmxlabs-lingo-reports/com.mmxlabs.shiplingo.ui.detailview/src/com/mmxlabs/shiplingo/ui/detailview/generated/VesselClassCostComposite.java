...
/**
 * A composite containing a form for editing VesselClassCost instances. The EClass hierarchy is implemented
...
public  class VesselClassCostComposite extends AbstractDetailComposite {
    ...
    composite.createEditorControl(mainGroup,
      composite.createEditor(FleetPackage.eINSTANCE.getVesselClassCost_LadenCost()),
      "Laden Cost");
  }
    ...
    composite.createEditorControl(mainGroup,
      composite.createEditor(FleetPackage.eINSTANCE.getVesselClassCost_UnladenCost()),
      "Unladen Cost");
  }
    ...
    composite.createEditorControl(mainGroup,
      composite.createEditor(FleetPackage.eINSTANCE.getVesselClassCost_TransitTime()),
      "Transit Time");
  }
    ...
    composite.createEditorControl(mainGroup,
      composite.createEditor(FleetPackage.eINSTANCE.getVesselClassCost_TransitFuel()),
      "Transit Fuel");
  }
}
