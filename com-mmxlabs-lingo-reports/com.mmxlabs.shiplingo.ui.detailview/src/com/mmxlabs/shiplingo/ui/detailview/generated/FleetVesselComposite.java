...
/**
 * A composite containing a form for editing FleetVessel instances. The EClass hierarchy is implemented by the static methods at the bottom of the class, and is not mirrored in the java class
...
public class FleetVesselComposite extends AbstractDetailComposite {
	...
	protected static void createVesselEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(FleetallocationPackage.eINSTANCE.getFleetVessel_Vessel()), "Vessel");
	}
}
