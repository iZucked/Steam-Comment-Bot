...
/**
 * A composite containing a form for editing LoadSlot instances. The EClass hierarchy is implemented by the static methods at the bottom of the class, and is not mirrored in the java class hierarchy
...
public class LoadSlotComposite extends AbstractDetailComposite {
	...
	protected static void createCargoCVvalueEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(CargoPackage.eINSTANCE.getLoadSlot_CargoCVvalue()), "Cargo CV");
	}
	...
	protected static void createArriveColdEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(CargoPackage.eINSTANCE.getLoadSlot_ArriveCold()), "Arrive Cold");
	}
}
