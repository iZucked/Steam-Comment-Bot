...
/**
 * A composite containing a form for editing ContractModel instances. The EClass hierarchy is implemented by the static methods at the bottom of the class, and is not mirrored in the java class
...
public class ContractModelComposite extends AbstractDetailComposite {
	...
	protected static void createVolumeConstraintsEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(ContractPackage.eINSTANCE.getContractModel_VolumeConstraints()), "Volume Constraints");
	}
	...
	protected static void createEntitiesEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(ContractPackage.eINSTANCE.getContractModel_Entities()), "Entities");
	}
	...
	protected static void createShippingEntityEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		final GroupEntityComposite sub = new GroupEntityComposite(composite, composite.getStyle(), "Shipping Entity", false);
	...
	protected static void createPurchaseContractsEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(ContractPackage.eINSTANCE.getContractModel_PurchaseContracts()), "Purchase Contracts");
	}
	...
	protected static void createSalesContractsEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(ContractPackage.eINSTANCE.getContractModel_SalesContracts()), "Sales Contracts");
	}
}
