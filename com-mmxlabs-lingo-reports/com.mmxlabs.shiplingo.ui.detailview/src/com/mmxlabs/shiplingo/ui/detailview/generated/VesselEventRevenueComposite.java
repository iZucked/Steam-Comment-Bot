...
/**
 * A composite containing a form for editing VesselEventRevenue instances. The EClass hierarchy is implemented by the static methods at the bottom of the class, and is not mirrored in the java class
...
public class VesselEventRevenueComposite extends AbstractDetailComposite {
	...
	protected static void createVesselEventVisitEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(SchedulePackage.eINSTANCE.getVesselEventRevenue_VesselEventVisit()), "Vessel Event Visit");
	}
}
