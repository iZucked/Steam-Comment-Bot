...
/**
 * A composite containing a form for editing NamedObject instances. The EClass hierarchy is implemented
...
public abstract class NamedObjectComposite extends AbstractDetailComposite {
    ...
    composite.createEditorControl(mainGroup,
      composite.createEditor(ScenarioPackage.eINSTANCE.getNamedObject_Name()),
      "Name");
  }
}
