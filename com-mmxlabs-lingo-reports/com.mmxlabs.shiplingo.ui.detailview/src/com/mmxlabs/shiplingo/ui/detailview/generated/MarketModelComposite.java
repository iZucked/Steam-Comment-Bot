...
/**
 * A composite containing a form for editing MarketModel instances. The EClass hierarchy is implemented by the static methods at the bottom of the class, and is not mirrored in the java class
...
public class MarketModelComposite extends AbstractDetailComposite {
	...
	protected static void createIndicesEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(MarketPackage.eINSTANCE.getMarketModel_Indices()), "Indices");
	}
}
