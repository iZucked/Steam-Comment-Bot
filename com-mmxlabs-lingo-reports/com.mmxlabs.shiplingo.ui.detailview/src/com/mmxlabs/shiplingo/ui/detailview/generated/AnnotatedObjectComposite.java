...
/**
 * A composite containing a form for editing AnnotatedObject instances. The EClass hierarchy is implemented by the static methods at the bottom of the class, and is not mirrored in the java class
...
public class AnnotatedObjectComposite extends AbstractDetailComposite {
	 ...
	 * @generated
	 */
	public AnnotatedObjectComposite(final Composite container, final int style, final String mainGroupTitle, final boolean validate) {
		super(container, style, validate);
		this.mainGroupTitle = mainGroupTitle;
	}

	public AnnotatedObjectComposite(final Composite container, final int style, final boolean validate) {
	 ...
	 * @generated
	 */
	protected static void createAnnotatedObjectFields(final AbstractDetailComposite composite, final Composite mainGroup) {
	 ...
	 */
	protected static void createNotesEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(
				mainGroup,
				new TextInlineEditor(composite.getInputPath(), ScenarioPackage.eINSTANCE.getAnnotatedObject_Notes(), composite.getEditingDomain(), composite.getCommandProcessor(), SWT.MULTI
						| SWT.BORDER | SWT.WRAP | SWT.V_SCROLL), "Notes").setLayoutData(new GridData(GridData.FILL_BOTH));
