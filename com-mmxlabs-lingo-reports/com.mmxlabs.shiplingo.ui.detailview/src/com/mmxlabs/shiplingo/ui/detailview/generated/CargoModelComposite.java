...
/**
 * A composite containing a form for editing CargoModel instances. The EClass hierarchy is implemented by the static methods at the bottom of the class, and is not mirrored in the java class hierarchy
...
public class CargoModelComposite extends AbstractDetailComposite {
	...
	protected static void createCargoesEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(CargoPackage.eINSTANCE.getCargoModel_Cargoes()), "Cargoes");
	}
	...
	protected static void createSpareDischargeSlotsEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(CargoPackage.eINSTANCE.getCargoModel_SpareDischargeSlots()), "Spare Discharge Slots");
	}
	...
	protected static void createSpareLoadSlotsEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(CargoPackage.eINSTANCE.getCargoModel_SpareLoadSlots()), "Spare Load Slots");
	}
}
