...
/**
 * A composite containing a form for editing Slot instances. The EClass hierarchy is implemented by the static methods at the bottom of the class, and is not mirrored in the java class hierarchy for
...
public class SlotComposite extends AbstractDetailComposite {
	...
	protected static void createMinQuantityEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(CargoPackage.eINSTANCE.getSlot_MinQuantity()), "Min Quantity");
	}
	...
	protected static void createMaxQuantityEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(CargoPackage.eINSTANCE.getSlot_MaxQuantity()), "Max Quantity");
	}
	...
	protected static void createPortEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(CargoPackage.eINSTANCE.getSlot_Port()), "Port");
	}
	...
	protected static void createWindowStartEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(CargoPackage.eINSTANCE.getSlot_WindowStart()), "Window Start");
	}
	...
	protected static void createWindowDurationEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(CargoPackage.eINSTANCE.getSlot_WindowDuration()), "Window (hrs)");
	}
	...
	protected static void createSlotDurationEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(CargoPackage.eINSTANCE.getSlot_SlotDuration()), "Slot Length (hrs)");
	}
	...
	protected static void createFixedPriceEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(CargoPackage.eINSTANCE.getSlot_FixedPrice()), "Fixed Price");
	}
	...
	protected static void createContractEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(CargoPackage.eINSTANCE.getSlot_Contract()), "Contract");
	}
}
