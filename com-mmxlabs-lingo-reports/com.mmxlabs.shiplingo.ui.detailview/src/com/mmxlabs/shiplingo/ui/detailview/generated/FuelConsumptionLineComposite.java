...
/**
 * A composite containing a form for editing FuelConsumptionLine instances. The EClass hierarchy is implemented by the static methods at the bottom of the class, and is not mirrored in the java class
...
public class FuelConsumptionLineComposite extends AbstractDetailComposite {
	...
	protected static void createSpeedEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(FleetPackage.eINSTANCE.getFuelConsumptionLine_Speed()), "Speed");
	}
	...
	protected static void createConsumptionEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(FleetPackage.eINSTANCE.getFuelConsumptionLine_Consumption()), "Consumption");
	}
}
