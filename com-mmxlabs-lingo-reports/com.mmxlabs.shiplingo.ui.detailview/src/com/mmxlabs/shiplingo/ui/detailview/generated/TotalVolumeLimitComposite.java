...
/**
 * A composite containing a form for editing TotalVolumeLimit instances. The EClass hierarchy is implemented by the static methods at the bottom of the class, and is not mirrored in the java class
...
public class TotalVolumeLimitComposite extends AbstractDetailComposite {
	...
	protected static void createPortsEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(ContractPackage.eINSTANCE.getTotalVolumeLimit_Ports()), "Ports");
	}
	...
	protected static void createMaximumVolumeEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(ContractPackage.eINSTANCE.getTotalVolumeLimit_MaximumVolume()), "Maximum Volume");
	}
	...
	protected static void createStartDateEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(ContractPackage.eINSTANCE.getTotalVolumeLimit_StartDate()), "Start Date");
	}
	...
	protected static void createDurationEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(ContractPackage.eINSTANCE.getTotalVolumeLimit_Duration()), "Duration");
	}
	...
	protected static void createRepeatingEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(ContractPackage.eINSTANCE.getTotalVolumeLimit_Repeating()), "Repeating");
	}
}
