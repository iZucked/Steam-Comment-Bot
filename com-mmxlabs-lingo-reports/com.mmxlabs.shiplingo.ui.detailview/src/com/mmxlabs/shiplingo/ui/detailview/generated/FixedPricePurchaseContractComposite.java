...
/**
 * A composite containing a form for editing FixedPricePurchaseContract instances. The EClass hierarchy is implemented by the static methods at the bottom of the class, and is not mirrored in the java
...
public class FixedPricePurchaseContractComposite extends AbstractDetailComposite {
	...
	protected static void createUnitPriceEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(ContractPackage.eINSTANCE.getFixedPricePurchaseContract_UnitPrice()), "Unit Price");
	}
}
