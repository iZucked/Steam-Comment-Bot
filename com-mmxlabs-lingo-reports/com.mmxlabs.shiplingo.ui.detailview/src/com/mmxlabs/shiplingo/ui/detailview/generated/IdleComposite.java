...
/**
 * A composite containing a form for editing Idle instances. The EClass hierarchy is implemented
...
public  class IdleComposite extends AbstractDetailComposite {
    ...
    composite.createEditorControl(mainGroup,
      composite.createEditor(EventsPackage.eINSTANCE.getIdle_VesselState()),
      "Vessel State");
  }
}
