...
/**
 * A composite containing a form for editing NetbackPurchaseContract instances. The EClass hierarchy is implemented
...
public  class NetbackPurchaseContractComposite extends AbstractDetailComposite {
    ...
    composite.createEditorControl(mainGroup,
      composite.createEditor(ContractPackage.eINSTANCE.getNetbackPurchaseContract_LowerBound()),
      "Lower Bound");
  }
    ...
    composite.createEditorControl(mainGroup,
      composite.createEditor(ContractPackage.eINSTANCE.getNetbackPurchaseContract_BuyersMargin()),
      "Buyers Margin");
  }
}
