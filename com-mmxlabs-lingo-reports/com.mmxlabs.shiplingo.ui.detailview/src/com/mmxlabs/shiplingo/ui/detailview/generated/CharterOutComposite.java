...
/**
 * A composite containing a form for editing CharterOut instances. The EClass hierarchy is implemented
...
public  class CharterOutComposite extends AbstractDetailComposite {
    ...
    composite.createEditorControl(mainGroup,
      composite.createEditor(FleetPackage.eINSTANCE.getCharterOut_EndPort()),
      "End Port");
  }
    ...
    composite.createEditorControl(mainGroup,
      composite.createEditor(FleetPackage.eINSTANCE.getCharterOut_DailyCharterOutPrice()),
    ...
    composite.createEditorControl(mainGroup,
      composite.createEditor(FleetPackage.eINSTANCE.getCharterOut_RepositioningFee()),
      "Repositioning Fee");
  }
}
