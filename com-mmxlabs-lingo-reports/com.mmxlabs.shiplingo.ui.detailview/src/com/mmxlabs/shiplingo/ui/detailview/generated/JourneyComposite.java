...
/**
 * A composite containing a form for editing Journey instances. The EClass hierarchy is implemented by the static methods at the bottom of the class, and is not mirrored in the java class hierarchy
...
public class JourneyComposite extends AbstractDetailComposite {
	...
	protected static void createVesselStateEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(EventsPackage.eINSTANCE.getJourney_VesselState()), "Vessel State");
	}
	...
	protected static void createRouteEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(EventsPackage.eINSTANCE.getJourney_Route()), "Route");
	}
	...
	protected static void createSpeedEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(EventsPackage.eINSTANCE.getJourney_Speed()), "Speed");
	}
	...
	protected static void createDistanceEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(EventsPackage.eINSTANCE.getJourney_Distance()), "Distance");
	}
	...
	protected static void createRouteCostEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(EventsPackage.eINSTANCE.getJourney_RouteCost()), "Route Cost");
	}
	...
	protected static void createToPortEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(EventsPackage.eINSTANCE.getJourney_ToPort()), "To Port");
	}
	...
	protected static void createFromPortEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(EventsPackage.eINSTANCE.getJourney_FromPort()), "From Port");
	}
}
