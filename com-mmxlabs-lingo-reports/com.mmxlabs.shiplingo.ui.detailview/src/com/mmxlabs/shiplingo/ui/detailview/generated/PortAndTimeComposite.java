...
/**
 * A composite containing a form for editing PortAndTime instances. The EClass hierarchy is implemented by the static methods at the bottom of the class, and is not mirrored in the java class
...
public class PortAndTimeComposite extends AbstractDetailComposite {
	...
	protected static void createStartTimeEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(FleetPackage.eINSTANCE.getPortAndTime_StartTime()), "Start Time");
	}
	...
	protected static void createEndTimeEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(FleetPackage.eINSTANCE.getPortAndTime_EndTime()), "End Time");
	}
	...
	protected static void createPortEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(FleetPackage.eINSTANCE.getPortAndTime_Port()), "Port");
	}
}
