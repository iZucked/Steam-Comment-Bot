...
/**
 * A composite containing a form for editing FuelQuantity instances. The EClass hierarchy is implemented by the static methods at the bottom of the class, and is not mirrored in the java class
...
public class FuelQuantityComposite extends AbstractDetailComposite {
	...
	protected static void createFuelTypeEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(EventsPackage.eINSTANCE.getFuelQuantity_FuelType()), "Fuel Type");
	}
	...
	protected static void createQuantityEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(EventsPackage.eINSTANCE.getFuelQuantity_Quantity()), "Quantity");
	}
	...
	protected static void createUnitPriceEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(EventsPackage.eINSTANCE.getFuelQuantity_UnitPrice()), "Unit Price");
	}
	...
	protected static void createTotalPriceEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(EventsPackage.eINSTANCE.getFuelQuantity_TotalPrice()), "Total Price");
	}
	...
	protected static void createFuelUnitEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(EventsPackage.eINSTANCE.getFuelQuantity_FuelUnit()), "Fuel Unit");
	}
	...
	protected static void createPurposeEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(EventsPackage.eINSTANCE.getFuelQuantity_Purpose()), "Purpose");
	}
}
