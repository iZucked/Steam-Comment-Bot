...
/**
 * A composite containing a form for editing VesselFuel instances. The EClass hierarchy is implemented by the static methods at the bottom of the class, and is not mirrored in the java class hierarchy
...
public class VesselFuelComposite extends AbstractDetailComposite {
	...
	protected static void createUnitPriceEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(FleetPackage.eINSTANCE.getVesselFuel_UnitPrice()), "Unit Price");
	}
	...
	protected static void createEquivalenceFactorEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(FleetPackage.eINSTANCE.getVesselFuel_EquivalenceFactor()), "Equivalence Factor");
	}
}
