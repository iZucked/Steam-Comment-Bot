...
/**
 * A composite containing a form for editing DistanceLine instances. The EClass hierarchy is implemented by the static methods at the bottom of the class, and is not mirrored in the java class
...
public class DistanceLineComposite extends AbstractDetailComposite {
	...
	protected static void createFromPortEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(PortPackage.eINSTANCE.getDistanceLine_FromPort()), "From Port");
	}
	...
	protected static void createToPortEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(PortPackage.eINSTANCE.getDistanceLine_ToPort()), "To Port");
	}
	...
	protected static void createDistanceEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(PortPackage.eINSTANCE.getDistanceLine_Distance()), "Distance");
	}
}
