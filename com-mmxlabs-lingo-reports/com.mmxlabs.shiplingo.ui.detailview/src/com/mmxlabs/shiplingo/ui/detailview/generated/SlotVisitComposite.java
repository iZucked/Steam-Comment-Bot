...
/**
 * A composite containing a form for editing SlotVisit instances. The EClass hierarchy is implemented by the static methods at the bottom of the class, and is not mirrored in the java class hierarchy
...
public class SlotVisitComposite extends AbstractDetailComposite {
	...
	protected static void createCargoAllocationEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(EventsPackage.eINSTANCE.getSlotVisit_CargoAllocation()), "Cargo Allocation");
	}
	...
	protected static void createSlotEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(EventsPackage.eINSTANCE.getSlotVisit_Slot()), "Slot");
	}
}
