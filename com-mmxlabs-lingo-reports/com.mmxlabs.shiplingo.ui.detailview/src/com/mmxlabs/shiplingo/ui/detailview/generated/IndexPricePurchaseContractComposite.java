...
/**
 * A composite containing a form for editing IndexPricePurchaseContract instances. The EClass hierarchy is implemented by the static methods at the bottom of the class, and is not mirrored in the java
...
public class IndexPricePurchaseContractComposite extends AbstractDetailComposite {
	...
	protected static void createIndexEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(ContractPackage.eINSTANCE.getIndexPricePurchaseContract_Index()), "Index");
	}
}
