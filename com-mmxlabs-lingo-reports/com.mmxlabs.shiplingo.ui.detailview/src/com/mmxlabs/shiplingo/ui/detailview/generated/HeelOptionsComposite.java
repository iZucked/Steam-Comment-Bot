...
/**
 * A composite containing a form for editing HeelOptions instances. The EClass hierarchy is implemented by the static methods at the bottom of the class, and is not mirrored in the java class
...
public class HeelOptionsComposite extends AbstractDetailComposite {
	...
	protected static void createHeelLimitEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(FleetPackage.eINSTANCE.getHeelOptions_HeelLimit()), "Heel Limit");
	}
	...
	protected static void createHeelCVValueEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(FleetPackage.eINSTANCE.getHeelOptions_HeelCVValue()), "Heel CVValue");
	}
	...
	protected static void createHeelUnitPriceEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(FleetPackage.eINSTANCE.getHeelOptions_HeelUnitPrice()), "Heel Unit Price");
	}
}
