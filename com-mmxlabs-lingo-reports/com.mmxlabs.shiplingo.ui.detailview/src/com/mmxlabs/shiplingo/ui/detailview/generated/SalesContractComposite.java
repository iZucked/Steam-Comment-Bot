...
/**
 * A composite containing a form for editing SalesContract instances. The EClass hierarchy is implemented by the static methods at the bottom of the class, and is not mirrored in the java class
...
public class SalesContractComposite extends AbstractDetailComposite {
	...
	protected static void createMarkupEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(ContractPackage.eINSTANCE.getSalesContract_Markup()), "Markup");
	}
	...
	protected static void createIndexEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(ContractPackage.eINSTANCE.getSalesContract_Index()), "Index");
	}
}
