...
/**
 * A composite containing a form for editing Discount instances. The EClass hierarchy is implemented
...
public  class DiscountComposite extends AbstractDetailComposite {
    ...
    composite.createEditorControl(mainGroup,
      composite.createEditor(OptimiserPackage.eINSTANCE.getDiscount_Time()),
      "Time");
  }
    ...
    composite.createEditorControl(mainGroup,
      composite.createEditor(OptimiserPackage.eINSTANCE.getDiscount_DiscountFactor()),
      "Discount Factor");
  }
}
