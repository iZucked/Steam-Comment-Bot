...
/**
 * A composite containing a form for editing ThresholderSettings instances. The EClass hierarchy is implemented by the static methods at the bottom of the class, and is not mirrored in the java class
...
public class ThresholderSettingsComposite extends AbstractDetailComposite {
	...
	protected static void createAlphaEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(LsoPackage.eINSTANCE.getThresholderSettings_Alpha()), "Alpha");
	}
	...
	protected static void createInitialAcceptanceRateEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(LsoPackage.eINSTANCE.getThresholderSettings_InitialAcceptanceRate()), "Initial Acceptance Rate");
	}
	...
	protected static void createEpochLengthEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(LsoPackage.eINSTANCE.getThresholderSettings_EpochLength()), "Epoch Length");
	}
}
