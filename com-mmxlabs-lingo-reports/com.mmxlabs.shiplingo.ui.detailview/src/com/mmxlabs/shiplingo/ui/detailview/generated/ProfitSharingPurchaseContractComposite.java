...
/**
 * A composite containing a form for editing ProfitSharingPurchaseContract instances. The EClass hierarchy is implemented by the static methods at the bottom of the class, and is not mirrored in the
...
public class ProfitSharingPurchaseContractComposite extends AbstractDetailComposite {
	...
	protected static void createAlphaEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(ContractPackage.eINSTANCE.getProfitSharingPurchaseContract_Alpha()), "Alpha");
	}
	...
	protected static void createBetaEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(ContractPackage.eINSTANCE.getProfitSharingPurchaseContract_Beta()), "Beta");
	}
	...
	protected static void createGammaEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(ContractPackage.eINSTANCE.getProfitSharingPurchaseContract_Gamma()), "Gamma");
	}
	...
	protected static void createIndexEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(ContractPackage.eINSTANCE.getProfitSharingPurchaseContract_Index()), "Index");
	}
	...
	protected static void createReferenceIndexEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(ContractPackage.eINSTANCE.getProfitSharingPurchaseContract_ReferenceIndex()), "Reference Index");
	}
}
