...
/**
 * A composite containing a form for editing CargoRevenue instances. The EClass hierarchy is implemented by the static methods at the bottom of the class, and is not mirrored in the java class
...
public class CargoRevenueComposite extends AbstractDetailComposite {
	...
	protected static void createCargoEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(SchedulePackage.eINSTANCE.getCargoRevenue_Cargo()), "Cargo");
	}
}
