...
/**
 * A composite containing a form for editing VesselEventVisit instances. The EClass hierarchy is implemented by the static methods at the bottom of the class, and is not mirrored in the java class
...
public class VesselEventVisitComposite extends AbstractDetailComposite {
	...
	protected static void createVesselEventEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(EventsPackage.eINSTANCE.getVesselEventVisit_VesselEvent()), "Vessel Event");
	}
	...
	protected static void createRevenueEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(EventsPackage.eINSTANCE.getVesselEventVisit_Revenue()), "Revenue");
	}
}
