...
/**
 * A composite containing a form for editing VesselStateAttributes instances. The EClass hierarchy is implemented
...
public  class VesselStateAttributesComposite extends AbstractDetailComposite {
    ...
    composite.createEditorControl(mainGroup,
      composite.createEditor(FleetPackage.eINSTANCE.getVesselStateAttributes_NboRate()),
      "NBO Rate");
  }
    ...
    composite.createEditorControl(mainGroup,
      composite.createEditor(FleetPackage.eINSTANCE.getVesselStateAttributes_IdleNBORate()),
      "Idle NBO Rate");
  }
    ...
    composite.createEditorControl(mainGroup,
    		new FuelCurveEditor(composite.getInputPath(), FleetPackage.eINSTANCE.getVesselStateAttributes_FuelConsumptionCurve(), composite.getEditingDomain(), composite.getCommandProcessor()),
