...
/**
 * A composite containing a form for editing SimplePurchaseContract instances. The EClass hierarchy is implemented by the static methods at the bottom of the class, and is not mirrored in the java
...
public abstract class SimplePurchaseContractComposite extends AbstractDetailComposite {
	...
	protected static void createCooldownPortsEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(ContractPackage.eINSTANCE.getSimplePurchaseContract_CooldownPorts()), "Cooldown Ports");
	}
}
