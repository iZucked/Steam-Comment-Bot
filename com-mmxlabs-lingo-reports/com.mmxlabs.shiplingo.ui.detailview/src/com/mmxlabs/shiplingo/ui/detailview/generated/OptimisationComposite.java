...
/**
 * A composite containing a form for editing Optimisation instances. The EClass hierarchy is implemented by the static methods at the bottom of the class, and is not mirrored in the java class
...
public class OptimisationComposite extends AbstractDetailComposite {
	...
	protected static void createAllSettingsEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(OptimiserPackage.eINSTANCE.getOptimisation_AllSettings()), "All Settings");
	}
	...
	protected static void createCurrentSettingsEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(OptimiserPackage.eINSTANCE.getOptimisation_CurrentSettings()), "Current Settings");
	}
}
