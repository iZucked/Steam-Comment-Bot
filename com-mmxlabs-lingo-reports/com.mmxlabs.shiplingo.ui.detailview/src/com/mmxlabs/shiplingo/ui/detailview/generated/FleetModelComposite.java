...
/**
 * A composite containing a form for editing FleetModel instances. The EClass hierarchy is implemented by the static methods at the bottom of the class, and is not mirrored in the java class hierarchy
...
public class FleetModelComposite extends AbstractDetailComposite {
	...
	protected static void createFleetEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(FleetPackage.eINSTANCE.getFleetModel_Fleet()), "Fleet");
	}
	...
	protected static void createVesselClassesEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(FleetPackage.eINSTANCE.getFleetModel_VesselClasses()), "Vessel Classes");
	}
	...
	protected static void createVesselEventsEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(FleetPackage.eINSTANCE.getFleetModel_VesselEvents()), "Vessel Events");
	}
	...
	protected static void createFuelsEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(FleetPackage.eINSTANCE.getFleetModel_Fuels()), "Fuels");
	}
}
