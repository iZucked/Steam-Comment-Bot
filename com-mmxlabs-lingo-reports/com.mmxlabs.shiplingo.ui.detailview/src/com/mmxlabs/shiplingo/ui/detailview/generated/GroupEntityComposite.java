...
/**
 * A composite containing a form for editing GroupEntity instances. The EClass hierarchy is implemented
...
public  class GroupEntityComposite extends AbstractDetailComposite {
    ...
    composite.createEditorControl(mainGroup,
      composite.createEditor(ContractPackage.eINSTANCE.getGroupEntity_TaxRate()),
      "Tax Rate");
  }
    ...
    composite.createEditorControl(mainGroup,
      composite.createEditor(ContractPackage.eINSTANCE.getGroupEntity_Ownership()),
      "Ownership");
  }
    ...
    composite.createEditorControl(mainGroup,
      composite.createEditor(ContractPackage.eINSTANCE.getGroupEntity_TransferOffset()),
      "Transfer Offset");
  }
}
