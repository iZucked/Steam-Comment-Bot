...
/**
 * A composite containing a form for editing Scenario instances. The EClass hierarchy is implemented by the static methods at the bottom of the class, and is not mirrored in the java class hierarchy
...
public class ScenarioComposite extends AbstractDetailComposite {
	...
	protected static void createVersionEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(ScenarioPackage.eINSTANCE.getScenario_Version()), "Version");
	}
	...
	protected static void createNameEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(ScenarioPackage.eINSTANCE.getScenario_Name()), "Name");
	}
	...
	protected static void createFleetModelEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		final FleetModelComposite sub = new FleetModelComposite(composite, composite.getStyle(), "Fleet Model", false);
	...
	protected static void createScheduleModelEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		final ScheduleModelComposite sub = new ScheduleModelComposite(composite, composite.getStyle(), "Schedule Model", false);
		sub.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true));
	...
	protected static void createPortModelEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(ScenarioPackage.eINSTANCE.getScenario_PortModel()), "Port Model");
	}
	...
	protected static void createDistanceModelEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(ScenarioPackage.eINSTANCE.getScenario_DistanceModel()), "Distance Model");
	}
	...
	protected static void createCanalModelEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(ScenarioPackage.eINSTANCE.getScenario_CanalModel()), "Canal Model");
	}
	...
	protected static void createCargoModelEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		final CargoModelComposite sub = new CargoModelComposite(composite, composite.getStyle(), "Cargo Model", false);
		sub.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true));
	...
	protected static void createContractModelEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		final ContractModelComposite sub = new ContractModelComposite(composite, composite.getStyle(), "Contract Model", false);
		sub.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true));
	...
	protected static void createMarketModelEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		final MarketModelComposite sub = new MarketModelComposite(composite, composite.getStyle(), "Market Model", false);
		sub.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true));
	...
	protected static void createOptimisationEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		final OptimisationComposite sub = new OptimisationComposite(composite, composite.getStyle(), "Optimisation", false);
		sub.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true));
	...
	protected static void createContainedModelsEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(ScenarioPackage.eINSTANCE.getScenario_ContainedModels()), "Contained Models");
	}
}
