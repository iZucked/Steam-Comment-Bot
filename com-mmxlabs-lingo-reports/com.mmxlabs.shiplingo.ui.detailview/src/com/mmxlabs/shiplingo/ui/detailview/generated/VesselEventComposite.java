...
/**
 * A composite containing a form for editing VesselEvent instances. The EClass hierarchy is implemented by the static methods at the bottom of the class, and is not mirrored in the java class
...
public abstract class VesselEventComposite extends AbstractDetailComposite {
	...
	protected static void createIdEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(FleetPackage.eINSTANCE.getVesselEvent_Id()), "Id");
	}
	...
	protected static void createStartDateEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(FleetPackage.eINSTANCE.getVesselEvent_StartDate()), "Start Date");
	}
	...
	protected static void createEndDateEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(FleetPackage.eINSTANCE.getVesselEvent_EndDate()), "End Date");
	}
	...
	protected static void createDurationEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(FleetPackage.eINSTANCE.getVesselEvent_Duration()), "Duration (days)");
	}
	...
	protected static void createVesselsEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(FleetPackage.eINSTANCE.getVesselEvent_Vessels()), "Vessels");
	}
	...
	protected static void createVesselClassesEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(FleetPackage.eINSTANCE.getVesselEvent_VesselClasses()), "Vessel Classes");
	}
	...
	protected static void createStartPortEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(FleetPackage.eINSTANCE.getVesselEvent_StartPort()), "Start Port");
	}
}
