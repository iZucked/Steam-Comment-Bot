...
/**
 * A composite containing a form for editing StepwisePriceCurve instances. The EClass hierarchy is implemented by the static methods at the bottom of the class, and is not mirrored in the java class
...
public class StepwisePriceCurveComposite extends AbstractDetailComposite {
	...
	protected static void createDefaultValueEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(MarketPackage.eINSTANCE.getStepwisePriceCurve_DefaultValue()), "Default Value");
	}
	...
	protected static void createPricesEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(MarketPackage.eINSTANCE.getStepwisePriceCurve_Prices()), "Prices");
	}
}
