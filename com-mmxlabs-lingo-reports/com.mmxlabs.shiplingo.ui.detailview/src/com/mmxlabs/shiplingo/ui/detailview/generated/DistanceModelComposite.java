...
/**
 * A composite containing a form for editing DistanceModel instances. The EClass hierarchy is implemented by the static methods at the bottom of the class, and is not mirrored in the java class
...
public class DistanceModelComposite extends AbstractDetailComposite {
	...
	protected static void createDistancesEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(PortPackage.eINSTANCE.getDistanceModel_Distances()), "Distances");
	}
}
