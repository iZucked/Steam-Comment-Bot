...
/**
 * A composite containing a form for editing FuelMixture instances. The EClass hierarchy is implemented by the static methods at the bottom of the class, and is not mirrored in the java class
...
public class FuelMixtureComposite extends AbstractDetailComposite {
	...
	protected static void createFuelUsageEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(EventsPackage.eINSTANCE.getFuelMixture_FuelUsage()), "Fuel Usage");
	}
}
