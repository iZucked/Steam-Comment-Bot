...
/**
 * A composite containing a form for editing BookedRevenue instances. The EClass hierarchy is implemented by the static methods at the bottom of the class, and is not mirrored in the java class
...
public class BookedRevenueComposite extends AbstractDetailComposite {
	...
	protected static void createDateEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(SchedulePackage.eINSTANCE.getBookedRevenue_Date()), "Date");
	}
	...
	protected static void createEntityEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(SchedulePackage.eINSTANCE.getBookedRevenue_Entity()), "Entity");
	}
	...
	protected static void createValueEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(SchedulePackage.eINSTANCE.getBookedRevenue_Value()), "Value");
	}
	...
	protected static void createDetailsEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		final DetailComposite sub = new DetailComposite(composite, composite.getStyle(), "Details", false);
