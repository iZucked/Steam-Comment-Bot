...
public abstract class PortSelectionComposite extends AbstractDetailComposite {
	...
	public PortSelectionComposite(final Composite container, final int style, final boolean validate) {
		this(container, style, "Port Selection", validate);
	}

	public PortSelectionComposite(final Composite container, final int style) {
		this(container, style, "Port Selection", true);
	}
	...
	protected static void createFields(final AbstractDetailComposite composite, final Composite mainGroup) {
		...
		createPortSelectionFields(composite, mainGroup);
	}
