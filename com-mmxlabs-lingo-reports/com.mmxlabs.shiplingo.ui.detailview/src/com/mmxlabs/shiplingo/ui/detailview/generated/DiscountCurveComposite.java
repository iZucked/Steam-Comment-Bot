...
/**
 * A composite containing a form for editing DiscountCurve instances. The EClass hierarchy is implemented by the static methods at the bottom of the class, and is not mirrored in the java class
...
public class DiscountCurveComposite extends AbstractDetailComposite {
	...
	protected static void createStartDateEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(OptimiserPackage.eINSTANCE.getDiscountCurve_StartDate()), "Start Date");
	}
	...
	protected static void createDiscountsEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(OptimiserPackage.eINSTANCE.getDiscountCurve_Discounts()), "Discounts");
	}
}
