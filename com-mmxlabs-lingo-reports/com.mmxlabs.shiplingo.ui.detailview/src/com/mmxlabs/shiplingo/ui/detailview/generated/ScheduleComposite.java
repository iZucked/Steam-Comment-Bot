...
/**
 * A composite containing a form for editing Schedule instances. The EClass hierarchy is implemented by the static methods at the bottom of the class, and is not mirrored in the java class hierarchy
...
public class ScheduleComposite extends AbstractDetailComposite {
	...
	protected static void createNameEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(SchedulePackage.eINSTANCE.getSchedule_Name()), "Name");
	}
	...
	protected static void createSequencesEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(SchedulePackage.eINSTANCE.getSchedule_Sequences()), "Sequences");
	}
	...
	protected static void createCargoAllocationsEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(SchedulePackage.eINSTANCE.getSchedule_CargoAllocations()), "Cargo Allocations");
	}
	...
	protected static void createFitnessEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(SchedulePackage.eINSTANCE.getSchedule_Fitness()), "Fitness");
	}
	...
	protected static void createRevenueEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(SchedulePackage.eINSTANCE.getSchedule_Revenue()), "Revenue");
	}
	...
	protected static void createFleetEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(SchedulePackage.eINSTANCE.getSchedule_Fleet()), "Fleet");
	}
}
