...
/**
 * A composite containing a form for editing PortVisit instances. The EClass hierarchy is implemented by the static methods at the bottom of the class, and is not mirrored in the java class hierarchy
...
public class PortVisitComposite extends AbstractDetailComposite {
	...
	protected static void createPortEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(EventsPackage.eINSTANCE.getPortVisit_Port()), "Port");
	}
}
