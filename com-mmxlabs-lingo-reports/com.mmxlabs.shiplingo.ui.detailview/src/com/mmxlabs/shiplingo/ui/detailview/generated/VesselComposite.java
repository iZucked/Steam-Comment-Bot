...
/**
 * A composite containing a form for editing Vessel instances. The EClass hierarchy is implemented
...
//      AnnotatedObjectComposite.createFields(composite, mainGroup);
    ...
    composite.createEditorControl(mainGroup,
      composite.createEditor(FleetPackage.eINSTANCE.getVessel_TimeChartered()),
      "Time Chartered");
  }
    ...
    composite.createEditorControl(mainGroup,
      composite.createEditor(FleetPackage.eINSTANCE.getVessel_DailyCharterOutPrice()),
    ...
    composite.createEditorControl(mainGroup,
      composite.createEditor(FleetPackage.eINSTANCE.getVessel_Class()),
      "Class");
  }
