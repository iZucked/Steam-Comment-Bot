...
/**
 * A composite containing a form for editing Constraint instances. The EClass hierarchy is implemented by the static methods at the bottom of the class, and is not mirrored in the java class hierarchy
...
public class ConstraintComposite extends AbstractDetailComposite {
	...
	protected static void createEnabledEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(OptimiserPackage.eINSTANCE.getConstraint_Enabled()), "Enabled");
	}
}
