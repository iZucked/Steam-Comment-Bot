...
/**
 * A composite containing a form for editing CargoAllocation instances. The EClass hierarchy is implemented by the static methods at the bottom of the class, and is not mirrored in the java class
...
public class CargoAllocationComposite extends AbstractDetailComposite {
	...
	protected static void createFuelVolumeEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(SchedulePackage.eINSTANCE.getCargoAllocation_FuelVolume()), "Fuel Volume");
	}
	...
	protected static void createDischargeVolumeEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(SchedulePackage.eINSTANCE.getCargoAllocation_DischargeVolume()), "Discharge Volume");
	}
	...
	protected static void createLoadDateEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(SchedulePackage.eINSTANCE.getCargoAllocation_LoadDate()), "Load Date");
	}
	...
	protected static void createDischargeDateEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(SchedulePackage.eINSTANCE.getCargoAllocation_DischargeDate()), "Discharge Date");
	}
	...
	protected static void createLoadPriceM3Editor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(SchedulePackage.eINSTANCE.getCargoAllocation_LoadPriceM3()), "Load Price M3");
	}
	...
	protected static void createDischargePriceM3Editor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(SchedulePackage.eINSTANCE.getCargoAllocation_DischargePriceM3()), "Discharge Price M3");
	}
	...
	protected static void createLoadRevenueEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(SchedulePackage.eINSTANCE.getCargoAllocation_LoadRevenue()), "Load Revenue");
	}
	...
	protected static void createShippingRevenueEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(SchedulePackage.eINSTANCE.getCargoAllocation_ShippingRevenue()), "Shipping Revenue");
	}
	...
	protected static void createDischargeRevenueEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(SchedulePackage.eINSTANCE.getCargoAllocation_DischargeRevenue()), "Discharge Revenue");
	}
	...
	protected static void createLadenLegEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(SchedulePackage.eINSTANCE.getCargoAllocation_LadenLeg()), "Laden Leg");
	}
	...
	protected static void createBallastLegEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(SchedulePackage.eINSTANCE.getCargoAllocation_BallastLeg()), "Ballast Leg");
	}
	...
	protected static void createLadenIdleEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(SchedulePackage.eINSTANCE.getCargoAllocation_LadenIdle()), "Laden Idle");
	}
	...
	protected static void createBallastIdleEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(SchedulePackage.eINSTANCE.getCargoAllocation_BallastIdle()), "Ballast Idle");
	}
	...
	protected static void createLoadSlotVisitEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(SchedulePackage.eINSTANCE.getCargoAllocation_LoadSlotVisit()), "Load Slot Visit");
	}
	...
	protected static void createDischargeSlotVisitEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(SchedulePackage.eINSTANCE.getCargoAllocation_DischargeSlotVisit()), "Discharge Slot Visit");
	}
	...
	protected static void createVesselEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(SchedulePackage.eINSTANCE.getCargoAllocation_Vessel()), "Vessel");
	}
	...
	protected static void createDischargeSlotEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(SchedulePackage.eINSTANCE.getCargoAllocation_DischargeSlot()), "Discharge Slot");
	}
	...
	protected static void createLoadSlotEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(SchedulePackage.eINSTANCE.getCargoAllocation_LoadSlot()), "Load Slot");
	}
	...
	protected static void createCargoTypeEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(SchedulePackage.eINSTANCE.getCargoAllocation_CargoType()), "Cargo Type");
	}
}
