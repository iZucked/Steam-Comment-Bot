...
/**
 * A composite containing a form for editing LSOSettings instances. The EClass hierarchy is implemented by the static methods at the bottom of the class, and is not mirrored in the java class
...
public class LSOSettingsComposite extends AbstractDetailComposite {
	...
	protected static void createNumberOfStepsEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(LsoPackage.eINSTANCE.getLSOSettings_NumberOfSteps()), "Number Of Steps");
	}
	...
	protected static void createThresholderSettingsEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		final ThresholderSettingsComposite sub = new ThresholderSettingsComposite(composite, composite.getStyle(), "Thresholder Settings", false);
	...
	protected static void createMoveGeneratorSettingsEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		final MoveGeneratorSettingsComposite sub = new MoveGeneratorSettingsComposite(composite, composite.getStyle(), "Move Generator Settings", false);
		sub.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true));
