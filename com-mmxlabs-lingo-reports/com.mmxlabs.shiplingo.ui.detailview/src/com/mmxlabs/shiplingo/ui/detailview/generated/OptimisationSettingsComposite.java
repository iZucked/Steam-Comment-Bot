...
/**
 * A composite containing a form for editing OptimisationSettings instances. The EClass hierarchy is implemented by the static methods at the bottom of the class, and is not mirrored in the java class
...
public class OptimisationSettingsComposite extends AbstractDetailComposite {
	...
	protected static void createRandomSeedEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(OptimiserPackage.eINSTANCE.getOptimisationSettings_RandomSeed()), "Random Seed");
	}
	...
	protected static void createInitialScheduleEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(OptimiserPackage.eINSTANCE.getOptimisationSettings_InitialSchedule()), "Initial Schedule");
	}
	...
	protected static void createFreezeDaysFromStartEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(OptimiserPackage.eINSTANCE.getOptimisationSettings_FreezeDaysFromStart()), "Freeze Days From Start");
	}
	...
	protected static void createIgnoreElementsAfterEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(OptimiserPackage.eINSTANCE.getOptimisationSettings_IgnoreElementsAfter()), "Ignore Elements After");
	}
	...
	protected static void createConstraintsEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(OptimiserPackage.eINSTANCE.getOptimisationSettings_Constraints()), "Constraints");
	}
	...
	protected static void createObjectivesEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(OptimiserPackage.eINSTANCE.getOptimisationSettings_Objectives()), "Objectives");
	}
	...
	protected static void createDefaultDiscountCurveEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		final DiscountCurveComposite sub = new DiscountCurveComposite(composite, composite.getStyle(), "Default Discount Curve", false);
	...
	protected static void createAllowRewiringByDefaultEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(OptimiserPackage.eINSTANCE.getOptimisationSettings_AllowRewiringByDefault()), "Allow Rewiring By Default");
	}
}
