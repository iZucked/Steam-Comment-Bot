...
/**
 * A composite containing a form for editing Objective instances. The EClass hierarchy is implemented by the static methods at the bottom of the class, and is not mirrored in the java class hierarchy
...
public class ObjectiveComposite extends AbstractDetailComposite {
	...
	protected static void createWeightEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		composite.createEditorControl(mainGroup, composite.createEditor(OptimiserPackage.eINSTANCE.getObjective_Weight()), "Weight");
	}
	...
	protected static void createDiscountCurveEditor(final AbstractDetailComposite composite, final Composite mainGroup) {
		final DiscountCurveComposite sub = new DiscountCurveComposite(composite, composite.getStyle(), "Discount Curve", false);
