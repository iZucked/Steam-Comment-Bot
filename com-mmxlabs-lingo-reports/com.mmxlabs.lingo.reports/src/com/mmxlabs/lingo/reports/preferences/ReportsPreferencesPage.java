...
public class ReportsPreferencesPage
	...
	public ReportsPreferencesPage() {
		...
		setDescription("Enter the leeway value (in days) for tight journeys. If a vessel travelling at service speed could not complete a particular journey in the allocated time (taking idle time into account) with that many days to spare, it is considered 'tight'.");
	}
