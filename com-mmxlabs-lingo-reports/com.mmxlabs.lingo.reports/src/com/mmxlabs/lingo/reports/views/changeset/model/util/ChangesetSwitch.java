...
public class ChangesetSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ChangesetPackage.CHANGE_SET_ROOT: {
				ChangeSetRoot changeSetRoot = (ChangeSetRoot)theEObject;
				T result = caseChangeSetRoot(changeSetRoot);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ChangesetPackage.CHANGE_SET: {
				ChangeSet changeSet = (ChangeSet)theEObject;
				T result = caseChangeSet(changeSet);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ChangesetPackage.METRICS: {
				Metrics metrics = (Metrics)theEObject;
				T result = caseMetrics(metrics);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ChangesetPackage.DELTA_METRICS: {
				DeltaMetrics deltaMetrics = (DeltaMetrics)theEObject;
				T result = caseDeltaMetrics(deltaMetrics);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Change Set Root</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Change Set Root</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseChangeSetRoot(ChangeSetRoot object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Delta Metrics</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Delta Metrics</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDeltaMetrics(DeltaMetrics object) {
		return null;
	}
