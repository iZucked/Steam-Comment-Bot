		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RowGroup_rows_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RowGroup_rows_feature", "_UI_RowGroup_type"),
				 ScheduleReportPackage.Literals.ROW_GROUP__ROWS,
				 true,
				 false,
				 true,
				 null,
