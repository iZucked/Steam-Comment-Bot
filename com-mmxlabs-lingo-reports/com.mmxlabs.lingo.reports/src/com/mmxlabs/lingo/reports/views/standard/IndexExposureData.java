...
public class IndexExposureData {
	...
	public IndexExposureData(ScenarioResult scenarioResult, final Schedule schedule, final String name, final NamedIndexContainer<?> index, final @NonNull Map<YearMonth, Double> exposuresByMonth,
