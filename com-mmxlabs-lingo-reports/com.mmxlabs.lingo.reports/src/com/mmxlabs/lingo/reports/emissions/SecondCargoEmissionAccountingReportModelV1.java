 ...
 */
@SchemaVersion(1)
public class SecondCargoEmissionAccountingReportModelV1{
	...
	public Double liquefaction;
	
	@ColumnName("Shipping CF, kg")
	...
	public static void main(String args[]) throws Exception {
		...
		String json = gen.generateHubSchema(SecondCargoEmissionAccountingReportModelV1.class, Mode.FULL);
