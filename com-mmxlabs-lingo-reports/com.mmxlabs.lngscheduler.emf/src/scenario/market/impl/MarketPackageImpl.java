...
public class MarketPackageImpl extends EPackageImpl implements MarketPackage {
	 ...
	 * 
	 * <p>
	 * This method is used to initialize {@link MarketPackage#eINSTANCE} when that field is accessed. Clients should not invoke it directly. Instead, they should simply access that field to obtain the
	...
	public static MarketPackage init() {
		if (isInited) {
			return (MarketPackage) EPackage.Registry.INSTANCE.getEPackage(MarketPackage.eNS_URI);
		}

		// Obtain or create and register package
		final MarketPackageImpl theMarketPackage = (MarketPackageImpl) (EPackage.Registry.INSTANCE.get(eNS_URI) instanceof MarketPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI)
				: new MarketPackageImpl());
	...
	public void initializePackageContents() {
		...
		initEReference(getIndex_PriceCurve(), this.getStepwisePriceCurve(), null, "priceCurve", null, 1, 1, Index.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(marketModelEClass, MarketModel.class, "MarketModel", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getMarketModel_Indices(), this.getIndex(), null, "indices", null, 0, -1, MarketModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getStepwisePriceCurve_DefaultValue(), ecorePackage.getEFloat(), "defaultValue", null, 0, 1, StepwisePriceCurve.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getStepwisePriceCurve_Prices(), this.getStepwisePrice(), null, "prices", null, 0, -1, StepwisePriceCurve.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		final EOperation op = initEOperation(getStepwisePriceCurve__GetValueAtDate__Date(), ecorePackage.getEFloat(), "getValueAtDate", 1, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEAttribute(getStepwisePrice_Date(), ecorePackage.getEDate(), "date", null, 1, 1, StepwisePrice.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getStepwisePrice_PriceFromDate(), ecorePackage.getEFloat(), "priceFromDate", null, 1, 1, StepwisePrice.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
