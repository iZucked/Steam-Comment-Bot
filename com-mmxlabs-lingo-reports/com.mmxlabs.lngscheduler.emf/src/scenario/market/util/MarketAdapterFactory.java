...
public class MarketAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected MarketSwitch<Adapter> modelSwitch = new MarketSwitch<Adapter>() {
		@Override
		...
		@Override
		public Adapter caseMarketModel(final MarketModel object) {
			return createMarketModelAdapter();
		}

		@Override
		public Adapter caseStepwisePriceCurve(final StepwisePriceCurve object) {
			return createStepwisePriceCurveAdapter();
		}

		@Override
		public Adapter caseStepwisePrice(final StepwisePrice object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link scenario.market.Index <em>Index</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can easily ignore cases;
	...
	/**
	 * Creates a new adapter for an object of class '{@link scenario.market.MarketModel <em>Model</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can easily ignore
	...
	/**
	 * Creates a new adapter for an object of class '{@link scenario.market.StepwisePriceCurve <em>Stepwise Price Curve</em>}'. <!-- begin-user-doc --> This default implementation returns null so that
	...
	/**
	 * Creates a new adapter for an object of class '{@link scenario.market.StepwisePrice <em>Stepwise Price</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can
