...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Stepwise Price Curve</b></em>'. <!-- end-user-doc -->
 * 
 * <p>
...
public interface StepwisePriceCurve extends EObject {
	/**
	 * Returns the value of the '<em><b>Prices</b></em>' containment reference list. The list contents are of type {@link scenario.market.StepwisePrice}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Prices</em>' containment reference list isn't clear, there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link scenario.market.StepwisePriceCurve#getDefaultValue <em>Default Value</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
