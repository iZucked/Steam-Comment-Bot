...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Vessel State Attributes</b></em>'. <!-- end-user-doc -->
 * 
 * <p>
...
public interface VesselStateAttributes extends EObject {
	...
	/**
	 * Sets the value of the '{@link scenario.fleet.VesselStateAttributes#getVesselState <em>Vessel State</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	...
	/**
	 * Returns the value of the '<em><b>Nbo Rate</b></em>' attribute. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Nbo Rate</em>' attribute isn't clear, there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link scenario.fleet.VesselStateAttributes#getNboRate <em>Nbo Rate</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Nbo Rate</em>' attribute.
	 * @see #getNboRate()
	 * @generated
	 */
	...
	/**
	 * Returns the value of the '<em><b>Idle NBO Rate</b></em>' attribute. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Idle NBO Rate</em>' attribute isn't clear, there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link scenario.fleet.VesselStateAttributes#getIdleNBORate <em>Idle NBO Rate</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Idle NBO Rate</em>' attribute.
	 * @see #getIdleNBORate()
	 * @generated
	 */
	...
	/**
	 * Returns the value of the '<em><b>Idle Consumption Rate</b></em>' attribute. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Idle Consumption Rate</em>' attribute isn't clear, there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link scenario.fleet.VesselStateAttributes#getIdleConsumptionRate <em>Idle Consumption Rate</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Idle Consumption Rate</em>' attribute.
	...
	/**
	 * Returns the value of the '<em><b>Fuel Consumption Curve</b></em>' containment reference list. The list contents are of type {@link scenario.fleet.FuelConsumptionLine}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Fuel Consumption Curve</em>' containment reference list isn't clear, there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
