...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Port Exclusion</b></em>'. <!-- end-user-doc -->
 * 
 * <p>
...
public interface PortExclusion extends ScenarioObject {
	...
	/**
	 * Sets the value of the '{@link scenario.fleet.PortExclusion#getPort <em>Port</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	...
	/**
	 * Sets the value of the '{@link scenario.fleet.PortExclusion#getStartDate <em>Start Date</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	...
	/**
	 * Unsets the value of the '{@link scenario.fleet.PortExclusion#getStartDate <em>Start Date</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isSetStartDate()
	 * @see #getStartDate()
	 * @see #setStartDate(Date)
	...
	/**
	 * Returns whether the value of the '{@link scenario.fleet.PortExclusion#getStartDate <em>Start Date</em>}' attribute is set. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link scenario.fleet.PortExclusion#getEndDate <em>End Date</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	...
	/**
	 * Unsets the value of the '{@link scenario.fleet.PortExclusion#getEndDate <em>End Date</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isSetEndDate()
	 * @see #getEndDate()
	 * @see #setEndDate(Date)
	...
	/**
	 * Returns whether the value of the '{@link scenario.fleet.PortExclusion#getEndDate <em>End Date</em>}' attribute is set. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
