...
public interface PortAndTime extends EObject {
	...
	/**
	 * Sets the value of the '{@link scenario.fleet.PortAndTime#getPort <em>Port</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	...
	/**
	 * Unsets the value of the '{@link scenario.fleet.PortAndTime#getPort <em>Port</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isSetPort()
	 * @see #getPort()
	 * @see #setPort(Port)
	...
	/**
	 * Returns whether the value of the '{@link scenario.fleet.PortAndTime#getPort <em>Port</em>}' reference is set. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link scenario.fleet.PortAndTime#getStartTime <em>Start Time</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	...
	/**
	 * Unsets the value of the '{@link scenario.fleet.PortAndTime#getStartTime <em>Start Time</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isSetStartTime()
	 * @see #getStartTime()
	 * @see #setStartTime(Date)
	...
	/**
	 * Returns whether the value of the '{@link scenario.fleet.PortAndTime#getStartTime <em>Start Time</em>}' attribute is set. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link scenario.fleet.PortAndTime#getEndTime <em>End Time</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	...
	/**
	 * Unsets the value of the '{@link scenario.fleet.PortAndTime#getEndTime <em>End Time</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isSetEndTime()
	 * @see #getEndTime()
	 * @see #setEndTime(Date)
	...
	/**
	 * Returns whether the value of the '{@link scenario.fleet.PortAndTime#getEndTime <em>End Time</em>}' attribute is set. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
