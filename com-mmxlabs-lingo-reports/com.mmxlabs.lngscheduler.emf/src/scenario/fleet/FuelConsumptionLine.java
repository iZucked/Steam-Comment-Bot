 ...
 * 
 * <!-- begin-model-doc --> Represents a point on the fuel consumption curve, so a containing VesselStateAttributes will consume the associated amount of fuel at the given speed. <!-- end-model-doc
 * -->
 * 
 * <p>
...
public interface FuelConsumptionLine extends EObject {
	...
	/**
	 * Sets the value of the '{@link scenario.fleet.FuelConsumptionLine#getSpeed <em>Speed</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	...
	/**
	 * Returns the value of the '<em><b>Consumption</b></em>' attribute. <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Sets the value of the '{@link scenario.fleet.FuelConsumptionLine#getConsumption <em>Consumption</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
