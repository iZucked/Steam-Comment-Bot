...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Vessel Event</b></em>'. <!-- end-user-doc -->
 * 
 * <p>
...
public interface VesselEvent extends AnnotatedObject {
	...
	/**
	 * Sets the value of the '{@link scenario.fleet.VesselEvent#getId <em>Id</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	...
	/**
	 * Sets the value of the '{@link scenario.fleet.VesselEvent#getStartDate <em>Start Date</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 ...
	 * <p>
	 * If the meaning of the '<em>End Date</em>' attribute isn't clear, there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link scenario.fleet.VesselEvent#getEndDate <em>End Date</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	...
	/**
	 * Sets the value of the '{@link scenario.fleet.VesselEvent#getDuration <em>Duration</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	...
	/**
	 * Returns the value of the '<em><b>Start Port</b></em>' reference. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Start Port</em>' reference isn't clear, there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link scenario.fleet.VesselEvent#getStartPort <em>Start Port</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Start Port</em>' reference.
	 * @see #getStartPort()
	 * @generated
	 */
	...
	/**
	 * Returns the value of the '<em><b>Vessels</b></em>' reference list. The list contents are of type {@link scenario.fleet.Vessel}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Vessels</em>' reference list isn't clear, there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns the value of the '<em><b>Vessel Classes</b></em>' reference list. The list contents are of type {@link scenario.fleet.VesselClass}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Vessel Classes</em>' reference list isn't clear, there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
