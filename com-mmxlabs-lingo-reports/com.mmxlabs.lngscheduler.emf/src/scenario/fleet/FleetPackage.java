...
public interface FleetPackage extends EPackage {
	...
	/**
	 * The meta object id for the '{@link scenario.fleet.impl.VesselEventImpl <em>Vessel Event</em>}' class.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	...
	/**
	 * The number of operations of the '<em>Drydock</em>' class.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	...
	/**
	 * The meta object id for the '{@link scenario.fleet.impl.MaintenanceImpl <em>Maintenance</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see scenario.fleet.impl.MaintenanceImpl
	 * @see scenario.fleet.impl.FleetPackageImpl#getMaintenance()
	 * @generated
	 */
	int MAINTENANCE = 14;
	 ...
	 * @ordered
	 */
	int MAINTENANCE__NOTES = VESSEL_EVENT__NOTES;
	 ...
	 * @ordered
	 */
	int MAINTENANCE__ID = VESSEL_EVENT__ID;
	 ...
	 * @ordered
	 */
	int MAINTENANCE__START_DATE = VESSEL_EVENT__START_DATE;
	 ...
	 * @ordered
	 */
	int MAINTENANCE__END_DATE = VESSEL_EVENT__END_DATE;
	 ...
	 * @ordered
	 */
	int MAINTENANCE__DURATION = VESSEL_EVENT__DURATION;
	 ...
	 * @ordered
	 */
	int MAINTENANCE__VESSELS = VESSEL_EVENT__VESSELS;
	 ...
	 * @ordered
	 */
	int MAINTENANCE__VESSEL_CLASSES = VESSEL_EVENT__VESSEL_CLASSES;
	 ...
	 * @ordered
	 */
	int MAINTENANCE__START_PORT = VESSEL_EVENT__START_PORT;
	 ...
	 * @ordered
	 */
	int MAINTENANCE_FEATURE_COUNT = VESSEL_EVENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int MAINTENANCE_OPERATION_COUNT = VESSEL_EVENT_OPERATION_COUNT + 0;
	...
	/**
	 * Returns the meta object for the containment reference list '{@link scenario.fleet.FleetModel#getVesselEvents <em>Vessel Events</em>}'.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for class '{@link scenario.fleet.VesselEvent <em>Vessel Event</em>}'.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the attribute '{@link scenario.fleet.VesselEvent#getId <em>Id</em>}'.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the attribute '{@link scenario.fleet.VesselEvent#getStartDate <em>Start Date</em>}'.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the attribute '{@link scenario.fleet.VesselEvent#getEndDate <em>End Date</em>}'.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the attribute '{@link scenario.fleet.VesselEvent#getDuration <em>Duration</em>}'.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the reference list '{@link scenario.fleet.VesselEvent#getVesselClasses <em>Vessel Classes</em>}'.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for class '{@link scenario.fleet.Maintenance <em>Maintenance</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Maintenance</em>'.
	 * @see scenario.fleet.Maintenance
	 * @generated
	 */
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '{@link scenario.fleet.impl.VesselEventImpl <em>Vessel Event</em>}' class.
		 * <!-- begin-user-doc --> <!-- end-user-doc -->
		 * @see scenario.fleet.impl.VesselEventImpl
		 * @see scenario.fleet.impl.FleetPackageImpl#getVesselEvent()
		 * @generated
		...
		/**
		 * The meta object literal for the '{@link scenario.fleet.impl.MaintenanceImpl <em>Maintenance</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see scenario.fleet.impl.MaintenanceImpl
		 * @see scenario.fleet.impl.FleetPackageImpl#getMaintenance()
