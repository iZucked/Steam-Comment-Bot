...
public interface VesselClassCost extends EObject {
	/**
	 * Returns the value of the '<em><b>Canal</b></em>' reference. <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc --> The vessel class to which these costs apply, for this canal
	 * <!-- end-model-doc -->
	 * 
	...
	/**
	 * Returns the value of the '<em><b>Laden Cost</b></em>' attribute. <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc --> The toll in dollars paid for letting a laden vessel of
	 * this class pass through this canal <!-- end-model-doc -->
	 * 
	...
	/**
	 * Returns the value of the '<em><b>Unladen Cost</b></em>' attribute. <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc --> The toll in dollars for an unladen vessel of this class
	 * to pass through this canal. <!-- end-model-doc -->
	 * 
	...
	/**
	 * Returns the value of the '<em><b>Transit Time</b></em>' attribute. The default value is <code>"24"</code>. <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc --> The time in
	 * hours required for vessels of this class to pass through this canal <!-- end-model-doc -->
	 * 
	...
	/**
	 * Returns the value of the '<em><b>Transit Fuel</b></em>' attribute. The default value is <code>"50"</code>. <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc --> The amount of
	 * base fuel or base fuel equivalent, in metric tonnes per day (MT/day), consumed by vessels of this class during their passage through the canal. The total fuel consumption for a journey through
	 * the canal is then given by transitTime * (transitFuel / 24). <!-- end-model-doc -->
	 * 
