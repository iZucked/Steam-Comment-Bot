 ...
 * <ul>
 *   <li>{@link scenario.cargo.impl.DischargeSlotImpl#getId <em>Id</em>}</li>
 *   <li>{@link scenario.cargo.impl.DischargeSlotImpl#getMinQuantity <em>Min Quantity</em>}</li>
 *   <li>{@link scenario.cargo.impl.DischargeSlotImpl#getMaxQuantity <em>Max Quantity</em>}</li>
 *   <li>{@link scenario.cargo.impl.DischargeSlotImpl#getUnitPrice <em>Unit Price</em>}</li>
 *   <li>{@link scenario.cargo.impl.DischargeSlotImpl#getPort <em>Port</em>}</li>
 *   <li>{@link scenario.cargo.impl.DischargeSlotImpl#getWindowStart <em>Window Start</em>}</li>
 *   <li>{@link scenario.cargo.impl.DischargeSlotImpl#getWindowDuration <em>Window Duration</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class DischargeSlotImpl extends EObjectImpl implements DischargeSlot {
	/**
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CargoPackage.DISCHARGE_SLOT__ID, oldId, id));
	}
	...
	public void setMinQuantity(long newMinQuantity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CargoPackage.DISCHARGE_SLOT__MIN_QUANTITY, oldMinQuantity, minQuantity));
	}
	...
	public void setMaxQuantity(long newMaxQuantity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CargoPackage.DISCHARGE_SLOT__MAX_QUANTITY, oldMaxQuantity, maxQuantity));
	}
	...
	public void setUnitPrice(int newUnitPrice) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CargoPackage.DISCHARGE_SLOT__UNIT_PRICE, oldUnitPrice, unitPrice));
	}
	...
	public Port getPort() {
		if (port != null && port.eIsProxy()) {
			...
			if (port != oldPort) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CargoPackage.DISCHARGE_SLOT__PORT, oldPort, port));
			}
		}
		return port;
	}
	...
	public void setPort(Port newPort) {
		...
		port = newPort;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CargoPackage.DISCHARGE_SLOT__PORT, oldPort, port));
	}
	...
	public void setWindowStart(Date newWindowStart) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CargoPackage.DISCHARGE_SLOT__WINDOW_START, oldWindowStart, windowStart));
	}
	...
	public void setWindowDuration(int newWindowDuration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CargoPackage.DISCHARGE_SLOT__WINDOW_DURATION, oldWindowDuration, windowDuration));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CargoPackage.DISCHARGE_SLOT__ID:
				return getId();
			case CargoPackage.DISCHARGE_SLOT__MIN_QUANTITY:
				return getMinQuantity();
			case CargoPackage.DISCHARGE_SLOT__MAX_QUANTITY:
				return getMaxQuantity();
			case CargoPackage.DISCHARGE_SLOT__UNIT_PRICE:
				return getUnitPrice();
			case CargoPackage.DISCHARGE_SLOT__PORT:
				if (resolve) return getPort();
				return basicGetPort();
			case CargoPackage.DISCHARGE_SLOT__WINDOW_START:
				return getWindowStart();
			case CargoPackage.DISCHARGE_SLOT__WINDOW_DURATION:
