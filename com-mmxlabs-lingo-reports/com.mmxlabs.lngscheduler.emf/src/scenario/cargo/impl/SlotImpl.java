...
public class SlotImpl extends EObjectImpl implements Slot {
	...
	/**
	 * The default value of the '{@link #getWindowStart() <em>Window Start</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getWindowStart()
	 * @generated
	 * @ordered
	...
	/**
	 * The cached value of the '{@link #getWindowStart() <em>Window Start</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getWindowStart()
	 * @generated
	 * @ordered
	...
	/**
	 * The cached value of the '{@link #getContract() <em>Contract</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getContract()
	 * @generated
	 * @ordered
	...
	/**
	 * The default value of the '{@link #getFixedPrice() <em>Fixed Price</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getFixedPrice()
	 * @generated
	 * @ordered
	...
	/**
	 * The cached value of the '{@link #getFixedPrice() <em>Fixed Price</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getFixedPrice()
	 * @generated
	 * @ordered
	...
	/**
	 * This is true if the Fixed Price attribute has been set. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	 */
	...
	/**
	 * This is true if the Min Quantity attribute has been set. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	 */
	...
	/**
	 * This is true if the Max Quantity attribute has been set. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	 */
	...
	/**
	 * The default value of the '{@link #getWindowDuration() <em>Window Duration</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getWindowDuration() <em>Window Duration</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getWindowDuration()
	 * @generated
	 * @ordered
	...
	/**
	 * The default value of the '{@link #getSlotDuration() <em>Slot Duration</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getSlotDuration()
	 * @generated
	 * @ordered
	...
	/**
	 * The cached value of the '{@link #getSlotDuration() <em>Slot Duration</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getSlotDuration()
	 * @generated
	 * @ordered
	...
	/**
	 * This is true if the Slot Duration attribute has been set. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	 */
	 ...
	 */
	@Override
	public void setWindowStart(final DateAndOptionalTime newWindowStart) {
		final DateAndOptionalTime oldWindowStart = windowStart;
	 ...
	 */
	@Override
	public void setWindowDuration(final int newWindowDuration) {
		final int oldWindowDuration = windowDuration;
	 ...
	 */
	@Override
	public void setSlotDuration(final int newSlotDuration) {
		final int oldSlotDuration = slotDuration;
		slotDuration = newSlotDuration;
		final boolean oldSlotDurationESet = slotDurationESet;
	 ...
	 */
	@Override
	public void setFixedPrice(final float newFixedPrice) {
		final float oldFixedPrice = fixedPrice;
		fixedPrice = newFixedPrice;
		final boolean oldFixedPriceESet = fixedPriceESet;
		fixedPriceESet = true;
		if (eNotificationRequired()) {
	 ...
	 */
	@Override
	public void setContract(final Contract newContract) {
		final Contract oldContract = contract;
	...
	public Date getWindowEnd() {
		return new Date(getWindowStart().getDateWithDefaults(getPort()).getTime() + (javax.management.timer.Timer.ONE_HOUR * getWindowDuration()));
	}
	 ...
	 */
	@Override
	public Contract getSlotOrPortContract(final Object scenario) {
		if (getContract() != null) {
			return getContract();
	 ...
	 */
	@Override
	public int getSlotOrContractMinQuantity(final Object scenario) {
		if (isSetMinQuantity()) {
	 ...
	 */
	@Override
	public int getSlotOrContractMaxQuantity(final Object scenario) {
		if (isSetMaxQuantity()) {
