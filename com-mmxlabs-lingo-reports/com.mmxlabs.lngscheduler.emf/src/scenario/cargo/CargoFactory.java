...
public interface CargoFactory extends EFactory {
	...
	/**
	 * Returns a new object of class '<em>Cargo</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Slot</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Load Slot</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
