...
public class CargoAdapterFactory extends AdapterFactoryImpl {
	...
	protected CargoSwitch<Adapter> modelSwitch = new CargoSwitch<Adapter>() {
		@Override
		public Adapter caseCargoModel(final CargoModel object) {
			return createCargoModelAdapter();
		}

		@Override
		public Adapter caseCargo(final Cargo object) {
			return createCargoAdapter();
		}

		@Override
		public Adapter caseSlot(final Slot object) {
			return createSlotAdapter();
		}

		@Override
		public Adapter caseLoadSlot(final LoadSlot object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link scenario.cargo.CargoModel <em>Model</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can easily ignore
	...
	/**
	 * Creates a new adapter for an object of class '{@link scenario.cargo.Cargo <em>Cargo</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can easily ignore cases;
	...
	/**
	 * Creates a new adapter for an object of class '{@link scenario.cargo.Slot <em>Slot</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
	...
	/**
	 * Creates a new adapter for an object of class '{@link scenario.cargo.LoadSlot <em>Load Slot</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can easily ignore
	 * cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
