...
public class CargoSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(final int classifierID, final EObject theEObject) {
		...
		case CargoPackage.CARGO_MODEL: {
			final CargoModel cargoModel = (CargoModel) theEObject;
		...
		case CargoPackage.CARGO: {
			final Cargo cargo = (Cargo) theEObject;
			T result = caseCargo(cargo);
			if (result == null) {
				result = caseAnnotatedObject(cargo);
			}
			if (result == null) {
				result = defaultCase(theEObject);
			}
		...
		case CargoPackage.LOAD_SLOT: {
			final LoadSlot loadSlot = (LoadSlot) theEObject;
			T result = caseLoadSlot(loadSlot);
			if (result == null) {
				result = caseSlot(loadSlot);
			}
			if (result == null) {
				result = defaultCase(theEObject);
			}
	 ...
	 * @generated
	 */
	public T caseCargoModel(final CargoModel object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Cargo</em>'. <!-- begin-user-doc --> This implementation returns null; returning a non-null result will terminate the
	 * switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *            the target of the switch.
	 ...
	 * @generated
	 */
	public T caseCargo(final Cargo object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Slot</em>'. <!-- begin-user-doc --> This implementation returns null; returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * 
	 * @param object
	 *            the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Load Slot</em>'. <!-- begin-user-doc --> This implementation returns null; returning a non-null result will terminate the
	 * switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *            the target of the switch.
	 ...
	 * @generated
	 */
	public T caseLoadSlot(final LoadSlot object) {
		return null;
	}
