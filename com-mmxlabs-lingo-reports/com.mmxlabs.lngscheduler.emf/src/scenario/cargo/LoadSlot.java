...
public interface LoadSlot extends Slot {
	/**
	 * Returns the value of the '<em><b>Cargo CVvalue</b></em>' attribute. <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc --> The energy content conversion factor for this cargo;
	 * because LNG is priced by MMBTU but measured by volume, we need to know both the energy content and volume. This value lets us derive the former from the latter. <!-- end-model-doc -->
	 * 
