...
public class ContractModelImpl extends EObjectImpl implements ContractModel {
	/**
	 * The cached value of the '{@link #getVolumeConstraints() <em>Volume Constraints</em>}' containment reference list. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getShippingEntity() <em>Shipping Entity</em>}' containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getPurchaseContracts() <em>Purchase Contracts</em>}' containment reference list. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getSalesContracts() <em>Sales Contracts</em>}' containment reference list. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 ...
	 */
	@Override
	public Contract getDefaultContract(final Port port) {
		for (final Contract c : getPurchaseContracts()) {
			if (c.getDefaultPorts().contains(port)) {
				return c;
			}
		}
	 ...
	 */
	@Override
	public SimplePurchaseContract getCooldownContract(final Port port) {
		for (final Contract c : getPurchaseContracts()) {
			if (c instanceof SimplePurchaseContract) {
				if (((SimplePurchaseContract) c).getCooldownPorts().contains(port)) {
					return (SimplePurchaseContract) c;
				}
			}
		}
	...
	public GroupEntity getShippingEntity() {
		if ((shippingEntity != null) && shippingEntity.eIsProxy()) {
			final InternalEObject oldShippingEntity = (InternalEObject) shippingEntity;
			shippingEntity = (GroupEntity) eResolveProxy(oldShippingEntity);
			if (shippingEntity != oldShippingEntity) {
				final InternalEObject newShippingEntity = (InternalEObject) shippingEntity;
	 ...
	 * @generated
	 */
	public NotificationChain basicSetShippingEntity(final GroupEntity newShippingEntity, NotificationChain msgs) {
		final GroupEntity oldShippingEntity = shippingEntity;
		shippingEntity = newShippingEntity;
		if (eNotificationRequired()) {
			final ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ContractPackage.CONTRACT_MODEL__SHIPPING_ENTITY, oldShippingEntity, newShippingEntity);
			if (msgs == null) {
				msgs = notification;
			} else {
	 ...
	 */
	@Override
	public void setShippingEntity(final GroupEntity newShippingEntity) {
