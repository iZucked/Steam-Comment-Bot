...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Profit Sharing Purchase Contract</b></em>'. <!-- end-user-doc -->
 * 
 * <p>
...
public interface ProfitSharingPurchaseContract extends PurchaseContract {
	/**
	 * Returns the value of the '<em><b>Index</b></em>' reference. <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Sets the value of the '{@link scenario.contract.ProfitSharingPurchaseContract#getIndex <em>Index</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	...
	/**
	 * Returns the value of the '<em><b>Reference Index</b></em>' reference. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Reference Index</em>' reference isn't clear, there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link scenario.contract.ProfitSharingPurchaseContract#getReferenceIndex <em>Reference Index</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Reference Index</em>' reference.
	 ...
	 * <p>
	 * If the meaning of the '<em>Alpha</em>' attribute isn't clear, there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link scenario.contract.ProfitSharingPurchaseContract#getAlpha <em>Alpha</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	...
	/**
	 * Returns the value of the '<em><b>Beta</b></em>' attribute. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Beta</em>' attribute isn't clear, there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link scenario.contract.ProfitSharingPurchaseContract#getBeta <em>Beta</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Beta</em>' attribute.
	 * @see #getBeta()
	 * @generated
	 */
	...
	/**
	 * Returns the value of the '<em><b>Gamma</b></em>' attribute. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Gamma</em>' attribute isn't clear, there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link scenario.contract.ProfitSharingPurchaseContract#getGamma <em>Gamma</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
