...
public interface Port extends UUIDObject, NamedObject, AnnotatedObject, PortSelection {
	/**
	 * Returns the value of the '<em><b>Time Zone</b></em>' attribute. <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Sets the value of the '{@link scenario.port.Port#getTimeZone <em>Time Zone</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Time Zone</em>' attribute.
	 * @see #getTimeZone()
	 * @generated
	 */
	...
	/**
	 * Returns the value of the '<em><b>Default CVvalue</b></em>' attribute. The default value is <code>"22.8"</code>. <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Sets the value of the '{@link scenario.port.Port#getDefaultCVvalue <em>Default CVvalue</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Default CVvalue</em>' attribute.
	...
	/**
	 * Returns the value of the '<em><b>Default Window Start</b></em>' attribute. The default value is <code>"0"</code>. <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Sets the value of the '{@link scenario.port.Port#getDefaultWindowStart <em>Default Window Start</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Default Window Start</em>' attribute.
	...
	/**
	 * Returns the value of the '<em><b>Default Slot Duration</b></em>' attribute. <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Sets the value of the '{@link scenario.port.Port#getDefaultSlotDuration <em>Default Slot Duration</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Default Slot Duration</em>' attribute.
	...
	/**
	 * Returns the value of the '<em><b>Should Arrive Cold</b></em>' attribute. <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Sets the value of the '{@link scenario.port.Port#isShouldArriveCold <em>Should Arrive Cold</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Should Arrive Cold</em>' attribute.
	...
	/**
	 * Returns the value of the '<em><b>Default Load Duration</b></em>' attribute. <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Sets the value of the '{@link scenario.port.Port#getDefaultLoadDuration <em>Default Load Duration</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Default Load Duration</em>' attribute.
	...
	/**
	 * Returns the value of the '<em><b>Default Discharge Duration</b></em>' attribute. <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Sets the value of the '{@link scenario.port.Port#getDefaultDischargeDuration <em>Default Discharge Duration</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Default Discharge Duration</em>' attribute.
	...
	/**
	 * Returns the value of the '<em><b>Capabilities</b></em>' attribute list. The list contents are of type {@link scenario.port.PortCapability}. The literals are from the enumeration
	 * {@link scenario.port.PortCapability}. <!-- begin-user-doc -->
	 * <p>
