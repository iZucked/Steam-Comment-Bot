...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Distance Line</b></em>'. <!-- end-user-doc -->
 * 
 * <p>
...
public interface DistanceLine extends EObject {
	...
	/**
	 * Sets the value of the '{@link scenario.port.DistanceLine#getFromPort <em>From Port</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	...
	/**
	 * Sets the value of the '{@link scenario.port.DistanceLine#getToPort <em>To Port</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	...
	/**
	 * Sets the value of the '{@link scenario.port.DistanceLine#getDistance <em>Distance</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
