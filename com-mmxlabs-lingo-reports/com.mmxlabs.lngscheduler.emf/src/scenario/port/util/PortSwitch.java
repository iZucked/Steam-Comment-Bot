...
public class PortSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case PortPackage.DISTANCE_MODEL: {
				DistanceModel distanceModel = (DistanceModel)theEObject;
				T result = caseDistanceModel(distanceModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PortPackage.DISTANCE_LINE: {
				DistanceLine distanceLine = (DistanceLine)theEObject;
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Distance Model</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public T caseDistanceModel(DistanceModel object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Distance Line</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
