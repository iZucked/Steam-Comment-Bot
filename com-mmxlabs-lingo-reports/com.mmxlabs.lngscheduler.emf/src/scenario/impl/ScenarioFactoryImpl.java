...
public class ScenarioFactoryImpl extends EFactoryImpl implements ScenarioFactory {
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case ScenarioPackage.DATE_AND_OPTIONAL_HOUR:
				return createDateAndOptionalHourFromString(eDataType, initialValue);
			default:
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
			case ScenarioPackage.DATE_AND_OPTIONAL_HOUR:
				return convertDateAndOptionalHourToString(eDataType, instanceValue);
			default:
				throw new IllegalArgumentException("The datatype '" + eDataType.getName() + "' is not a valid classifier");
		}
	}
	 ...
	 * @generated
	 */
	public DateAndOptionalHour createDateAndOptionalHourFromString(EDataType eDataType, String initialValue) {
		return (DateAndOptionalHour)super.createFromString(eDataType, initialValue);
	}
	 ...
	 * @generated
	 */
	public String convertDateAndOptionalHourToString(EDataType eDataType, Object instanceValue) {
