...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Detail</b></em>'. <!-- end-user-doc -->
 * <p>
...
public class DetailImpl extends EObjectImpl implements Detail {
	...
	protected EClass eStaticClass() {
		return ScenarioPackage.Literals.DETAIL;
	}
	 ...
	 */
	@Override
	public EList<Detail> getChildren() {
		if (children == null) {
			children = new EObjectContainmentEList.Resolving<Detail>(Detail.class, this, ScenarioPackage.DETAIL__CHILDREN);
		}
		return children;
	}
