...
public interface OptimiserFactory extends EFactory {
	...
	/**
	 * Returns a new object of class '<em>Optimisation Settings</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Optimisation</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Discount Curve</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Discount</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
