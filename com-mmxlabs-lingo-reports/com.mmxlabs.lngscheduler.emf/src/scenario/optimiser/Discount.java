...
public interface Discount extends EObject {
	/**
	 * Returns the value of the '<em><b>Time</b></em>' attribute. <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc --> The time offset from the beginning of the curve from which this
	 * discount factor applies, in hours. <!-- end-model-doc -->
	 * 
	...
	/**
	 * Returns the value of the '<em><b>Discount Factor</b></em>' attribute. The default value is <code>"1"</code>. <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc --> The discount
	 * factor itself, a floating point number indicating how much weight a fitness value should be given in this interval (0 means no weight, 1 means normal weight) <!-- end-model-doc -->
	 * 
