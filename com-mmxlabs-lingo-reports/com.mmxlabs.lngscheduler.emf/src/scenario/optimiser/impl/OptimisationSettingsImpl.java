...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Optimisation Settings</b></em>'. <!-- end-user-doc -->
 * <p>
...
public class OptimisationSettingsImpl extends NamedObjectImpl implements OptimisationSettings {
	/**
	 * The default value of the '{@link #getRandomSeed() <em>Random Seed</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getRandomSeed()
	 * @generated
	 * @ordered
	...
	/**
	 * The cached value of the '{@link #getRandomSeed() <em>Random Seed</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getRandomSeed()
	 * @generated
	 * @ordered
	...
	/**
	 * The cached value of the '{@link #getInitialSchedule() <em>Initial Schedule</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The default value of the '{@link #getFreezeDaysFromStart() <em>Freeze Days From Start</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getFreezeDaysFromStart() <em>Freeze Days From Start</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getFreezeDaysFromStart()
	 * @generated
	 * @ordered
	...
	/**
	 * The default value of the '{@link #getIgnoreElementsAfter() <em>Ignore Elements After</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getIgnoreElementsAfter() <em>Ignore Elements After</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getIgnoreElementsAfter()
	 * @generated
	 * @ordered
	...
	/**
	 * This is true if the Ignore Elements After attribute has been set. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	 */
	...
	/**
	 * The cached value of the '{@link #getConstraints() <em>Constraints</em>}' containment reference list. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getConstraints()
	 * @generated
	 * @ordered
	...
	/**
	 * The cached value of the '{@link #getObjectives() <em>Objectives</em>}' containment reference list. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getObjectives()
	 * @generated
	 * @ordered
	...
	/**
	 * The cached value of the '{@link #getDefaultDiscountCurve() <em>Default Discount Curve</em>}' containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * This is true if the Default Discount Curve containment reference has been set. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	 */
	...
	/**
	 * The default value of the '{@link #isAllowRewiringByDefault() <em>Allow Rewiring By Default</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #isAllowRewiringByDefault() <em>Allow Rewiring By Default</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isAllowRewiringByDefault()
	 * @generated
	 * @ordered
	 ...
	 */
	@Override
	public void setRandomSeed(final long newRandomSeed) {
		final long oldRandomSeed = randomSeed;
	...
	public Schedule getInitialSchedule() {
		if ((initialSchedule != null) && initialSchedule.eIsProxy()) {
			final InternalEObject oldInitialSchedule = (InternalEObject) initialSchedule;
	 ...
	 */
	@Override
	public void setInitialSchedule(final Schedule newInitialSchedule) {
		final Schedule oldInitialSchedule = initialSchedule;
	...
	public DiscountCurve getDefaultDiscountCurve() {
		if ((defaultDiscountCurve != null) && defaultDiscountCurve.eIsProxy()) {
			final InternalEObject oldDefaultDiscountCurve = (InternalEObject) defaultDiscountCurve;
			defaultDiscountCurve = (DiscountCurve) eResolveProxy(oldDefaultDiscountCurve);
			if (defaultDiscountCurve != oldDefaultDiscountCurve) {
				final InternalEObject newDefaultDiscountCurve = (InternalEObject) defaultDiscountCurve;
	 ...
	 * @generated
	 */
	public NotificationChain basicSetDefaultDiscountCurve(final DiscountCurve newDefaultDiscountCurve, NotificationChain msgs) {
		final DiscountCurve oldDefaultDiscountCurve = defaultDiscountCurve;
		defaultDiscountCurve = newDefaultDiscountCurve;
		final boolean oldDefaultDiscountCurveESet = defaultDiscountCurveESet;
		defaultDiscountCurveESet = true;
		if (eNotificationRequired()) {
			final ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OptimiserPackage.OPTIMISATION_SETTINGS__DEFAULT_DISCOUNT_CURVE, oldDefaultDiscountCurve,
					newDefaultDiscountCurve, !oldDefaultDiscountCurveESet);
			if (msgs == null) {
				msgs = notification;
			} else {
	 ...
	 */
	@Override
	public void setDefaultDiscountCurve(final DiscountCurve newDefaultDiscountCurve) {
		if (newDefaultDiscountCurve != defaultDiscountCurve) {
			...
			defaultDiscountCurveESet = true;
			if (eNotificationRequired()) {
				eNotify(new ENotificationImpl(this, Notification.SET, OptimiserPackage.OPTIMISATION_SETTINGS__DEFAULT_DISCOUNT_CURVE, newDefaultDiscountCurve, newDefaultDiscountCurve,
						!oldDefaultDiscountCurveESet));
			}
		}
	}
	...
	public NotificationChain basicUnsetDefaultDiscountCurve(NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			final ENotificationImpl notification = new ENotificationImpl(this, Notification.UNSET, OptimiserPackage.OPTIMISATION_SETTINGS__DEFAULT_DISCOUNT_CURVE, oldDefaultDiscountCurve, null,
					oldDefaultDiscountCurveESet);
			if (msgs == null) {
				msgs = notification;
			} else {
	 ...
	 */
	@Override
	public void setAllowRewiringByDefault(final boolean newAllowRewiringByDefault) {
		final boolean oldAllowRewiringByDefault = allowRewiringByDefault;
	 ...
	 */
	@Override
	public void setFreezeDaysFromStart(final int newFreezeDaysFromStart) {
		final int oldFreezeDaysFromStart = freezeDaysFromStart;
	 ...
	 */
	@Override
	public void setIgnoreElementsAfter(final Date newIgnoreElementsAfter) {
		final Date oldIgnoreElementsAfter = ignoreElementsAfter;
		ignoreElementsAfter = newIgnoreElementsAfter;
		final boolean oldIgnoreElementsAfterESet = ignoreElementsAfterESet;
		ignoreElementsAfterESet = true;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, OptimiserPackage.OPTIMISATION_SETTINGS__IGNORE_ELEMENTS_AFTER, oldIgnoreElementsAfter, ignoreElementsAfter,
					!oldIgnoreElementsAfterESet));
		}
	}
	...
	public void unsetIgnoreElementsAfter() {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.UNSET, OptimiserPackage.OPTIMISATION_SETTINGS__IGNORE_ELEMENTS_AFTER, oldIgnoreElementsAfter, IGNORE_ELEMENTS_AFTER_EDEFAULT,
					oldIgnoreElementsAfterESet));
		}
	}
