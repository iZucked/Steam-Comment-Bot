 ...
 * <ul>
 *   <li>{@link scenario.optimiser.impl.ConstraintImpl#getName <em>Name</em>}</li>
...
public class ConstraintImpl extends EObjectImpl implements Constraint {
	...
	protected EClass eStaticClass() {
		return OptimiserPackage.Literals.CONSTRAINT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OptimiserPackage.CONSTRAINT__NAME, oldName, name));
	}
