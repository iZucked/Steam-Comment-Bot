...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Discount Curve</b></em>'.
 * <!-- end-user-doc -->
 *
 * <!-- begin-model-doc -->
...
public interface DiscountCurve extends NamedObject {
	 ...
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Discounts</em>' containment reference list isn't clear,
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * The earliest date from which the discount curve should apply. If this is not set, the discount curve applies from the optimisation's start.
	 * <!-- end-model-doc -->
