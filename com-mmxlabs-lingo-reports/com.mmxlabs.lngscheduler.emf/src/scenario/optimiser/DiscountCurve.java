 ...
 * 
 * <!-- begin-model-doc --> A collection of discounts together with a base-time from which the discount curve should apply. <!-- end-model-doc -->
 * 
 * <p>
...
public interface DiscountCurve extends NamedObject {
	/**
	 * Returns the value of the '<em><b>Discounts</b></em>' containment reference list. The list contents are of type {@link scenario.optimiser.Discount}. <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Sets the value of the '{@link scenario.optimiser.DiscountCurve#getStartDate <em>Start Date</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	...
	/**
	 * Unsets the value of the '{@link scenario.optimiser.DiscountCurve#getStartDate <em>Start Date</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isSetStartDate()
	 * @see #getStartDate()
	 * @see #setStartDate(Date)
	...
	/**
	 * Returns whether the value of the '{@link scenario.optimiser.DiscountCurve#getStartDate <em>Start Date</em>}' attribute is set. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
