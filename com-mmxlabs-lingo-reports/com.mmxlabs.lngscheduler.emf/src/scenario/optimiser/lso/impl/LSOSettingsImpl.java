...
public class LSOSettingsImpl extends OptimisationSettingsImpl implements LSOSettings {
	/**
	 * The default value of the '{@link #getNumberOfSteps() <em>Number Of Steps</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getNumberOfSteps() <em>Number Of Steps</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getNumberOfSteps()
	 * @generated
	 * @ordered
	...
	/**
	 * The cached value of the '{@link #getThresholderSettings() <em>Thresholder Settings</em>}' containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getMoveGeneratorSettings() <em>Move Generator Settings</em>}' containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	public void setNumberOfSteps(final int newNumberOfSteps) {
		final int oldNumberOfSteps = numberOfSteps;
	...
	public ThresholderSettings getThresholderSettings() {
		if ((thresholderSettings != null) && thresholderSettings.eIsProxy()) {
			final InternalEObject oldThresholderSettings = (InternalEObject) thresholderSettings;
			...
			if (thresholderSettings != oldThresholderSettings) {
				final InternalEObject newThresholderSettings = (InternalEObject) thresholderSettings;
	 ...
	 * @generated
	 */
	public NotificationChain basicSetThresholderSettings(final ThresholderSettings newThresholderSettings, NotificationChain msgs) {
		final ThresholderSettings oldThresholderSettings = thresholderSettings;
		thresholderSettings = newThresholderSettings;
		if (eNotificationRequired()) {
			final ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LsoPackage.LSO_SETTINGS__THRESHOLDER_SETTINGS, oldThresholderSettings, newThresholderSettings);
			if (msgs == null) {
				msgs = notification;
			} else {
	 ...
	 */
	@Override
	public void setThresholderSettings(final ThresholderSettings newThresholderSettings) {
	...
	public MoveGeneratorSettings getMoveGeneratorSettings() {
		if ((moveGeneratorSettings != null) && moveGeneratorSettings.eIsProxy()) {
			final InternalEObject oldMoveGeneratorSettings = (InternalEObject) moveGeneratorSettings;
			...
			if (moveGeneratorSettings != oldMoveGeneratorSettings) {
				final InternalEObject newMoveGeneratorSettings = (InternalEObject) moveGeneratorSettings;
	 ...
	 * @generated
	 */
	public NotificationChain basicSetMoveGeneratorSettings(final MoveGeneratorSettings newMoveGeneratorSettings, NotificationChain msgs) {
		final MoveGeneratorSettings oldMoveGeneratorSettings = moveGeneratorSettings;
		moveGeneratorSettings = newMoveGeneratorSettings;
		if (eNotificationRequired()) {
			final ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LsoPackage.LSO_SETTINGS__MOVE_GENERATOR_SETTINGS, oldMoveGeneratorSettings, newMoveGeneratorSettings);
			if (msgs == null) {
				msgs = notification;
			} else {
				msgs.add(notification);
	 ...
	 */
	@Override
	public void setMoveGeneratorSettings(final MoveGeneratorSettings newMoveGeneratorSettings) {
