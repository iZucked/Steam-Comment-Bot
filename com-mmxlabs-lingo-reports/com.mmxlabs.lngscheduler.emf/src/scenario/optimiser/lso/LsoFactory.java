...
public interface LsoFactory extends EFactory {
	...
	/**
	 * Returns a new object of class '<em>LSO Settings</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Thresholder Settings</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Move Generator Settings</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Random Move Generator Settings</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Constrained Move Generator Settings</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
