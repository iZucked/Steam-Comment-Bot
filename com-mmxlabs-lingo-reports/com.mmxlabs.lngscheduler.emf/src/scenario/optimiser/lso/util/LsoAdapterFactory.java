...
public class LsoAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected LsoSwitch<Adapter> modelSwitch = new LsoSwitch<Adapter>() {
		@Override
		public Adapter caseLSOSettings(final LSOSettings object) {
			return createLSOSettingsAdapter();
		}

		@Override
		public Adapter caseThresholderSettings(final ThresholderSettings object) {
			return createThresholderSettingsAdapter();
		}

		@Override
		public Adapter caseMoveGeneratorSettings(final MoveGeneratorSettings object) {
			return createMoveGeneratorSettingsAdapter();
		}

		@Override
		public Adapter caseRandomMoveGeneratorSettings(final RandomMoveGeneratorSettings object) {
			return createRandomMoveGeneratorSettingsAdapter();
		}

		@Override
		public Adapter caseConstrainedMoveGeneratorSettings(final ConstrainedMoveGeneratorSettings object) {
		...
		@Override
		public Adapter caseOptimisationSettings(final OptimisationSettings object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link scenario.optimiser.lso.LSOSettings <em>LSO Settings</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can
	...
	/**
	 * Creates a new adapter for an object of class '{@link scenario.optimiser.lso.ThresholderSettings <em>Thresholder Settings</em>}'. <!-- begin-user-doc --> This default implementation returns null
	...
	/**
	 * Creates a new adapter for an object of class '{@link scenario.optimiser.lso.MoveGeneratorSettings <em>Move Generator Settings</em>}'. <!-- begin-user-doc --> This default implementation returns
	...
	/**
	 * Creates a new adapter for an object of class '{@link scenario.optimiser.lso.RandomMoveGeneratorSettings <em>Random Move Generator Settings</em>}'. <!-- begin-user-doc --> This default
	...
	/**
	 * Creates a new adapter for an object of class '{@link scenario.optimiser.lso.ConstrainedMoveGeneratorSettings <em>Constrained Move Generator Settings</em>}'. <!-- begin-user-doc --> This default
	 * implementation returns null so that we can easily ignore cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
	...
	/**
	 * Creates a new adapter for an object of class '{@link scenario.optimiser.OptimisationSettings <em>Optimisation Settings</em>}'. <!-- begin-user-doc --> This default implementation returns null
	 * so that we can easily ignore cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
