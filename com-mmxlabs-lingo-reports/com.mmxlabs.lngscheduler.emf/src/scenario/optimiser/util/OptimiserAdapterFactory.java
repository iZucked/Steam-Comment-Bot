...
public class OptimiserAdapterFactory extends AdapterFactoryImpl {
	...
	protected OptimiserSwitch<Adapter> modelSwitch = new OptimiserSwitch<Adapter>() {
		...
		@Override
		public Adapter caseOptimisation(final Optimisation object) {
		...
		@Override
		public Adapter caseDiscountCurve(final DiscountCurve object) {
			return createDiscountCurveAdapter();
		}

		@Override
		public Adapter caseDiscount(final Discount object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link scenario.optimiser.Optimisation <em>Optimisation</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can
	...
	/**
	 * Creates a new adapter for an object of class '{@link scenario.optimiser.Constraint <em>Constraint</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can easily
	...
	/**
	 * Creates a new adapter for an object of class '{@link scenario.optimiser.Objective <em>Objective</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can easily
	 * ignore cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
	...
	/**
	 * Creates a new adapter for an object of class '{@link scenario.optimiser.DiscountCurve <em>Discount Curve</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can
	 * easily ignore cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
	...
	/**
	 * Creates a new adapter for an object of class '{@link scenario.optimiser.Discount <em>Discount</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can easily
	 * ignore cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
