...
public interface Detail extends EObject {
	...
	/**
	 * Sets the value of the '{@link scenario.Detail#getName <em>Name</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	...
	/**
	 * Returns the value of the '<em><b>Children</b></em>' containment reference list. The list contents are of type {@link scenario.Detail}. <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Sets the value of the '{@link scenario.Detail#getValue <em>Value</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
