...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Fitness</b></em>'. <!-- end-user-doc -->
 * 
 * <p>
...
public interface ScheduleFitness extends EObject {
	...
	/**
	 * Sets the value of the '{@link scenario.schedule.ScheduleFitness#getName <em>Name</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	...
	/**
	 * Sets the value of the '{@link scenario.schedule.ScheduleFitness#getValue <em>Value</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
