...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Fuel Mixture</b></em>'. <!-- end-user-doc -->
 * 
 * <p>
...
public interface FuelMixture extends EObject {
	/**
	 * Returns the value of the '<em><b>Fuel Usage</b></em>' containment reference list. The list contents are of type {@link scenario.schedule.events.FuelQuantity}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Fuel Usage</em>' containment reference list isn't clear, there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
