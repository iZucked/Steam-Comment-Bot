...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Journey</b></em>'. <!-- end-user-doc -->
 * 
 * <p>
...
public interface Journey extends ScheduledEvent, FuelMixture {
	/**
	 * Returns the value of the '<em><b>To Port</b></em>' reference. <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Sets the value of the '{@link scenario.schedule.events.Journey#getToPort <em>To Port</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>To Port</em>' reference.
	 * @see #getToPort()
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link scenario.schedule.events.Journey#getVesselState <em>Vessel State</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	...
	/**
	 * Returns the value of the '<em><b>Route</b></em>' attribute. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Route</em>' attribute isn't clear, there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link scenario.schedule.events.Journey#getRoute <em>Route</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	...
	/**
	 * Returns the value of the '<em><b>Speed</b></em>' attribute. <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Sets the value of the '{@link scenario.schedule.events.Journey#getSpeed <em>Speed</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 ...
	 * <p>
	 * If the meaning of the '<em>Distance</em>' attribute isn't clear, there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link scenario.schedule.events.Journey#getDistance <em>Distance</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	...
	/**
	 * Returns the value of the '<em><b>From Port</b></em>' reference. <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Sets the value of the '{@link scenario.schedule.events.Journey#getFromPort <em>From Port</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>From Port</em>' reference.
	 * @see #getFromPort()
	 * @generated
	 */
	...
	/**
	 * Returns the value of the '<em><b>Route Cost</b></em>' attribute. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Route Cost</em>' attribute isn't clear, there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link scenario.schedule.events.Journey#getRouteCost <em>Route Cost</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Route Cost</em>' attribute.
	 * @see #getRouteCost()
	 * @generated
	 */
	 ...
	 * 
	 * @model kind="operation" required="true" annotation="http://www.eclipse.org/emf/2002/GenModel body='return getRouteCost() + getTotalFuelCost() + getHireCost();'"
	 * @generated
	 */
	long getTotalCost();
