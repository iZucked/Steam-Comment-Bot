...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Port Visit</b></em>'. <!-- end-user-doc -->
 * 
 * <p>
...
public interface PortVisit extends ScheduledEvent {
	...
	/**
	 * Sets the value of the '{@link scenario.schedule.events.PortVisit#getPort <em>Port</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 ...
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @model kind="operation" required="true" annotation="http://www.eclipse.org/emf/2002/GenModel body='return \"visit to \" + port.getName();'"
	 * @generated
	 */
	String getId();
	 ...
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @model kind="operation" required="true" annotation="http://www.eclipse.org/emf/2002/GenModel body='return eClass().getName().replace(\"Visit\", \"\");'"
	 * @generated
	 */
	@Override
