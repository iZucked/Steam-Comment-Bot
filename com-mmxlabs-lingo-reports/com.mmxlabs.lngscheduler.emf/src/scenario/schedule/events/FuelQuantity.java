...
public interface FuelQuantity extends EObject {
	/**
	 * Returns the value of the '<em><b>Fuel Type</b></em>' attribute. The literals are from the enumeration {@link scenario.schedule.events.FuelType}. <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Sets the value of the '{@link scenario.schedule.events.FuelQuantity#getFuelType <em>Fuel Type</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Fuel Type</em>' attribute.
	 * @see scenario.schedule.events.FuelType
	 * @see #getFuelType()
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link scenario.schedule.events.FuelQuantity#getQuantity <em>Quantity</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	...
	/**
	 * Sets the value of the '{@link scenario.schedule.events.FuelQuantity#getUnitPrice <em>Unit Price</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	...
	/**
	 * Returns the value of the '<em><b>Total Price</b></em>' attribute. <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Sets the value of the '{@link scenario.schedule.events.FuelQuantity#getTotalPrice <em>Total Price</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Total Price</em>' attribute.
	 * @see #getTotalPrice()
	 * @generated
	 */
	...
	/**
	 * Returns the value of the '<em><b>Fuel Unit</b></em>' attribute. The literals are from the enumeration {@link scenario.schedule.events.FuelUnit}. <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Sets the value of the '{@link scenario.schedule.events.FuelQuantity#getFuelUnit <em>Fuel Unit</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Fuel Unit</em>' attribute.
	 * @see scenario.schedule.events.FuelUnit
	 * @see #getFuelUnit()
	 * @generated
	 */
	...
	/**
	 * Returns the value of the '<em><b>Purpose</b></em>' attribute. The literals are from the enumeration {@link scenario.schedule.events.FuelPurpose}. <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Sets the value of the '{@link scenario.schedule.events.FuelQuantity#getPurpose <em>Purpose</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
