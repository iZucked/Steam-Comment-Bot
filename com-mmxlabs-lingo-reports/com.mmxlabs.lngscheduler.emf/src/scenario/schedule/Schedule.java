...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Schedule</b></em>'. <!-- end-user-doc -->
 * 
 * <p>
...
public interface Schedule extends EObject {
	/**
	 * Returns the value of the '<em><b>Sequences</b></em>' containment reference list. The list contents are of type {@link scenario.schedule.Sequence}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Sequences</em>' containment reference list isn't clear, there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link scenario.schedule.Schedule#getName <em>Name</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	...
	/**
	 * Returns the value of the '<em><b>Cargo Allocations</b></em>' containment reference list. The list contents are of type {@link scenario.schedule.CargoAllocation}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Cargo Allocations</em>' containment reference list isn't clear, there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns the value of the '<em><b>Fleet</b></em>' containment reference list. The list contents are of type {@link scenario.schedule.fleetallocation.AllocatedVessel}. <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Returns the value of the '<em><b>Fitness</b></em>' containment reference list. The list contents are of type {@link scenario.schedule.ScheduleFitness}. <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Returns the value of the '<em><b>Revenue</b></em>' containment reference list. The list contents are of type {@link scenario.schedule.BookedRevenue}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Revenue</em>' containment reference list isn't clear, there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
