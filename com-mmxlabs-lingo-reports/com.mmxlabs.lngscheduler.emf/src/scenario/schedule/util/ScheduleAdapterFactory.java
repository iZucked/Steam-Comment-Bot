...
public class ScheduleAdapterFactory extends AdapterFactoryImpl {
	...
	protected ScheduleSwitch<Adapter> modelSwitch = new ScheduleSwitch<Adapter>() {
		@Override
		public Adapter caseScheduleModel(final ScheduleModel object) {
			return createScheduleModelAdapter();
		}

		@Override
		public Adapter caseSchedule(final Schedule object) {
		...
		@Override
		public Adapter caseCargoAllocation(final CargoAllocation object) {
			return createCargoAllocationAdapter();
		}

		@Override
		public Adapter caseScheduleFitness(final ScheduleFitness object) {
			return createScheduleFitnessAdapter();
		}

		@Override
		public Adapter caseBookedRevenue(final BookedRevenue object) {
			return createBookedRevenueAdapter();
		}

		@Override
		public Adapter caseCargoRevenue(final CargoRevenue object) {
			return createCargoRevenueAdapter();
		}

		@Override
		public Adapter caseVesselEventRevenue(final VesselEventRevenue object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link scenario.schedule.ScheduleModel <em>Model</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can easily
	...
	/**
	 * Creates a new adapter for an object of class '{@link scenario.schedule.Schedule <em>Schedule</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can easily
	 * ignore cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
	...
	/**
	 * Creates a new adapter for an object of class '{@link scenario.schedule.Sequence <em>Sequence</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can easily
	 * ignore cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
	...
	/**
	 * Creates a new adapter for an object of class '{@link scenario.schedule.CargoAllocation <em>Cargo Allocation</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we
	...
	/**
	 * Creates a new adapter for an object of class '{@link scenario.schedule.ScheduleFitness <em>Fitness</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can easily
	 * ignore cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
	...
	/**
	 * Creates a new adapter for an object of class '{@link scenario.schedule.BookedRevenue <em>Booked Revenue</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can
	...
	/**
	 * Creates a new adapter for an object of class '{@link scenario.schedule.CargoRevenue <em>Cargo Revenue</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can
	 * easily ignore cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
	...
	/**
	 * Creates a new adapter for an object of class '{@link scenario.schedule.VesselEventRevenue <em>Vessel Event Revenue</em>}'. <!-- begin-user-doc --> This default implementation returns null so
