...
public class FleetallocationPackageImpl extends EPackageImpl implements FleetallocationPackage {
	 ...
	 * 
	 * <p>
	 * This method is used to initialize {@link FleetallocationPackage#eINSTANCE} when that field is accessed. Clients should not invoke it directly. Instead, they should simply access that field to
	...
	public static FleetallocationPackage init() {
		if (isInited) {
			return (FleetallocationPackage) EPackage.Registry.INSTANCE.getEPackage(FleetallocationPackage.eNS_URI);
		}

		// Obtain or create and register package
		final FleetallocationPackageImpl theFleetallocationPackage = (FleetallocationPackageImpl) (EPackage.Registry.INSTANCE.get(eNS_URI) instanceof FleetallocationPackageImpl ? EPackage.Registry.INSTANCE
				.get(eNS_URI) : new FleetallocationPackageImpl());
	...
	public void initializePackageContents() {
		...
		initEReference(getFleetVessel_Vessel(), theFleetPackage.getVessel(), null, "vessel", null, 1, 1, FleetVessel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
		...
		initEAttribute(getSpotVessel_Index(), ecorePackage.getEInt(), "index", null, 1, 1, SpotVessel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEReference(getSpotVessel_VesselClass(), theFleetPackage.getVesselClass(), null, "vesselClass", null, 1, 1, SpotVessel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
