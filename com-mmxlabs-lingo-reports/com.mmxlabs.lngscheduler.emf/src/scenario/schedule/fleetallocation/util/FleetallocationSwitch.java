 ...
 * @generated
 */
public class FleetallocationSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(final int classifierID, final EObject theEObject) {
		...
		case FleetallocationPackage.ALLOCATED_VESSEL: {
			final AllocatedVessel allocatedVessel = (AllocatedVessel) theEObject;
		...
		case FleetallocationPackage.FLEET_VESSEL: {
			final FleetVessel fleetVessel = (FleetVessel) theEObject;
			T result = caseFleetVessel(fleetVessel);
			if (result == null) {
				result = caseAllocatedVessel(fleetVessel);
			}
			if (result == null) {
				result = defaultCase(theEObject);
			}
		...
		case FleetallocationPackage.SPOT_VESSEL: {
			final SpotVessel spotVessel = (SpotVessel) theEObject;
			T result = caseSpotVessel(spotVessel);
			if (result == null) {
				result = caseAllocatedVessel(spotVessel);
			}
			if (result == null) {
				result = defaultCase(theEObject);
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Allocated Vessel</em>'. <!-- begin-user-doc --> This implementation returns null; returning a non-null result will terminate
	 * the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *            the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Allocated Vessel</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAllocatedVessel(final AllocatedVessel object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Fleet Vessel</em>'. <!-- begin-user-doc --> This implementation returns null; returning a non-null result will terminate the
	 * switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *            the target of the switch.
	 ...
	 * @generated
	 */
	public T caseFleetVessel(final FleetVessel object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Spot Vessel</em>'. <!-- begin-user-doc --> This implementation returns null; returning a non-null result will terminate the
	 * switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *            the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Spot Vessel</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSpotVessel(final SpotVessel object) {
		return null;
	}
