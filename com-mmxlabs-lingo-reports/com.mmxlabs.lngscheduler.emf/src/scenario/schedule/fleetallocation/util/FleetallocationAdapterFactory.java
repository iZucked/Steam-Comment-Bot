...
public class FleetallocationAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected FleetallocationSwitch<Adapter> modelSwitch = new FleetallocationSwitch<Adapter>() {
		@Override
		public Adapter caseAllocatedVessel(final AllocatedVessel object) {
			return createAllocatedVesselAdapter();
		}

		@Override
		public Adapter caseFleetVessel(final FleetVessel object) {
			return createFleetVesselAdapter();
		}

		@Override
		public Adapter caseSpotVessel(final SpotVessel object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link scenario.schedule.fleetallocation.AllocatedVessel <em>Allocated Vessel</em>}'. <!-- begin-user-doc --> This default implementation returns
	...
	/**
	 * Creates a new adapter for an object of class '{@link scenario.schedule.fleetallocation.FleetVessel <em>Fleet Vessel</em>}'. <!-- begin-user-doc --> This default implementation returns null so
	...
	/**
	 * Creates a new adapter for an object of class '{@link scenario.schedule.fleetallocation.SpotVessel <em>Spot Vessel</em>}'. <!-- begin-user-doc --> This default implementation returns null so
	 * that we can easily ignore cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
