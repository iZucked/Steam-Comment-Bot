...
public interface Sequence extends EObject {
	/**
	 * Returns the value of the '<em><b>Events</b></em>' containment reference list. The list contents are of type {@link scenario.schedule.events.ScheduledEvent}. <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Sets the value of the '{@link scenario.schedule.Sequence#getVessel <em>Vessel</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
