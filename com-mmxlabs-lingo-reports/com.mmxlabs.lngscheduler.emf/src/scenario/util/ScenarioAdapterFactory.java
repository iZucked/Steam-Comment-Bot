...
public class ScenarioAdapterFactory extends AdapterFactoryImpl {
	...
	protected ScenarioSwitch<Adapter> modelSwitch = new ScenarioSwitch<Adapter>() {
		@Override
		public Adapter caseScenario(final Scenario object) {
		...
		@Override
		public Adapter caseDetail(final Detail object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link scenario.Scenario <em>Scenario</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can easily ignore cases;
	...
	/**
	 * Creates a new adapter for an object of class '{@link scenario.Detail <em>Detail</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can easily ignore cases; it's
