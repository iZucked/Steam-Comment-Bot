 ...
 * @generated
 */
public class ScenarioServiceItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider,
		IItemPropertySource {
	/**
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_ScenarioService_name_feature"), getString("_UI_PropertyDescriptor_description", "_UI_ScenarioService_name_feature", "_UI_ScenarioService_type"),
				ScenarioServicePackage.Literals.SCENARIO_SERVICE__NAME, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ScenarioServicePackage.Literals.SCENARIO_SERVICE__SCENARIOS);
		}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_ScenarioService_type") : getString("_UI_ScenarioService_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		case ScenarioServicePackage.SCENARIO_SERVICE__DESCRIPTION:
			...
			return;
		case ScenarioServicePackage.SCENARIO_SERVICE__SCENARIOS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(ScenarioServicePackage.Literals.SCENARIO_SERVICE__SCENARIOS, ScenarioServiceFactory.eINSTANCE.createScenarioInstance()));
	}
