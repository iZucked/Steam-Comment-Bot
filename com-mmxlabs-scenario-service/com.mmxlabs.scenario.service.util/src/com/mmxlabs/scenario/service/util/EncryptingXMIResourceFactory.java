...
//		EncBinaryResourceImpl resource = new EncBinaryResourceImpl(uri, cipher);

		return resource;
	}

	private class EncBinaryResourceImpl extends BinaryResourceImpl {
		public EncBinaryResourceImpl(URI uri, URIConverter.Cipher cipher) {
			super(uri);
			this.defaultLoadOptions = new HashMap<Object, Object>();
			this.defaultSaveOptions = new HashMap<Object, Object>();
			this.defaultLoadOptions.put(Resource.OPTION_CIPHER, cipher);
			this.defaultSaveOptions.put(Resource.OPTION_CIPHER, cipher);
		}
