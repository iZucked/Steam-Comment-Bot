...
public interface IScenarioService {
	 ...
	 * 
	 * @param container the destination in this logical model where the new scenario instance will go
	 * @param dependencies other scenario instances which the new instance will depend upon
	 * @param models the new models which this scenario will own; these ought not be in any resources at this point.
	 * 		New resources and storage will be sorted out for them by this scenario service.
	...
	/**
	 * Create a duplicate of the given scenario and place it in the destination. Any models owned by the original will be
	 * duplicated into new resources; dependencies of the original will not be duplicated.
	 * 
	 * @param original
	 * @param destination
