 ...
 * All rights reserved.
 */
package com.mmxlabs.scenario.service.model.util.encryption.impl.v1;
...
public final class KeyFileV1 implements IKeyFile {
	...
	private KeyFileV1(final byte[] keyUUID, final Key key, final int keySize) {
	...
	public static KeyFileV1 load(final InputStream in, final char[] password) throws Exception {
		...
		final KeyFileV1 keyfile = new KeyFileV1(fileUUID, key, keysize);

		return keyfile;
	}

	public static KeyFileV1 generateKey(final int keysize) {
		try {
			...
			return new KeyFileV1(keyUUID, generatedKey, keysize);
